...
export function createInteractiveInvocation(
  ...
  mode: Exclude<RunnerCommand, 'start'>,
...
function spawnPlaywright(config: InteractiveRunnerConfig, mode: Exclude<RunnerCommand, 'start'>, playwrightArgs: string[]): ChildProcess {
