...
## Corpus Check
- 238 files · ~157,842 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1433 nodes · 2889 edges · 117 communities (94 shown, 23 thin omitted)
...
Cohesion: 0.10
Nodes (31): supabase, mapCommentMentionRow(), mapCommentRow(), mapIssueRow(), mapModuleRow(), mapProfileRow(), mapProjectMemberRow(), mapProjectMemberWithProfileRow() (+23 more)
...
Cohesion: 0.09
Nodes (25): xlsx, BulkActionsBar(), BulkActionsBarProps, RowActionsMenu(), RowActionsMenuProps, downloadTestCaseImportTemplate(), exportTestCasesToExcel(), exportTestCasesToPdf() (+17 more)
...
Cohesion: 0.14
Nodes (25): Props, ISSUE_STATUS_SEVERITY, PROJECT_MEMBER_ROLE_LABEL, PROJECT_MEMBER_ROLE_SEVERITY, PROJECT_STATUS_LABEL, PROJECT_STATUS_SEVERITY, TagSeverity, TEST_CASE_PRIORITY_LABEL (+17 more)
...
Cohesion: 0.05
Nodes (59): AiAssistantPanel(), AiIssueDraftDialog(), priorities, Props, aiIssueDraftSchema, assistantEntityTypeSchema, assistantMatchSchema, assistantResponseSchema (+51 more)
...
Cohesion: 0.26
Nodes (13): CommentsPanel(), formatDateTime(), USER_ROLE_LABEL, USER_ROLE_SEVERITY, AuthContext, AuthContextValue, useComments(), useProfiles() (+5 more)
...
Cohesion: 0.16
Nodes (16): Breadcrumb(), BreadcrumbItem, BreadcrumbProps, ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY, ISSUE_STATUS_LABEL, useIssuesByTestRun(), IssueDetail (+8 more)
...
Cohesion: 0.13
Nodes (22): PageHeader(), PageHeaderProps, TEST_PLAN_STATUS_LABEL, TEST_PLAN_STATUS_SEVERITY, TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY, TEST_RUN_STATUS_LABEL, TEST_RUN_STATUS_SEVERITY (+14 more)
...
## Knowledge Gaps
- **531 isolated node(s):** `supabase`, `$schema`, `typescript`, `oxc`, `react/rules-of-hooks` (+526 more)
...
- **Why does `useAiAssistant()` connect `schema_requirement_traceability.sql` to `Community 2`, `handler.ts`?**
