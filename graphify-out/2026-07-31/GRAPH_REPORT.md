...
## Corpus Check
- 299 files · ~192,238 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1802 nodes · 3521 edges · 157 communities (125 shown, 32 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 26 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f2ae130d`
...
Cohesion: 0.20
Nodes (14): DEFAULT_OPTIONS, aiTestCaseRepository, aiTestCaseService, similarity(), tokens(), AI_TEST_CASE_SOURCE_TYPES, AiDuplicateCandidate, AiTestCaseGenerationOptions (+6 more)
...
Cohesion: 0.06
Nodes (45): jspdf, AppMenu(), AppMenuitem(), AppMenuSeparator(), MenuItemModel, exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName() (+37 more)
...
Cohesion: 0.13
Nodes (13): supabase, mapNotificationRow(), issueAttachmentRepository, mapRow(), withSignedUrl(), moduleRepository, notificationRepository, profileRepository (+5 more)

### Community 8 - "Community 8"
Cohesion: 0.13
Nodes (18): TestSuiteDialog(), TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, ProfileViewProps, FilterToolbar(), FilterToolbarProps, RowActionsMenu() (+10 more)

### Community 9 - "Community 9"
Cohesion: 0.16
Nodes (10): mapTestSuiteItemRow(), mapTestSuiteItemStepRow(), mapTestSuiteRow(), SuiteItemInput, testSuiteRepository, ItemInput, testSuiteService, TestSuiteItem (+2 more)
...
Cohesion: 0.08
Nodes (29): ProfileView(), describeSystemEvent(), EVENT_TYPE_LABEL, STATUS_LABEL_BY_ENTITY, statusLabel(), ISSUE_STATUS_LABEL, ISSUE_STATUS_SEVERITY, ISSUE_TYPE_LABEL (+21 more)

### Community 18 - "3. Konsep Test Management"
Cohesion: 0.07
Nodes (32): IssueEditor(), IssueEditorProps, IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, mapRequirementLinkRow(), mapRequirementRow() (+24 more)
...
Cohesion: 0.11
Nodes (29): AdminRoute(), ProtectedRoute(), IssueDialog(), IssueDialogProps, TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY, useAuthContext(), useAutomation() (+21 more)

### Community 21 - "Feature Backlog — TestManager"
Cohesion: 0.12
Nodes (18): ImportCasesDialog(), ImportCasesDialogProps, ActivityPanel(), TABLE_LABELS, formatDateTime(), useActivity(), ISSUE_PRIORITY_OPTIONS, ISSUE_STATUS_OPTIONS (+10 more)

### Community 22 - "Architecture"
Cohesion: 0.12
Nodes (21): Breadcrumb(), BreadcrumbItem, BreadcrumbProps, BreadcrumbTrail(), ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY, USER_ROLE_LABEL, USER_ROLE_SEVERITY (+13 more)

### Community 23 - "AttachmentPanel.tsx"
Cohesion: 0.19
Nodes (13): mapTestRunAssignmentRow(), mapTestRunRow(), EMPTY_FILTERS, TestRunWithSummary, useTestRuns(), testCaseRepository, testResultRepository, TestRunFilters (+5 more)
...
Cohesion: 0.09
Nodes (29): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, BulkActionsBar(), BulkActionsBarProps, PageHeader(), PageHeaderProps, formatDate() (+21 more)
...
Cohesion: 0.20
Nodes (12): CSV_TEMPLATE_SAMPLE_ROWS, EXPECTED_HEADERS, InvalidRow, parseCsvText(), ParsedTestCaseCsv, ParsedTestCaseRow, ParsedTestCaseStep, parseStepsCell() (+4 more)
...
Cohesion: 0.19
Nodes (17): PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_SEVERITY, MEMBER_ROLE_OPTIONS, VISIBILITY_OPTIONS, ProjectsPage(), STATUS_OPTIONS, ProjectOwnerFilter, ProjectPaginatedQuery (+9 more)

### Community 40 - "graphify reference: query, path, explain"
Cohesion: 0.09
Nodes (27): mapCicdPipelineRow(), cicdRepository, projectMemberRepository, testResultStepRepository, cicdService, projectMemberService, testResultStepService, ActivityAction (+19 more)
...
Cohesion: 0.09
Nodes (28): mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapEnvironmentRow(), mapModuleRow(), mapProfileRow(), mapProjectMemberRow(), mapProjectMemberWithProfileRow() (+20 more)
...
Cohesion: 0.19
Nodes (12): PRIORITY_OPTIONS, TestCaseDetail, priorities, statuses, testCaseStepRepository, moduleService, tagService, testCaseService (+4 more)
...
Cohesion: 0.29
Nodes (9): AiTestCaseGeneratorDialog(), maxCaseOptions, priorityOptions, Props, ReviewDraft, toAiTestCaseSource(), useAiTestCaseGenerator(), AiTestCaseDraft (+1 more)
...
Cohesion: 0.22
Nodes (8): xlsx, detectSourceType(), parseRequirementFile(), downloadTestCaseImportTemplate(), exportTestCasesToExcel(), exportTestCasesToPdf(), ProjectTestCaseTab(), xlsx
...
## Knowledge Gaps
- **697 isolated node(s):** `1. Fitur yang sudah selesai`, `Requirement Traceability`, `Environment Management`, `Test Run Enhancement`, `Test Case Productivity` (+692 more)
...
- **Why does `react` connect `schema_test_management_v2.sql` to `Community 0`, `Community 1`, `Community 4`, `Community 8`, `Community 10`, `Community 11`, `Community 12`, `What You Must Do When Invoked`, `3. Konsep Test Management`, `ARCHITECTURE — TestManager (shiftech-test-mgr)`, `Feature Backlog — TestManager`, `Architecture`, `AttachmentPanel.tsx`, `TestCaseDetailPage.tsx`, `statusLabels.ts`, `schema_entity_codes.sql`, `schema_auth.sql`, `graphify reference: query, path, explain`, `design-review-test-management-v2.md`, `schema_project_roles.sql`, `schema_011_attachments_archive.sql`, `graphify reference: add a URL and watch a folder`, `issueAttachmentRepository.ts`, `graphify reference: transcribe video and audio`, `useScreenSize.ts`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `query()` connect `ARCHITECTURE — TestManager (shiftech-test-mgr)` to `Community 1`, `graphify reference: extra exports and benchmark`, `package.json`, `Architecture`, `schema_test_management_v2.sql`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `dependencies` connect `ProjectSettingsPage.tsx` to `UserHoverCard.tsx`, `Community 4`, `package.json`, `react-markdown`, `@supabase/supabase-js`, `react`, `jspdf-autotable`, `primereact`, `react-hook-form`?**
