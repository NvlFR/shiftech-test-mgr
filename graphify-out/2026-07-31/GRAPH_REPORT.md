...
## Corpus Check
- 301 files · ~192,959 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1808 nodes · 3586 edges · 160 communities (134 shown, 26 thin omitted)
...
Cohesion: 0.11
Nodes (25): IssueEditor(), IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, ISSUE_STATUS_LABEL, ISSUE_TYPE_LABEL, ISSUE_TYPE_SEVERITY (+17 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (33): supabase, mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapNotificationRow(), mapProfileRow(), mapProjectMemberRow(), mapProjectMemberWithProfileRow() (+25 more)

### Community 8 - "Community 8"
Cohesion: 0.19
Nodes (12): TestSuiteDialog(), FilterToolbar(), FilterToolbarProps, RowActionsMenu(), RowActionsMenuProps, SearchInput(), SearchInputProps, EMPTY_FORM (+4 more)

### Community 9 - "Community 9"
Cohesion: 0.27
Nodes (8): AppTopbar(), BreadcrumbContext, BreadcrumbContextValue, BreadcrumbItem, BreadcrumbProvider(), useBreadcrumbContext(), BreadcrumbTrail(), useNotifications()
...
Cohesion: 0.32
Nodes (9): AppLayout(), AppLayoutInner(), AppSidebar(), AppSidebarMask(), LayoutContext, LayoutContextValue, LayoutProvider(), useLayoutContext() (+1 more)
...
Cohesion: 0.11
Nodes (23): exportTestCasesToExcel(), exportTestCasesToPdf(), ISSUE_STATUS_SEVERITY, PROJECT_MEMBER_ROLE_SEVERITY, PROJECT_MEMBER_STATUS_LABEL, PROJECT_MEMBER_STATUS_SEVERITY, PROJECT_VISIBILITY_LABEL, PROJECT_VISIBILITY_SEVERITY (+15 more)
...
Cohesion: 0.16
Nodes (18): formatDate(), formatDateTime(), useDashboard(), useProjectContext(), LoginPage(), downloadCsv(), HomePage(), ProjectDetailPage() (+10 more)

### Community 21 - "Feature Backlog — TestManager"
Cohesion: 0.09
Nodes (26): Props, CustomTestRunDialog(), CustomTestRunDialogProps, ImportCasesDialog(), ImportCasesDialogProps, downloadTestCaseImportTemplate(), ImportedTestCaseRow, ISSUE_PRIORITY_OPTIONS (+18 more)

### Community 22 - "Architecture"
Cohesion: 0.18
Nodes (11): App(), AdminRoute(), ProtectedRoute(), BreadcrumbItem, AuthContext, AuthContextValue, AuthProvider(), useAuthContext() (+3 more)

### Community 23 - "AttachmentPanel.tsx"
Cohesion: 0.10
Nodes (29): IssueDialog(), IssueDialogProps, ActivityPanel(), TABLE_LABELS, TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY, TEST_RUN_STATUS_LABEL, TEST_RUN_STATUS_SEVERITY (+21 more)
...
Cohesion: 0.19
Nodes (12): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, TEST_PLAN_STATUS_LABEL, TEST_PLAN_STATUS_SEVERITY, ProjectTestPlanTab(), ProjectTestPlanTabProps, STATUS_OPTIONS (+4 more)
...
Cohesion: 0.12
Nodes (18): testResultStepRepository, testSuiteRepository, testResultStepService, ItemInput, ActivityAction, AutomationArtifact, CicdIngestResultInput, CicdIngestStatus (+10 more)
...
Cohesion: 0.16
Nodes (15): AiAssistantPanel(), PageHeader(), PageHeaderProps, ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY, USER_ROLE_LABEL, USER_ROLE_SEVERITY, useAiAssistant() (+7 more)
...
Cohesion: 0.18
Nodes (12): Breadcrumb(), BreadcrumbProps, BulkActionsBar(), BulkActionsBarProps, PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_LABEL, PROJECT_STATUS_SEVERITY, useProjectRole() (+4 more)
...
Cohesion: 0.24
Nodes (8): mapDashboardReportRunRow(), DashboardReportIssueRow, dashboardReportRepository, DashboardReportResultRow, fetchAllRows(), RangeResult, DashboardReportRun, TestResultStatus
...
Cohesion: 0.21
Nodes (12): mapIssueRow(), mapModuleRow(), mapTagRow(), mapTestCaseVersionRow(), mapTestPlanCaseRow(), mapTestRoleRow(), issueRepository, mapIssueDetails() (+4 more)
...
Cohesion: 0.43
Nodes (4): ProfileView(), ProfileViewProps, useProfileView(), UserDetailPage()
...
## Knowledge Gaps
- **699 isolated node(s):** `1. Fitur yang sudah selesai`, `Requirement Traceability`, `Environment Management`, `Test Run Enhancement`, `Test Case Productivity` (+694 more)
...
- **Why does `dependencies` connect `ProjectSettingsPage.tsx` to `TODO — Sprint Board Aktif`, `react-dom`, `README.md`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `query()` connect `ARCHITECTURE — TestManager (shiftech-test-mgr)` to `schema_011_attachments_archive.sql`, `graphify reference: extra exports and benchmark`, `What You Must Do When Invoked`, `AttachmentPanel.tsx`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `react` connect `schema_011_attachments_archive.sql` to `Community 0`, `Community 1`, `Community 4`, `Community 6`, `Community 8`, `Community 9`, `react-markdown`, `@supabase/supabase-js`, `Community 11`, `Community 12`, `Community 10`, `What You Must Do When Invoked`, `3. Konsep Test Management`, `ARCHITECTURE — TestManager (shiftech-test-mgr)`, `Feature Backlog — TestManager`, `Architecture`, `AttachmentPanel.tsx`, `TestCaseDetailPage.tsx`, `statusLabels.ts`, `schema_entity_codes.sql`, `schema_test_management_v2.sql`, `useScreenSize.ts`, `schema_auth.sql`, `graphify reference: query, path, explain`, `schema_project_roles.sql`, `graphify reference: add a URL and watch a folder`, `issueAttachmentRepository.ts`, `graphify reference: transcribe video and audio`, `graphify reference: GitHub clone and cross-repo merge`, `useScreenSize.ts`, `package.json`, `ai.ts`, `primereact`?**
