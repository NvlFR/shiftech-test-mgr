...
## Corpus Check
- 328 files · ~206,326 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1979 nodes · 3919 edges · 173 communities (139 shown, 34 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 28 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `83a9fade`
...
Cohesion: 0.06
Nodes (47): AppMenu(), AppMenuitem(), AppMenuSeparator(), MenuItemModel, exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName(), mapDashboardReportRunRow() (+39 more)
...
Cohesion: 0.14
Nodes (22): TestSuiteDialog(), Breadcrumb(), dataTablePaginatorProps, dataTablePaginatorTemplate, FilterToolbar(), FilterToolbarProps, PageHeader(), PageHeaderProps (+14 more)
...
Cohesion: 0.06
Nodes (59): xlsx, Props, CustomTestRunDialog(), CustomTestRunDialogProps, ImportCasesDialog(), ImportCasesDialogProps, ProfileViewProps, downloadTestCaseImportTemplate() (+51 more)
...
Cohesion: 0.10
Nodes (28): mapActivityEventRow(), mapApiTokenRow(), mapCommentMentionRow(), mapCommentRow(), mapEnvironmentRow(), mapProfileRow(), mapProjectMemberRow(), mapProjectMemberWithProfileRow() (+20 more)
...
Cohesion: 0.17
Nodes (13): ProfileView(), BreadcrumbItem, BreadcrumbProps, CommentsPanel(), AuthContext, AuthContextValue, useComments(), useProfiles() (+5 more)
...
Cohesion: 0.22
Nodes (11): mapTestRunAssignmentRow(), mapTestRunRow(), EMPTY_FILTERS, TestRunWithSummary, useTestRuns(), projectRepositoryLinkRepository, TestRunFilters, testRunRepository (+3 more)

### Community 40 - "graphify reference: query, path, explain"
Cohesion: 0.08
Nodes (36): IssueDialog(), IssueDialogProps, STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, ActivityPanel(), TABLE_LABELS, BulkActionsBar() (+28 more)
...
Cohesion: 0.13
Nodes (17): mapProjectRepositoryRow(), projectMemberRepository, CreateProjectRepositoryInput, UpdateProjectRepositoryInput, CredentialAction, repositoryConnectionRepository, RepositoryConnectionResultRow, RepositoryCredentialRow (+9 more)
...
Cohesion: 0.11
Nodes (17): dependencies, @modelcontextprotocol/sdk, devDependencies, @types/node, typescript, engines, node, name (+9 more)
...
Cohesion: 0.17
Nodes (23): AdminRoute(), ProtectedRoute(), formatDate(), useAuthContext(), useBackupRetention(), useIssuesByTestRun(), useProjectRole(), useScreenSize() (+15 more)

### Community 72 - "3. Konsep Test Management"
Cohesion: 0.60
Nodes (3): useDashboard(), downloadCsv(), HomePage()
...
Cohesion: 0.19
Nodes (11): PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_LABEL, PROJECT_STATUS_SEVERITY, useProjectRepositories(), MEMBER_ROLE_OPTIONS, ProjectSettingsPage(), REPOSITORY_SOURCE_LABEL, REPOSITORY_SOURCE_OPTIONS (+3 more)
...
## Knowledge Gaps
- **766 isolated node(s):** `2026-07-31 — REPO-08 traceability repository pada Test Run`, `2026-07-31 — REPO-07 mode `local_path` pada runner`, `2026-07-31 — REPO-04 tab Repository di Project Settings`, `2026-07-31 — REPO-02 domain, mapper, dan CRUD project repository links`, `2026-07-31 — REPO-01 project repositories migration` (+761 more)
...
- **Why does `query()` connect `useScreenSize.ts` to `Community 1`, `3. Konsep Test Management`, `primeflex`, `graphify reference: extra exports and benchmark`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `react` connect `Community 8` to `Community 0`, `Community 1`, `Community 4`, `Community 9`, `Community 11`, `Community 12`, `What You Must Do When Invoked`, `3. Konsep Test Management`, `Feature Backlog — TestManager`, `AttachmentPanel.tsx`, `TestCaseDetailPage.tsx`, `statusLabels.ts`, `schema_entity_codes.sql`, `primeflex`, `ProjectSettingsPage.tsx`, `UserDetailPage.tsx`, `graphify reference: query, path, explain`, `schema_auth.sql`, `schema_project_roles.sql`, `AppTopbar.tsx`, `scripts`, `graphify reference: transcribe video and audio`, `useScreenSize.ts`, `3. Konsep Test Management`, `useStoredState.ts`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `dependencies` connect `ProjectSettingsPage.tsx` to `primeicons`, `Breadcrumb.tsx`, `TestManager (shiftech-test-mgr)`, `package.json`, `3. Konsep Test Management`, `issueAttachmentRepository.ts`, `@supabase/supabase-js`?**
