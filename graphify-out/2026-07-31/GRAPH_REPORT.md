...
## Summary
- 1812 nodes · 3596 edges · 157 communities (125 shown, 32 thin omitted)
...
- `TestSuiteDetailPage()` --indirect_call--> `query()`  [INFERRED]
  frontend/src/pages/test-suites/TestSuiteDetailPage.tsx → supabase/functions/ai-gateway/handler.ts
...
Cohesion: 0.07
Nodes (47): AiAssistantPanel(), AiIssueDraftDialog(), priorities, Props, aiIssueDraftSchema, assistantEntityTypeSchema, assistantMatchSchema, assistantResponseSchema (+39 more)
...
Cohesion: 0.07
Nodes (40): supabase, mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapIssueRow(), mapModuleRow(), mapProfileRow(), mapProjectMemberRow() (+32 more)

### Community 8 - "Community 8"
Cohesion: 0.11
Nodes (22): TestSuiteDialog(), TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, ProfileViewProps, CharacterCount(), CharacterCountProps, FilterToolbar() (+14 more)
...
Cohesion: 0.09
Nodes (38): xlsx, AiTestCaseGeneratorDialog(), maxCaseOptions, priorityOptions, Props, ReviewDraft, parseRequirementFile(), toAiTestCaseSource() (+30 more)
...
Cohesion: 0.10
Nodes (23): CustomTestRunDialog(), CustomTestRunDialogProps, ActivityPanel(), TABLE_LABELS, formatDateTime(), ImportedTestCaseRow, normalizeHeader(), normalizePriority() (+15 more)

### Community 22 - "Architecture"
Cohesion: 0.06
Nodes (42): App(), AdminRoute(), ProtectedRoute(), AppMenu(), AppMenuitem(), AppMenuSeparator(), MenuItemModel, ProfileView() (+34 more)

### Community 23 - "AttachmentPanel.tsx"
Cohesion: 0.10
Nodes (28): IssueDialog(), IssueDialogProps, Breadcrumb(), BreadcrumbItem, BreadcrumbProps, PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_LABEL, PROJECT_STATUS_SEVERITY (+20 more)
...
Cohesion: 0.17
Nodes (18): ImportCasesDialog(), ImportCasesDialogProps, formatDate(), mapProjectRow(), useProjects(), ProjectsPage(), STATUS_OPTIONS, ProjectOwnerFilter (+10 more)
...
Cohesion: 0.19
Nodes (13): mapTestResultRow(), mapTestRunAssignmentRow(), mapTestRunRow(), EMPTY_FILTERS, TestRunWithSummary, testResultRepository, TestRunFilters, testRunRepository (+5 more)
...
## Knowledge Gaps
- **695 isolated node(s):** `1. Fitur yang sudah selesai`, `Requirement Traceability`, `Environment Management`, `Test Run Enhancement`, `Test Case Productivity` (+690 more)
...
- **Why does `query()` connect `AttachmentPanel.tsx` to `Community 8`, `Community 1`, `graphify reference: extra exports and benchmark`, `What You Must Do When Invoked`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `react` connect `schema_test_management_v2.sql` to `Community 1`, `Community 4`, `Community 6`, `Community 8`, `Community 10`, `Community 11`, `Community 12`, `What You Must Do When Invoked`, `3. Konsep Test Management`, `ARCHITECTURE — TestManager (shiftech-test-mgr)`, `Feature Backlog — TestManager`, `Architecture`, `AttachmentPanel.tsx`, `TestCaseDetailPage.tsx`, `statusLabels.ts`, `schema_entity_codes.sql`, `schema_auth.sql`, `graphify reference: query, path, explain`, `schema_project_roles.sql`, `issueAttachmentRepository.ts`, `graphify reference: transcribe video and audio`, `graphify reference: GitHub clone and cross-repo merge`, `useScreenSize.ts`, `package.json`, `testSuiteRepository.ts`?**
