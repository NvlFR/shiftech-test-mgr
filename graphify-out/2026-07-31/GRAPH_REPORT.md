...
## Corpus Check
- 301 files · ~194,106 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1814 nodes · 3512 edges · 162 communities (130 shown, 32 thin omitted)
...
Cohesion: 0.07
Nodes (51): AiTestCaseGeneratorDialog(), maxCaseOptions, priorityOptions, ReviewDraft, AiTestCaseResponseSchema, AiTestCaseSchema, AiTestCaseValidationError, AiTestCaseValidationResult (+43 more)
...
Cohesion: 0.09
Nodes (30): exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName(), mapDashboardReportRunRow(), useDashboardReport(), useEnvironments(), useProjects(), ALL (+22 more)
...
Cohesion: 0.05
Nodes (52): IssueEditor(), IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, ProfileViewProps, DescribableActivityEntry, describeSystemEvent() (+44 more)

### Community 7 - "Community 7"
Cohesion: 0.10
Nodes (23): mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapProfileRow(), mapProjectMemberRow(), mapProjectMemberWithProfileRow(), mapRequirementRow(), mapTestCaseStepRow() (+15 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (58): xlsx, AiAssistantPanel(), dataTablePaginatorProps, dataTablePaginatorTemplate, FilterToolbar(), FilterToolbarProps, PageHeader(), PageHeaderProps (+50 more)
...
Cohesion: 0.11
Nodes (20): riskLabel, riskSeverity, TestRunAnalysisPanelProps, AiTestRunAnalysisResponseContract, aiTestRunAnalysisResponseSchema, failurePatternSchema, parseAiTestRunAnalysisResponse(), retestRecommendationSchema (+12 more)
...
Cohesion: 0.31
Nodes (6): ImportCasesDialogProps, tagRepository, tagService, testCaseService, TestCase, TestCaseFilters

### Community 18 - "3. Konsep Test Management"
Cohesion: 0.17
Nodes (17): mapRequirementLinkRow(), mapLink(), requirementRepository, requirementService, ActivityAction, AutomationArtifact, CicdIngestResultInput, CicdIngestStatus (+9 more)
...
Cohesion: 0.10
Nodes (26): iconForKind(), NOTIFICATION_KIND_ICON, NotificationPanel(), NotificationPanelProps, CommentsPanel(), formatDateTime(), useBackupRetention(), useProjectRole() (+18 more)
...
Cohesion: 0.13
Nodes (18): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, BulkActionsBar(), BulkActionsBarProps, TEST_PLAN_STATUS_LABEL, TEST_PLAN_STATUS_SEVERITY, TEST_RESULT_STATUS_SEVERITY (+10 more)
...
Cohesion: 0.14
Nodes (18): Props, IssueEditorProps, PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_SEVERITY, useIssueEditorOptions(), MEMBER_ROLE_OPTIONS, VISIBILITY_OPTIONS, projectMemberRepository (+10 more)
...
Cohesion: 0.16
Nodes (15): AdminRoute(), ProtectedRoute(), ImportCasesDialog(), AppTopbar(), AuthContext, AuthContextValue, useAuthContext(), useNotifications() (+7 more)

### Community 43 - "TestManager (shiftech-test-mgr)"
Cohesion: 0.12
Nodes (15): CustomTestRunDialog(), CustomTestRunDialogProps, ActivityPanel(), TABLE_LABELS, TEST_RUN_STATUS_SEVERITY, useActivity(), ISSUE_PRIORITY_OPTIONS, ISSUE_STATUS_OPTIONS (+7 more)
...
Cohesion: 0.15
Nodes (16): supabase, mapIssueRow(), mapModuleRow(), mapTagRow(), mapTestCaseRow(), mapTestCaseVersionRow(), mapTestPlanCaseRow(), mapTestResultRow() (+8 more)
...
Cohesion: 0.29
Nodes (7): 2026-07-31 — SRC-01 aktivasi dialog source-new, 2026-07-31 — SRC-02 integrasi komponen Issue, 2026-07-31 — SRC-04 penyelesaian notification center, 2026-07-31 — SRC-05 aktivasi profile view lokal, 2026-07-31 — SRC-06 audit dan port shared UI, 2026-07-31 — SRC-08 sinkronisasi hooks-new, 2026-07-31 — SRC-09a port halaman utama batch 1
...
Cohesion: 0.24
Nodes (8): mapTestPlanRow(), Option, PRIORITIES, STATUSES, TYPES, testCaseRepository, testPlanRepository, TestPlan

### Community 71 - "useScreenSize.ts"
Cohesion: 0.13
Nodes (11): readStoredValue(), useStoredState(), RESULT_FILTER_OPTIONS, RESULT_OPTIONS, STEP_RESULT_OPTIONS, TestRunDetailPage(), EMPTY_FORM, ItemForm (+3 more)
...
Cohesion: 0.17
Nodes (14): BreadcrumbContext, BreadcrumbContextValue, BreadcrumbItem, BreadcrumbProvider(), useBreadcrumbContext(), ProfileView(), Breadcrumb(), BreadcrumbCollapsed() (+6 more)
...
## Knowledge Gaps
- **698 isolated node(s):** `SRC-09b — Port halaman Test Runs, Issues, Test Suites, dan execution detail`, `SRC-03 — Integrasi layout-new ke layout aktif`, `Build hijau kembali + perbaikan desain gate codex-loop`, `Commit porting source-new + ignore aset *-new`, `Antrean Codex lengkap + renumber FEATURE_BACKLOG` (+693 more)
...
- **Why does `query()` connect `graphify reference: extra exports and benchmark` to `Community 8`, `ARCHITECTURE — TestManager (shiftech-test-mgr)`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `dependencies` connect `ProjectSettingsPage.tsx` to `react-markdown`, `jspdf-autotable`, `@supabase/supabase-js`, `package.json`, `Community 8`, `Feature Backlog — TestManager`, `react`, `activityRoutes.ts`, `dashboardRepository.ts`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `react` connect `useScreenSize.ts` to `Community 0`, `Community 1`, `Community 4`, `Community 6`, `Community 8`, `Breadcrumb.tsx`, `Community 10`, `Community 12`, `What You Must Do When Invoked`, `3. Konsep Test Management`, `ARCHITECTURE — TestManager (shiftech-test-mgr)`, `Architecture`, `AttachmentPanel.tsx`, `TestCaseDetailPage.tsx`, `statusLabels.ts`, `schema_entity_codes.sql`, `schema_test_management_v2.sql`, `useComments.ts`, `graphify reference: extra exports and benchmark`, `schema_auth.sql`, `graphify reference: query, path, explain`, `useTheme.tsx`, `TestManager (shiftech-test-mgr)`, `schema_project_roles.sql`, `AppTopbar.tsx`, `useProjectBreadcrumbItems.ts`, `graphify reference: transcribe video and audio`, `graphify reference: GitHub clone and cross-repo merge`, `dataTablePaginator.tsx`, `AppMenu.tsx`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **What connects `SRC-09b — Port halaman Test Runs, Issues, Test Suites, dan execution detail`, `SRC-03 — Integrasi layout-new ke layout aktif`, `Build hijau kembali + perbaikan desain gate codex-loop` to the rest of the system?**
