...
## Corpus Check
- 285 files · ~188,513 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1727 nodes · 3474 edges · 145 communities (120 shown, 25 thin omitted)
...
Cohesion: 0.16
Nodes (10): mapTestSuiteItemRow(), mapTestSuiteItemStepRow(), mapTestSuiteRow(), SuiteItemInput, testSuiteRepository, ItemInput, TestSuite, TestSuiteItem (+2 more)
...
Cohesion: 0.14
Nodes (15): mapTestResultStepRow(), testResultStepRepository, testResultStepService, ActivityAction, AutomationArtifact, CicdIngestResultInput, CicdIngestStatus, ProjectMemberStatus (+7 more)
...
Cohesion: 0.11
Nodes (21): ProfileView(), mapEnvironmentRow(), ISSUE_STATUS_SEVERITY, PROJECT_MEMBER_ROLE_LABEL, PROJECT_MEMBER_ROLE_SEVERITY, PROJECT_STATUS_LABEL, PROJECT_STATUS_SEVERITY, PROJECT_VISIBILITY_LABEL (+13 more)
...
Cohesion: 0.07
Nodes (39): jspdf, AppLayout(), AppLayoutInner(), AppSidebar(), AppSidebarMask(), AppTopbar(), BreadcrumbContext, BreadcrumbContextValue (+31 more)
...
Cohesion: 0.20
Nodes (10): TEST_CASE_PRIORITY_SEVERITY, TEST_CASE_STATUS_LABEL, TEST_CASE_STATUS_SEVERITY, PRIORITY_OPTIONS, TestCaseDetail, priorities, statuses, moduleService (+2 more)
...
Cohesion: 0.22
Nodes (11): xlsx, downloadTestCaseImportTemplate(), exportTestCasesToExcel(), exportTestCasesToPdf(), Option, PRIORITY_OPTIONS, ProjectTestCaseTab(), ProjectTestCaseTabProps (+3 more)
...
Cohesion: 0.16
Nodes (22): TestSuiteDetailPage(), TestSuitesPage(), canonicalAction, ErrorEnvelope, GatewayRequest, OUTPUT_SCHEMA_HINT, requestInput(), RequestSchema (+14 more)

### Community 85 - "testRunRepository.ts"
Cohesion: 0.33
Nodes (5): 2026-07-31 — FIX-00a duplikasi domain TestCase, 2026-07-31 — FIX-00b error TypeScript ProjectDetailPage, 2026-07-31 — Integrasi compile-safe dialogs, notifications, dan profile, 2026-07-31 — Membuat task integrasi penuh source-new, 2026-07-31 — SRC-12 konsolidasi domain aktif
...
Cohesion: 0.05
Nodes (57): AdminRoute(), ProtectedRoute(), ImportCasesDialog(), ActivityPanel(), TABLE_LABELS, BreadcrumbItem, CommentsPanel(), UserHoverCardProps (+49 more)
...
Cohesion: 0.05
Nodes (59): STATUS_OPTIONS, TestPlanDialogProps, TestSuiteDialog(), TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, Breadcrumb(), BreadcrumbProps (+51 more)
...
### Community 125 - "jspdf"
Cohesion: 0.13
Nodes (20): AttachmentPanel(), AttachmentPanelProps, formatFileSize(), CommentEditorProps, MarkdownPreview(), ActiveMention, MentionSuggestion, MentionTextarea() (+12 more)
...
Cohesion: 0.10
Nodes (22): CustomTestRunDialog(), CustomTestRunDialogProps, ImportCasesDialogProps, BulkActionsBar(), BulkActionsBarProps, TEST_RESULT_STATUS_SEVERITY, TEST_RUN_STATUS_LABEL, TEST_RUN_STATUS_SEVERITY (+14 more)

### Community 149 - "TestCaseTab.tsx"
Cohesion: 0.13
Nodes (16): Props, IssueEditorProps, IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, ISSUE_PRIORITY_LABEL, ISSUE_STATUS_LABEL (+8 more)
...
Cohesion: 0.19
Nodes (12): mapTestRunAssignmentRow(), mapTestRunRow(), EMPTY_FILTERS, TestRunWithSummary, useTestRuns(), testCaseRepository, testResultRepository, TestRunFilters (+4 more)
...
## Knowledge Gaps
- **664 isolated node(s):** `Build hijau kembali + perbaikan desain gate codex-loop`, `Commit porting source-new + ignore aset *-new`, `Antrean Codex lengkap + renumber FEATURE_BACKLOG`, `Codex task loop (otomasi antrean task)`, `Penambahan roadmap: MCP server, Playwright interaktif, link repository` (+659 more)
...
- **Why does `query()` connect `handler.ts` to `Coding Conventions`, `react-router-dom`, `Community 13`, `schema_requirement_traceability.sql`, `primeicons`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `react` connect `primeicons` to `Community 1`, `Community 2`, `Community 3`, `Community 9`, `Community 12`, `Community 13`, `scripts`, `TestCaseTab.tsx`, `statusLabels.ts`, `Breadcrumb.tsx`, `Coding Conventions`, `TestSuitesPage.tsx`, `schema_requirement_traceability.sql`, `backupRetentionRepository.ts`, `CLAUDE.md`, `package.json`, `ProjectsPage.tsx`, `react-router-dom`, `react-router-dom`, `jspdf`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `dependencies` connect `Community 4` to `Coding Conventions`, `useProjectPins.tsx`, `primeicons`, `2026-07-31`, `@supabase/supabase-js`, `Community 13`, `package.json`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **What connects `Build hijau kembali + perbaikan desain gate codex-loop`, `Commit porting source-new + ignore aset *-new`, `Antrean Codex lengkap + renumber FEATURE_BACKLOG` to the rest of the system?**
