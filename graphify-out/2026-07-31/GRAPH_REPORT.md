...
## Summary
- 2030 nodes · 4001 edges · 173 communities (138 shown, 35 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 28 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6b357959`
...
- `UserManagementPage()` --indirect_call--> `query()`  [INFERRED]
  frontend/src/pages/users/UserManagementPage.tsx → supabase/functions/ai-gateway/handler.ts
...
Cohesion: 0.06
Nodes (52): App(), AdminRoute(), ProtectedRoute(), BreadcrumbItem, UserHoverCard(), UserHoverCardProps, mapCicdPipelineRow(), queryKeys (+44 more)
...
Cohesion: 0.08
Nodes (31): TestSuiteDialog(), TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, dataTablePaginatorProps, dataTablePaginatorTemplate, FilterToolbar(), FilterToolbarProps (+23 more)
...
Cohesion: 0.14
Nodes (20): AiTestCaseGeneratorDialog(), maxCaseOptions, priorityOptions, Props, toAiTestCaseSource(), TEST_CASE_PRIORITY_LABEL, TEST_CASE_STATUS_SEVERITY, useAiTestCaseGenerator() (+12 more)
...
Cohesion: 0.08
Nodes (41): supabase, mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapIssueRow(), mapModuleRow(), mapProfileRow(), mapProjectMemberRow() (+33 more)
...
Cohesion: 0.23
Nodes (8): authService, config, server, transport, registerTools(), unusedServer, ToolRegistrar, ToolRegistry
...
Cohesion: 0.10
Nodes (29): mapApiTokenRow(), mapWebhookDeliveryRow(), mapWebhookRow(), useIntegrations(), eventOptions, IntegrationsPage(), scopeOptions, integrationRepository (+21 more)
...
Cohesion: 0.09
Nodes (31): IssueDialog(), IssueDialogProps, ActivityPanel(), TABLE_LABELS, PageHeader(), PageHeaderProps, TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY (+23 more)

### Community 40 - "graphify reference: query, path, explain"
Cohesion: 0.13
Nodes (21): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, formatDate(), formatDateTime(), mapTestPlanRow(), TEST_PLAN_STATUS_LABEL, TEST_PLAN_STATUS_SEVERITY (+13 more)
...
Cohesion: 0.13
Nodes (18): IssueEditorProps, mapEnvironmentRow(), mapTestRoleRow(), MEMBER_ROLE_OPTIONS, REPOSITORY_SOURCE_LABEL, REPOSITORY_SOURCE_OPTIONS, VISIBILITY_OPTIONS, environmentRepository (+10 more)
...
Cohesion: 0.19
Nodes (15): mapProjectRow(), ProjectContext, ProjectContextValue, ProjectProvider(), STATUS_OPTIONS, ProjectOwnerFilter, ProjectPaginatedQuery, ProjectQuery (+7 more)
...
Cohesion: 0.08
Nodes (34): xlsx, CustomTestRunDialog(), CustomTestRunDialogProps, ImportCasesDialog(), ImportCasesDialogProps, BulkActionsBar(), BulkActionsBarProps, downloadTestCaseImportTemplate() (+26 more)
...
Cohesion: 0.07
Nodes (40): AppLayout(), AppLayoutInner(), AppSidebar(), AppSidebarMask(), AppTopbar(), BreadcrumbContext, BreadcrumbContextValue, BreadcrumbItem (+32 more)
...
Cohesion: 0.15
Nodes (12): loadConfig(), parseReadonly(), requiredEnv(), ServerConfig, AuthenticatedToken, AuthenticationError, AuthRepository, TokenAuthenticationRow (+4 more)
...
## Knowledge Gaps
- **780 isolated node(s):** `2026-07-31 — REPO-08 traceability repository pada Test Run`, `2026-07-31 — REPO-07 mode `local_path` pada runner`, `2026-07-31 — REPO-04 tab Repository di Project Settings`, `2026-07-31 — REPO-02 domain, mapper, dan CRUD project repository links`, `2026-07-31 — REPO-01 project repositories migration` (+775 more)
...
- **Why does `query()` connect `Community 6` to `Community 1`, `graphify reference: extra exports and benchmark`, `useAuthContext`, `graphify reference: query, path, explain`, `Community 8`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `react` connect `Community 8` to `Community 0`, `Community 1`, `Community 4`, `Community 6`, `Community 9`, `csvImport.ts`, `Community 11`, `Community 12`, `Community 10`, `Architecture`, `AttachmentPanel.tsx`, `TestCaseDetailPage.tsx`, `statusLabels.ts`, `schema_entity_codes.sql`, `schema_auth.sql`, `graphify reference: query, path, explain`, `TestManager (shiftech-test-mgr)`, `schema_project_roles.sql`, `AppTopbar.tsx`, `testSuiteRepository.ts`, `graphify reference: transcribe video and audio`, `graphify reference: GitHub clone and cross-repo merge`, `useAuthContext`, `useStoredState.ts`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `dependencies` connect `ProjectSettingsPage.tsx` to `useAuthContext`, `Community 9`, `package.json`, `react`, `react-markdown`, `@tanstack/react-query`, `react-router-dom`, `@supabase/supabase-js`, `@supabase/supabase-js`?**
