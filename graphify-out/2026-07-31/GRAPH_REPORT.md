...
## Corpus Check
- 300 files · ~192,782 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1805 nodes · 3581 edges · 158 communities (129 shown, 29 thin omitted)
...
Cohesion: 0.16
Nodes (18): IssueEditor(), IssueEditorProps, IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, ISSUE_TYPE_LABEL, ISSUE_TYPE_SEVERITY (+10 more)
...
Cohesion: 0.08
Nodes (33): IssueDialog(), IssueDialogProps, useBreadcrumbContext(), ProfileViewProps, Breadcrumb(), BreadcrumbProps, ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY (+25 more)
...
Cohesion: 0.31
Nodes (12): useProjectRole(), IssueDetailPage(), ProjectSettingsPage(), TestCaseDetailPage(), TestCasesPage(), TestPlansPage(), CustomTestRunPage(), TestRunDetailPage() (+4 more)

### Community 21 - "Feature Backlog — TestManager"
Cohesion: 0.12
Nodes (18): CustomTestRunDialog(), CustomTestRunDialogProps, ProfileView(), ActivityPanel(), TABLE_LABELS, formatDateTime(), useActivity(), ISSUE_PRIORITY_OPTIONS (+10 more)

### Community 22 - "Architecture"
Cohesion: 0.18
Nodes (14): AdminRoute(), ProtectedRoute(), ImportCasesDialog(), BreadcrumbItem, AuthContext, AuthContextValue, useAuthContext(), useProfiles() (+6 more)

### Community 23 - "AttachmentPanel.tsx"
Cohesion: 0.22
Nodes (11): mapTestRunAssignmentRow(), mapTestRunRow(), useTestRunDetail(), EMPTY_FILTERS, TestRunWithSummary, testCaseRepository, TestRunFilters, testRunRepository (+3 more)
...
Cohesion: 0.13
Nodes (22): BulkActionsBar(), BulkActionsBarProps, PageHeader(), PageHeaderProps, formatDate(), TEST_PLAN_STATUS_LABEL, TEST_PLAN_STATUS_SEVERITY, useTestPlanDetail() (+14 more)
...
Cohesion: 0.11
Nodes (15): supabase, mapTestRoleRow(), activityRepository, moduleRepository, profileRepository, tagRepository, testResultStepRepository, testRoleRepository (+7 more)
...
Cohesion: 0.33
Nodes (5): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, CharacterCount(), CharacterCountProps
...
Cohesion: 0.10
Nodes (28): jspdf, Props, downloadTestCaseImportTemplate(), exportTestCasesToExcel(), exportTestCasesToPdf(), TEST_CASE_STATUS_LABEL, TEST_CASE_STATUS_SEVERITY, Option (+20 more)
...
Cohesion: 0.40
Nodes (5): 2026-07-31 — SRC-01 aktivasi dialog source-new, 2026-07-31 — SRC-02 integrasi komponen Issue, 2026-07-31 — SRC-04 penyelesaian notification center, 2026-07-31 — SRC-06 audit dan port shared UI, 2026-07-31 — SRC-08 sinkronisasi hooks-new
...
Cohesion: 0.27
Nodes (8): PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_LABEL, PROJECT_STATUS_SEVERITY, MEMBER_ROLE_OPTIONS, VISIBILITY_OPTIONS, projectMemberRepository, projectMemberService, ProjectMemberRole
...
Cohesion: 0.20
Nodes (13): mapIssueRow(), mapModuleRow(), mapTagRow(), mapTestCaseVersionRow(), mapTestPlanCaseRow(), issueRepository, mapIssueDetails(), mapTestCaseSummary() (+5 more)
...
## Knowledge Gaps
- **693 isolated node(s):** `1. Fitur yang sudah selesai`, `Requirement Traceability`, `Environment Management`, `Test Run Enhancement`, `Test Case Productivity` (+688 more)
...
- **Why does `react` connect `Community 8` to `Community 0`, `Community 1`, `Community 4`, `Community 6`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `What You Must Do When Invoked`, `3. Konsep Test Management`, `Feature Backlog — TestManager`, `Architecture`, `AttachmentPanel.tsx`, `TestCaseDetailPage.tsx`, `statusLabels.ts`, `schema_entity_codes.sql`, `schema_test_management_v2.sql`, `schema_auth.sql`, `design-review-test-management-v2.md`, `schema_project_roles.sql`, `schema_011_attachments_archive.sql`, `graphify reference: add a URL and watch a folder`, `issueAttachmentRepository.ts`, `graphify reference: transcribe video and audio`, `useScreenSize.ts`, `package.json`, `primereact`, `react-hook-form`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `query()` connect `ARCHITECTURE — TestManager (shiftech-test-mgr)` to `Community 1`, `graphify reference: extra exports and benchmark`, `schema_011_attachments_archive.sql`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `dependencies` connect `ProjectSettingsPage.tsx` to `@supabase/supabase-js`, `schema_011_attachments_archive.sql`, `TODO — Sprint Board Aktif`, `jspdf-autotable`, `graphify reference: GitHub clone and cross-repo merge`, `react-dom`, `remark-gfm`?**
