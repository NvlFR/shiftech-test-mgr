...
## Corpus Check
- 304 files · ~196,622 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1830 nodes · 3611 edges · 172 communities (141 shown, 31 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 28 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0006bb5c`
...
3. `useAuthContext()` - 41 edges
4. `supabase` - 33 edges
5. `Worklog` - 29 edges
6. `useProjectRole()` - 26 edges
7. `formatDateTime()` - 20 edges
...
Cohesion: 0.14
Nodes (15): aiIssueDraftSchema, assistantEntityTypeSchema, assistantMatchSchema, assistantResponseSchema, buildDuplicateReason(), calculateDuplicateConfidence(), duplicateCandidateSchema, duplicateResponseSchema (+7 more)
...
Cohesion: 0.21
Nodes (15): ProjectContext, ProjectContextValue, ProjectProvider(), STATUS_OPTIONS, ProjectOwnerFilter, ProjectPaginatedQuery, ProjectQuery, projectRepository (+7 more)
...
Cohesion: 0.10
Nodes (25): IssueDialog(), IssueDialogProps, ProfileViewProps, ISSUE_STATUS_SEVERITY, ISSUE_TYPE_SEVERITY, PROJECT_MEMBER_ROLE_SEVERITY, PROJECT_MEMBER_STATUS_LABEL, PROJECT_MEMBER_STATUS_SEVERITY (+17 more)

### Community 7 - "Community 7"
Cohesion: 0.10
Nodes (26): mapActivityEventRow(), mapApiTokenRow(), mapAutomationJobRow(), mapAutomationRunnerRow(), mapAutomationScriptRow(), mapCommentMentionRow(), mapCommentRow(), mapProfileRow() (+18 more)
...
Cohesion: 0.12
Nodes (17): CustomTestRunDialog(), CustomTestRunDialogProps, ISSUE_PRIORITY_SEVERITY, ImportedTestCaseRow, normalizeHeader(), normalizePriority(), parseTestCaseExcel(), valueFrom() (+9 more)
...
Cohesion: 0.06
Nodes (42): IssueEditorProps, mapCicdPipelineRow(), PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_SEVERITY, useAutomation(), useCicdPipelines(), useEnvironments(), readStoredValue() (+34 more)
...
Cohesion: 0.25
Nodes (8): supabase, mapEnvironmentRow(), commentRepository, environmentRepository, commentService, ActivityEvent, Comment, CommentTargetType
...
Cohesion: 0.16
Nodes (14): jspdf, exportTestRunsToExcel(), exportTestRunsToPdf(), fileName(), TestRunExportRow, useDashboard(), downloadCsv(), HomePage() (+6 more)

### Community 21 - "Feature Backlog — TestManager"
Cohesion: 0.23
Nodes (9): mapDashboardReportRunRow(), mapTestResultRow(), DashboardReportIssueRow, dashboardReportRepository, DashboardReportResultRow, fetchAllRows(), RangeResult, testResultRepository (+1 more)
...
Cohesion: 0.12
Nodes (17): dependencies, @hookform/resolvers, jspdf-autotable, primeflex, react, react-dom, remark-gfm, @tanstack/react-query (+9 more)
...
Cohesion: 0.14
Nodes (23): useIntegrations(), eventOptions, IntegrationsPage(), scopeOptions, integrationRepository, allowedEvents, integrationService, ActivityAction (+15 more)

### Community 28 - "schema_entity_codes.sql"
Cohesion: 0.25
Nodes (6): formatDraftMetadata(), parseDuplicateCandidates(), toIssuePriority(), aiIssueService, assertActor(), assertAiProjectScope()

### Community 29 - "schema_test_management_v2.sql"
Cohesion: 0.12
Nodes (23): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, BulkActionsBar(), BulkActionsBarProps, mapTestPlanRow(), TEST_PLAN_STATUS_LABEL, TEST_PLAN_STATUS_SEVERITY (+15 more)
...
Cohesion: 0.23
Nodes (11): mapTestRunAssignmentRow(), mapTestRunRow(), EMPTY_FILTERS, TestRunWithSummary, testCaseRepository, TestRunFilters, testRunRepository, testRunService (+3 more)
...
Cohesion: 0.16
Nodes (18): exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName(), useDashboardReport(), useProfiles(), useProjects(), ALL, DashboardReportPage() (+10 more)
...
Cohesion: 0.16
Nodes (11): DescribableActivityEntry, describeSystemEvent(), EVENT_TYPE_LABEL, STATUS_LABEL_BY_ENTITY, statusLabel(), ACTIVITY_ENTITY_LABEL, ACTIVITY_ENTITY_ROUTE, ActivityEntityType (+3 more)

### Community 52 - "useProjectBreadcrumbItems.ts"
Cohesion: 0.14
Nodes (18): IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, ISSUE_PRIORITY_LABEL, ISSUE_STATUS_LABEL, ISSUE_TYPE_LABEL, useIssuesByTestRun() (+10 more)
...
Cohesion: 0.18
Nodes (13): ActivityPanel(), TABLE_LABELS, CommentsPanel(), formatDateTime(), mapTestCaseStepRow(), useActivity(), useComments(), PRIORITY_OPTIONS (+5 more)
...
### Community 70 - "Breadcrumb.tsx"
Cohesion: 0.25
Nodes (7): 2026-07-31 — FIX-00a duplikasi domain TestCase, 2026-07-31 — Integrasi compile-safe dialogs, notifications, dan profile, 2026-07-31 — Membuat task integrasi penuh source-new, 2026-07-31 — SRC-01 aktivasi dialog source-new, 2026-07-31 — SRC-02 integrasi komponen Issue, 2026-07-31 — SRC-06 audit dan port shared UI, 2026-07-31 — SRC-08 sinkronisasi hooks-new

### Community 71 - "useScreenSize.ts"
Cohesion: 0.33
Nodes (4): ItemInput, testSuiteService, TestSuiteItem, TestSuiteItemWithSteps

### Community 72 - "3. Konsep Test Management"
Cohesion: 0.24
Nodes (8): mapIssueAttachmentRow(), useIssueAttachments(), IssueDetail, IssueDetailPage(), STATUS_OPTIONS, issueAttachmentRepository, withSignedUrl(), issueAttachmentService
...
Cohesion: 0.29
Nodes (15): formatDate(), useProjectRole(), useScreenSize(), ProjectDetailPage(), ProjectSettingsPage(), ProjectsPage(), TestCasesPage(), TestPlansPage() (+7 more)
...
Cohesion: 0.25
Nodes (7): ImportCasesDialog(), ImportCasesDialogProps, tagRepository, tagService, testCaseService, TestCase, TestCaseFilters
...
Cohesion: 0.47
Nodes (4): ProfileView(), Breadcrumb(), useProfileView(), UserDetailPage()
...
### Community 119 - "zod"
Cohesion: 0.27
Nodes (11): AiGatewayRequest, aiRepository, aiAssistantService, AiActorContext, AiAssistantEntityType, AiAssistantMatch, AiAssistantSearchRequest, AiAssistantSearchResult (+3 more)
...
### Community 162 - "useAiIssueWorkflow.ts"
Cohesion: 0.33
Nodes (8): AiIssueDraftDialog(), priorities, Props, useAiIssueWorkflow(), AiIssueDraft, DuplicateIssueCandidate, TestResult, TestResultWithDetails

### Community 163 - "useAuthContext"
Cohesion: 0.21
Nodes (11): AdminRoute(), ProtectedRoute(), BreadcrumbItem, AuthContext, AuthContextValue, useAuthContext(), useProjectBreadcrumbItems(), LoginPage() (+3 more)

### Community 164 - "Module"
Cohesion: 0.31
Nodes (5): Props, moduleRepository, moduleService, Module, Tag

### Community 165 - "AppMenu.tsx"
Cohesion: 0.39
...
Cohesion: 0.25
Nodes (8): 2026-07-31 — E03-T06 audit filter priority dan status Test Case, 2026-07-31 — E06-T14 status rejected approval user, 2026-07-31 — SRC-04 penyelesaian notification center, 2026-07-31 — SRC-05 aktivasi profile view lokal, 2026-07-31 — SRC-09a port halaman utama batch 1, 2026-07-31 — SRC-09c port halaman utama batch 3, 2026-07-31 — SRC-13 audit App-new (BLOCKED untuk promosi), 2026-07-31 — SRC-DOD audit exclusion TypeScript source-new

### Community 167 - "TestCasesPage.tsx"
Cohesion: 0.43
Nodes (5): AiAssistantPanel(), useAiAssistant(), useProjectContext(), priorities, statuses

### Community 168 - "2. Layer Detail"
Cohesion: 0.33
...
### Community 169 - "6. Cross-Cutting Concerns"
Cohesion: 0.33
...
### Community 170 - "2026-07-31 — FIX-00b error TypeScript ProjectDetailPage"
Cohesion: 0.40
...
## Knowledge Gaps
- **708 isolated node(s):** `Integrasi source-new (hasil akhir)`, `Projects`, `Kode Entity (Module, Test Case, Test Plan, Test Run)`, `Modules & Tags`, `Test Cases` (+703 more)
...
- **Why does `react` connect `Community 11` to `Community 0`, `Community 4`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `What You Must Do When Invoked`, `ARCHITECTURE — TestManager (shiftech-test-mgr)`, `AttachmentPanel.tsx`, `TestCaseDetailPage.tsx`, `statusLabels.ts`, `schema_test_management_v2.sql`, `AppLayout.tsx`, `useAiIssueWorkflow.ts`, `useAuthContext`, `Module`, `AppMenu.tsx`, `graphify reference: extra exports and benchmark`, `TestCasesPage.tsx`, `schema_auth.sql`, `graphify reference: query, path, explain`, `TestManager (shiftech-test-mgr)`, `schema_project_roles.sql`, `AppTopbar.tsx`, `useProjectBreadcrumbItems.ts`, `graphify reference: transcribe video and audio`, `graphify reference: GitHub clone and cross-repo merge`, `3. Konsep Test Management`, `useStoredState.ts`, `jspdf`, `2026-07-31 — FIX-00b error TypeScript ProjectDetailPage`, `zod`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `query()` connect `useStoredState.ts` to `jspdf`, `graphify reference: extra exports and benchmark`, `TestCasesPage.tsx`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `dependencies` connect `ProjectSettingsPage.tsx` to `primeflex`, `@supabase/supabase-js`, `@tanstack/react-query`, `react-dom`, `react-hook-form`, `ARCHITECTURE — TestManager (shiftech-test-mgr)`, `jspdf`, `react-markdown`, `react-router-dom`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **What connects `Integrasi source-new (hasil akhir)`, `Projects`, `Kode Entity (Module, Test Case, Test Plan, Test Run)` to the rest of the system?**
