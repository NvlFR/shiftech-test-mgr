...
## Corpus Check
- 294 files · ~192,367 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1782 nodes · 3204 edges · 147 communities (123 shown, 24 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 25 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `74278bce`
...
3. `useAuthContext()` - 37 edges
4. `Worklog` - 29 edges
5. `handleAiGateway()` - 20 edges
6. `TestCaseWithDetails` - 18 edges
...
Cohesion: 0.07
Nodes (53): xlsx, AiTestCaseGeneratorDialog(), maxCaseOptions, priorityOptions, Props, ReviewDraft, IssueEditorProps, AiTestCaseResponseSchema (+45 more)
...
Cohesion: 0.05
Nodes (39): supabase, exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName(), mapDashboardReportRunRow(), mapEnvironmentRow(), useDashboardReport(), ALL (+31 more)
...
Cohesion: 0.09
Nodes (21): CustomTestRunDialog(), CustomTestRunDialogProps, STATUS_OPTIONS, TestPlanDialogProps, BulkActionsBar(), BulkActionsBarProps, TEST_PLAN_STATUS_LABEL, TEST_PLAN_STATUS_SEVERITY (+13 more)

### Community 7 - "Community 7"
Cohesion: 0.10
Nodes (22): TEST_CASE_PRIORITY_SEVERITY, TEST_CASE_STATUS_LABEL, TEST_CASE_STATUS_SEVERITY, Option, PRIORITY_OPTIONS, ProjectTestCaseTab(), ProjectTestCaseTabProps, STATUS_OPTIONS (+14 more)

### Community 8 - "Community 8"
Cohesion: 0.09
Nodes (25): TestSuiteDialog(), TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, FilterToolbar(), FilterToolbarProps, PageHeader(), PageHeaderProps (+17 more)

### Community 9 - "Community 9"
Cohesion: 0.12
Nodes (22): mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapProfileRow(), mapProjectMemberRow(), mapProjectMemberWithProfileRow(), mapTestCaseRow(), mapTestCaseStepRow() (+14 more)
...
Cohesion: 0.29
Nodes (6): AppLayout(), AppLayoutInner(), AppTopbar(), useNotifications(), useRealtimeSync(), notificationService
...
Cohesion: 0.14
Nodes (19): mapRequirementLinkRow(), mapRequirementRow(), mapLink(), requirementRepository, requirementService, ActivityAction, AutomationArtifact, CicdIngestResultInput (+11 more)
...
Cohesion: 0.12
Nodes (21): ImportCasesDialogProps, mapProjectRow(), PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_LABEL, PROJECT_STATUS_SEVERITY, ProjectContext, ProjectContextValue, MEMBER_ROLE_OPTIONS (+13 more)

### Community 22 - "Architecture"
Cohesion: 0.22
Nodes (11): downloadCsv(), HomePage(), ProjectDetailPage(), ProjectSettingsPage(), ProjectsPage(), TestCasesPage(), TestPlansPage(), TestRunIssuesPage() (+3 more)

### Community 23 - "AttachmentPanel.tsx"
Cohesion: 0.11
Nodes (26): ActivityPanel(), TABLE_LABELS, TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY, TEST_RUN_STATUS_SEVERITY, useActivity(), useTestPlanDetail(), useTestRunAnalysis() (+18 more)
...
Cohesion: 0.10
Nodes (21): dependencies, @hookform/resolvers, jspdf-autotable, primeflex, primeicons, react, react-dom, react-hook-form (+13 more)

### Community 26 - "TestCaseDetailPage.tsx"
Cohesion: 0.06
Nodes (34): IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, AttachmentPanel(), AttachmentPanelProps, formatFileSize(), CharacterCount() (+26 more)
...
Cohesion: 0.13
Nodes (16): ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY, ISSUE_TYPE_SEVERITY, IssueDetail, IssueDetailPage(), PRIORITY_OPTIONS, STATUS_OPTIONS, PRIORITY_OPTIONS (+8 more)
...
Cohesion: 0.10
Nodes (19): node, src/**/*.ts, compilerOptions, declaration, esModuleInterop, forceConsistentCasingInFileNames, lib, module (+11 more)
...
Cohesion: 0.05
Nodes (43): App(), AdminRoute(), ProtectedRoute(), ImportCasesDialog(), AppMenu(), AppSidebar(), AppSidebarMask(), LayoutContext (+35 more)
...
Cohesion: 0.16
Nodes (10): Dokumentasi Tambahan, Project Overview, Struktur repo, Wajib Menggunakan Graphify, Worklog Wajib, Diblokir, Sedang Dikerjakan, Selesai (recent) (+2 more)
...
Cohesion: 0.33
Nodes (6): useProjectRole(), projectMemberRepository, projectMemberService, ProjectMember, ProjectMemberRole, ProjectMemberWithProfile
...
Cohesion: 0.40
Nodes (4): readStoredPins(), useProjectPins(), readStoredValue(), useStoredState()
...
Cohesion: 0.22
Nodes (7): BreadcrumbContext, BreadcrumbContextValue, BreadcrumbItem, useBreadcrumbContext(), Breadcrumb(), BreadcrumbItem, BreadcrumbProps
...
Cohesion: 0.20
Nodes (9): 2026-07-31 — FIX-00a duplikasi domain TestCase, 2026-07-31 — FIX-00b error TypeScript ProjectDetailPage, 2026-07-31 — Integrasi compile-safe dialogs, notifications, dan profile, 2026-07-31 — Membuat task integrasi penuh source-new, 2026-07-31 — SRC-07 port helper source-new, 2026-07-31 — SRC-08 sinkronisasi hooks-new, 2026-07-31 — SRC-10 sinkronisasi repository source-new, 2026-07-31 — SRC-11 sinkronisasi business rule service source-new (+1 more)
...
Cohesion: 0.39
Nodes (4): mapTestPlanRow(), testPlanRepository, testPlanService, TestPlan
...
Cohesion: 0.28
Nodes (7): iconForKind(), NOTIFICATION_KIND_ICON, NotificationPanel(), NotificationPanelProps, mapNotificationRow(), notificationRepository, Notification
...
Cohesion: 0.17
Nodes (13): mapIssueRow(), mapModuleRow(), mapTagRow(), mapTestCaseVersionRow(), mapTestPlanCaseRow(), mapIssueDetails(), mapTestCaseSummary(), tagRepository (+5 more)
...
Cohesion: 0.67
Nodes (3): Commands, Database (Supabase), Development

## Knowledge Gaps
- **691 isolated node(s):** `1. Fitur yang sudah selesai`, `Requirement Traceability`, `Environment Management`, `Test Run Enhancement`, `Test Case Productivity` (+686 more)
...
- **Why does `react` connect `Community 8` to `Community 0`, `Community 1`, `Community 4`, `Community 6`, `Community 7`, `Community 10`, `Community 11`, `Community 12`, `What You Must Do When Invoked`, `3. Konsep Test Management`, `Feature Backlog — TestManager`, `Architecture`, `AttachmentPanel.tsx`, `TestCaseDetailPage.tsx`, `statusLabels.ts`, `schema_entity_codes.sql`, `schema_test_management_v2.sql`, `graphify reference: extra exports and benchmark`, `graphify reference: query, path, explain`, `design-review-test-management-v2.md`, `schema_project_roles.sql`, `schema_011_attachments_archive.sql`, `graphify reference: add a URL and watch a folder`, `graphify reference: transcribe video and audio`, `package.json`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `dependencies` connect `ProjectSettingsPage.tsx` to `Community 0`, `primereact`, `@tanstack/react-query`, `TODO — Sprint Board Aktif`, `graphify reference: GitHub clone and cross-repo merge`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `xlsx` connect `Community 0` to `ProjectSettingsPage.tsx`, `Community 4`, `graphify reference: GitHub clone and cross-repo merge`?**
