...
## Corpus Check
- 355 files · ~219,949 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2221 nodes · 4524 edges · 182 communities (147 shown, 35 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 40 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `346f5e04`
...
Cohesion: 0.10
Nodes (39): TestSuiteDialog(), dataTablePaginatorProps, dataTablePaginatorTemplate, FilterToolbar(), FilterToolbarProps, PageHeader(), PageHeaderProps, RowActionsMenu() (+31 more)
...
Cohesion: 0.12
Nodes (14): config, TestCaseChanges, TestCaseWriteInput, toCaseRow(), WriteRepository, WriteRepositoryError, invalid(), marker() (+6 more)
...
Cohesion: 0.07
Nodes (44): supabase, mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapEnvironmentRow(), mapIssueRow(), mapModuleRow(), mapNotificationRow() (+36 more)
...
Cohesion: 0.43
Nodes (6): useAutomation(), useEnvironments(), AutomationPage(), jobSeverity, runnerOnline(), AutomationJobStatus
...
Cohesion: 0.10
Nodes (21): dependencies, @hookform/resolvers, jspdf, jspdf-autotable, primeicons, react-hook-form, react-markdown, react-router-dom (+13 more)
...
Cohesion: 0.13
Nodes (24): mapApiTokenRow(), mapWebhookDeliveryRow(), mapWebhookRow(), useIntegrations(), eventOptions, scopeOptions, integrationRepository, allowedEvents (+16 more)

### Community 28 - "schema_entity_codes.sql"
Cohesion: 0.10
Nodes (27): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, BulkActionsBar(), BulkActionsBarProps, TEST_PLAN_STATUS_SEVERITY, useTestPlanDetail(), useTestRunDetail() (+19 more)
...
Cohesion: 0.15
Nodes (12): IssueDialog(), IssueDialogProps, TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY, TEST_RUN_STATUS_SEVERITY, RESULT_FILTER_OPTIONS, RESULT_OPTIONS, STEP_RESULT_OPTIONS (+4 more)
...
Cohesion: 0.09
Nodes (33): AiTestCaseGeneratorDialog(), maxCaseOptions, priorityOptions, Props, CustomTestRunDialog(), CustomTestRunDialogProps, ImportCasesDialog(), ImportCasesDialogProps (+25 more)
...
Cohesion: 0.12
Nodes (19): IssueEditor(), IssueEditorProps, IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, mapTestRoleRow(), ISSUE_TYPE_LABEL (+11 more)
...
Cohesion: 0.12
Nodes (16): useProjectRepositories(), CreateProjectRepositoryInput, projectRepositoryLinkRepository, UpdateProjectRepositoryInput, CredentialAction, repositoryConnectionRepository, RepositoryConnectionResultRow, RepositoryCredentialRow (+8 more)
...
Cohesion: 0.43
Nodes (4): Breadcrumb(), BreadcrumbProps, useProfileView(), UserDetailPage()
...
Cohesion: 0.18
Nodes (12): mapDashboardReportRunRow(), mapTestResultRow(), DashboardReportIssueRow, DashboardReportResultRow, countRows(), countStatuses(), fetchAllRows(), RangeResult (+4 more)
...
Cohesion: 0.05
Nodes (52): App(), AppLayout(), AppLayoutInner(), AppSidebar(), AppSidebarMask(), AppTopbar(), BreadcrumbContext, BreadcrumbContextValue (+44 more)
...
Cohesion: 0.11
Nodes (24): AdminRoute(), ProtectedRoute(), ActivityPanel(), TABLE_LABELS, BreadcrumbItem, CommentsPanel(), UserHoverCard(), UserHoverCardProps (+16 more)
...
Cohesion: 0.06
Nodes (34): 2026-07-31 — E03-T06 audit filter priority dan status Test Case, 2026-07-31 — E06-T14 status rejected approval user, 2026-07-31 — FIX-00a duplikasi domain TestCase, 2026-07-31 — FIX-00b error TypeScript ProjectDetailPage, 2026-07-31 — Integrasi compile-safe dialogs, notifications, dan profile, 2026-07-31 — MCP-01 fondasi MCP server stdio, 2026-07-31 — MCP-02 autentikasi dan project scoping MCP, 2026-07-31 — MCP-03 helper response bersama (+26 more)
...
Cohesion: 0.07
Nodes (36): ProfileView(), ProfileViewProps, describeSystemEvent(), EVENT_TYPE_LABEL, STATUS_LABEL_BY_ENTITY, statusLabel(), exportTestCasesToExcel(), exportTestCasesToPdf() (+28 more)
...
## Knowledge Gaps
- **808 isolated node(s):** `1. Fitur yang sudah selesai`, `Requirement Traceability`, `Environment Management`, `Test Run Enhancement`, `Test Case Productivity` (+803 more)
...
- **Why does `query()` connect `Community 8` to `Community 1`, `graphify reference: extra exports and benchmark`, `contract.test.ts`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `dependencies` connect `ProjectSettingsPage.tsx` to `primeflex`, `2026-07-31 — FIX-00b error TypeScript ProjectDetailPage`, `react-dom`, `csvImport.ts`, `6. Cross-Cutting Concerns`, `@supabase/supabase-js`, `testSuiteRepository.ts`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `react` connect `schema_entity_codes.sql` to `Community 0`, `Community 1`, `Community 4`, `Community 8`, `Community 10`, `Community 12`, `ARCHITECTURE — TestManager (shiftech-test-mgr)`, `Feature Backlog — TestManager`, `AttachmentPanel.tsx`, `TestCaseDetailPage.tsx`, `statusLabels.ts`, `useAuthContext`, `TestRunDetailPage.tsx`, `schema_auth.sql`, `graphify reference: query, path, explain`, `4. Scope — Modul`, `TestManager (shiftech-test-mgr)`, `schema_project_roles.sql`, `contract.test.ts`, `AppTopbar.tsx`, `useStoredState.ts`, `issueAttachmentRepository.ts`, `graphify reference: transcribe video and audio`, `graphify reference: GitHub clone and cross-repo merge`, `AppLayout.tsx`, `useStoredState.ts`?**
