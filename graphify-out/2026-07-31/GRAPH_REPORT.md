...
## Corpus Check
- 354 files · ~219,279 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2216 nodes · 4493 edges · 188 communities (156 shown, 32 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 40 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f5c0fd67`
...
8. `ReadRepository` - 22 edges
9. `ReadService` - 21 edges
10. `handleAiGateway()` - 20 edges
...
Cohesion: 0.07
Nodes (38): ApiError, AutomationApi, AutomationJob, JobRepository, JobResult, ReportArtifact, ReportPayload, classify() (+30 more)
...
Cohesion: 0.25
Nodes (26): JsonRecord, mapIssueDetailRow(), mapIssueSummaryRow(), mapProjectRow(), mapRequirementCoverageRow(), mapRequirementDetailRow(), mapRequirementSummaryRow(), mapRunCounts() (+18 more)

### Community 7 - "Community 7"
Cohesion: 0.09
Nodes (20): authService, config, readService, server, transport, writeService, config, TestCaseChanges (+12 more)

### Community 8 - "Community 8"
Cohesion: 0.10
Nodes (28): TestSuiteDialog(), ProfileViewProps, CommentsPanel(), dataTablePaginatorProps, dataTablePaginatorTemplate, FilterToolbar(), FilterToolbarProps, PageHeader() (+20 more)
...
Cohesion: 0.09
Nodes (25): mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapProfileRow(), mapProjectMemberRow(), mapProjectMemberWithProfileRow(), mapProjectRow(), mapTestCaseStepRow() (+17 more)
...
Cohesion: 0.27
Nodes (8): PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_SEVERITY, MEMBER_ROLE_OPTIONS, REPOSITORY_SOURCE_LABEL, REPOSITORY_SOURCE_OPTIONS, VISIBILITY_OPTIONS, projectMemberService, ProjectMemberRole

### Community 22 - "Architecture"
Cohesion: 0.13
Nodes (6): normalizePageSize(), ReadRepository, decodeCursor(), ReadService, Project, RequirementCoverage

### Community 23 - "AttachmentPanel.tsx"
Cohesion: 0.13
Nodes (20): supabase, mapIssueRow(), mapModuleRow(), mapTagRow(), mapTestCaseVersionRow(), mapTestPlanCaseRow(), mapTestRoleRow(), commentRepository (+12 more)
...
Cohesion: 0.08
Nodes (25): dependencies, @hookform/resolvers, primeflex, primeicons, primereact, react, react-hook-form, react-markdown (+17 more)
...
Cohesion: 0.12
Nodes (25): mapApiTokenRow(), mapWebhookDeliveryRow(), mapWebhookRow(), useIntegrations(), eventOptions, scopeOptions, integrationRepository, allowedEvents (+17 more)

### Community 28 - "schema_entity_codes.sql"
Cohesion: 0.12
Nodes (22): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, ActivityPanel(), TABLE_LABELS, BulkActionsBar(), BulkActionsBarProps, TEST_PLAN_STATUS_LABEL (+14 more)
...
Cohesion: 0.13
Nodes (22): IssueEditor(), IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, Breadcrumb(), BreadcrumbItem, BreadcrumbProps (+14 more)
...
Cohesion: 0.07
Nodes (51): xlsx, AiTestCaseGeneratorDialog(), maxCaseOptions, priorityOptions, Props, CustomTestRunDialog(), CustomTestRunDialogProps, ImportCasesDialogProps (+43 more)

### Community 40 - "graphify reference: query, path, explain"
Cohesion: 0.15
Nodes (20): exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName(), useDashboardReport(), useEnvironments(), useProfiles(), useProjects(), ALL (+12 more)
...
Cohesion: 0.29
Nodes (7): IssueEditorProps, useIssueEditorOptions(), testRoleRepository, testRoleService, ProjectMember, ProjectMemberWithProfile, TestRole
...
Cohesion: 0.23
Nodes (20): formatDate(), formatDateTime(), useProjectRole(), useScreenSize(), IntegrationsPage(), IssueDetailPage(), ProjectDetailPage(), ProjectSettingsPage() (+12 more)
...
Cohesion: 0.22
Nodes (13): ProjectContext, ProjectContextValue, STATUS_OPTIONS, ProjectOwnerFilter, ProjectPaginatedQuery, ProjectQuery, projectRepository, SORT_COLUMN (+5 more)
...
Cohesion: 0.13
Nodes (16): mapDashboardReportRunRow(), mapTestCaseRow(), mapTestResultRow(), DashboardReportIssueRow, DashboardReportResultRow, countRows(), countStatuses(), dashboardRepository (+8 more)
...
Cohesion: 0.20
Nodes (11): mapTestPlanRow(), mapTestRunAssignmentRow(), mapTestRunRow(), EMPTY_FILTERS, TestRunWithSummary, useTestRuns(), testPlanRepository, TestRunFilters (+3 more)
...
### Community 98 - "useNotifications.ts"
Cohesion: 0.23
...
### Community 139 - "6. Cross-Cutting Concerns"
Cohesion: 0.23
...
### Community 158 - "useAuthContext"
Cohesion: 0.25
Nodes (7): AdminRoute(), ProtectedRoute(), ImportCasesDialog(), useAuthContext(), useProjectBreadcrumbItems(), LoginPage(), PendingApprovalPage()

### Community 161 - "primeflex"
Cohesion: 0.18
...
### Community 165 - "2026-07-31 — FIX-00b error TypeScript ProjectDetailPage"
Cohesion: 0.20
Nodes (9): 2026-07-31 — FIX-00a duplikasi domain TestCase, 2026-07-31 — FIX-00b error TypeScript ProjectDetailPage, 2026-07-31 — Integrasi compile-safe dialogs, notifications, dan profile, 2026-07-31 — MCP-08 write test case/test plan tools, 2026-07-31 — Membuat task integrasi penuh source-new, 2026-07-31 — SRC-07 port helper source-new, 2026-07-31 — SRC-10 sinkronisasi repository source-new, 2026-07-31 — SRC-11 sinkronisasi business rule service source-new (+1 more)

### Community 167 - "4. Scope — Modul"
Cohesion: 0.33
...
Cohesion: 0.13
Nodes (13): loadConfig(), parseReadonly(), requiredEnv(), ServerConfig, AuthenticatedToken, AuthenticationError, AuthRepository, TokenAuthenticationRow (+5 more)

### Community 169 - "2026-07-31 — SRC-04 penyelesaian notification center"
Cohesion: 0.20
...
Cohesion: 0.09
Nodes (24): ProfileView(), DescribableActivityEntry, describeSystemEvent(), EVENT_TYPE_LABEL, STATUS_LABEL_BY_ENTITY, statusLabel(), ACTIVITY_ENTITY_LABEL, ACTIVITY_ENTITY_ROUTE (+16 more)

### Community 176 - "TestManager MCP Server"
Cohesion: 0.22
Nodes (8): Konfigurasi environment, Menjalankan, Persyaratan, Setup, TestManager MCP Server, Tool read batch 1, Tool read batch 2, Tool read batch 3
...
### Community 178 - "AppMenu.tsx"
Cohesion: 0.39
Nodes (6): AppMenu(), AppMenuitem(), AppMenuSeparator(), MenuItemModel, readStoredPins(), useProjectPins()

### Community 179 - "useRealtimeSync.ts"
Cohesion: 0.39
Nodes (4): UserHoverCard(), UserHoverCardProps, queryKeys, useProfile()

### Community 181 - "react-router-dom"
Cohesion: 0.33
Nodes (4): computeDuplicateConfidence(), parseProviderJson(), validateActionOutput(), InMemoryRateLimiter

### Community 183 - "@supabase/supabase-js"
Cohesion: 0.33
...
### Community 184 - "activityRoutes.ts"
Cohesion: 0.09
Nodes (23): CodeCursorQuery, IssueSearchQuery, RequirementListQuery, TestCaseSearchQuery, TestRunListQuery, ArtifactUrl, IssuePriority, IssueStatus (+15 more)

### Community 187 - "registry.ts"
Cohesion: 0.47
Nodes (4): registerTools(), unusedServer, ToolRegistrar, ToolRegistry

## Knowledge Gaps
- **808 isolated node(s):** `2026-07-31 — REPO-08 traceability repository pada Test Run`, `2026-07-31 — REPO-07 mode `local_path` pada runner`, `2026-07-31 — REPO-04 tab Repository di Project Settings`, `2026-07-31 — REPO-02 domain, mapper, dan CRUD project repository links`, `2026-07-31 — REPO-01 project repositories migration` (+803 more)
...
- **Why does `query()` connect `testSuiteRepository.ts` to `Community 1`, `graphify reference: extra exports and benchmark`, `schema_auth.sql`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `react` connect `Community 8` to `Community 0`, `Community 1`, `Community 4`, `Community 10`, `6. Cross-Cutting Concerns`, `Community 12`, `Community 11`, `csvImport.ts`, `ARCHITECTURE — TestManager (shiftech-test-mgr)`, `Feature Backlog — TestManager`, `AttachmentPanel.tsx`, `TestCaseDetailPage.tsx`, `statusLabels.ts`, `schema_entity_codes.sql`, `useAuthContext`, `TestRunDetailPage.tsx`, `schema_auth.sql`, `graphify reference: query, path, explain`, `4. Scope — Modul`, `TestManager (shiftech-test-mgr)`, `schema_project_roles.sql`, `AppTopbar.tsx`, `AppMenu.tsx`, `useRealtimeSync.ts`, `testSuiteRepository.ts`, `useStoredState.ts`, `issueAttachmentRepository.ts`, `graphify reference: transcribe video and audio`, `graphify reference: GitHub clone and cross-repo merge`, `useAuthContext`, `AppLayout.tsx`, `csvImport.ts`, `useStoredState.ts`, `AppTopbar.tsx`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `dependencies` connect `ProjectSettingsPage.tsx` to `primeflex`, `schema_auth.sql`, `csvImport.ts`, `primereact`, `jspdf-autotable`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **What connects `2026-07-31 — REPO-08 traceability repository pada Test Run`, `2026-07-31 — REPO-07 mode `local_path` pada runner`, `2026-07-31 — REPO-04 tab Repository di Project Settings` to the rest of the system?**
