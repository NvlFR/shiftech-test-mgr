...
## Corpus Check
- 302 files · ~196,212 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1824 nodes · 3653 edges · 161 communities (129 shown, 32 thin omitted)
...
- `TestRunIssuesPage()` --indirect_call--> `query()`  [INFERRED]
  frontend/src/pages/test-runs/TestRunIssuesPage.tsx → supabase/functions/ai-gateway/handler.ts
...
Cohesion: 0.07
Nodes (48): AiIssueDraftDialog(), priorities, Props, IssueFormData, aiIssueDraftSchema, assistantEntityTypeSchema, assistantMatchSchema, assistantResponseSchema (+40 more)
...
Cohesion: 0.19
Nodes (13): ISSUE_STATUS_SEVERITY, ISSUE_TYPE_SEVERITY, PROJECT_MEMBER_ROLE_SEVERITY, PROJECT_MEMBER_STATUS_LABEL, PROJECT_MEMBER_STATUS_SEVERITY, PROJECT_VISIBILITY_LABEL, PROJECT_VISIBILITY_SEVERITY, TagSeverity (+5 more)
...
Cohesion: 0.10
Nodes (36): AiAssistantPanel(), TestSuiteDialog(), dataTablePaginatorProps, dataTablePaginatorTemplate, FilterToolbar(), FilterToolbarProps, PageHeader(), PageHeaderProps (+28 more)

### Community 9 - "Community 9"
Cohesion: 0.09
Nodes (28): CustomTestRunDialog(), CustomTestRunDialogProps, ImportCasesDialog(), ImportCasesDialogProps, ImportedTestCaseRow, normalizeHeader(), normalizePriority(), parseTestCaseExcel() (+20 more)
...
Cohesion: 0.19
Nodes (11): PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_SEVERITY, MEMBER_ROLE_OPTIONS, VISIBILITY_OPTIONS, environmentRepository, projectMemberRepository, testRoleRepository, environmentService (+3 more)
...
Cohesion: 0.12
Nodes (26): Props, IssueEditorProps, supabase, mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapEnvironmentRow(), mapProfileRow() (+18 more)

### Community 18 - "3. Konsep Test Management"
Cohesion: 0.11
Nodes (25): mapCicdPipelineRow(), mapRequirementLinkRow(), mapRequirementRow(), cicdRepository, mapLink(), requirementRepository, cicdService, ActivityAction (+17 more)
...
Cohesion: 0.24
Nodes (9): exportTestRunsToExcel(), exportTestRunsToPdf(), fileName(), TestRunExportRow, useDashboard(), downloadCsv(), HomePage(), dashboardRepository (+1 more)

### Community 21 - "Feature Backlog — TestManager"
Cohesion: 0.17
Nodes (14): useCicdPipelines(), useIssuesByTestRun(), useProjectRole(), useTestPlans(), CicdIntegrationPage(), providerOptions, IntegrationsPage(), ProjectDetailPage() (+6 more)

### Community 22 - "Architecture"
Cohesion: 0.19
Nodes (13): mapIssueRow(), mapModuleRow(), mapTagRow(), mapTestCaseVersionRow(), mapTestPlanCaseRow(), mapTestRoleRow(), issueRepository, mapIssueDetails() (+5 more)

### Community 23 - "AttachmentPanel.tsx"
Cohesion: 0.11
Nodes (27): AdminRoute(), ProtectedRoute(), BreadcrumbItem, CommentsPanel(), UserHoverCard(), UserHoverCardProps, ISSUE_PRIORITY_SEVERITY, queryKeys (+19 more)
...
Cohesion: 0.12
Nodes (17): dependencies, @hookform/resolvers, jspdf, jspdf-autotable, primereact, react, remark-gfm, @tanstack/react-query (+9 more)
...
Cohesion: 0.17
Nodes (16): mapApiTokenRow(), mapWebhookDeliveryRow(), mapWebhookRow(), useIntegrations(), eventOptions, scopeOptions, integrationRepository, allowedEvents (+8 more)
...
Cohesion: 0.10
Nodes (26): iconForKind(), NOTIFICATION_KIND_ICON, NotificationPanel(), NotificationPanelProps, ActivityPanel(), TABLE_LABELS, BulkActionsBar(), BulkActionsBarProps (+18 more)
...
Cohesion: 0.16
Nodes (13): useRequirements(), useTestRunDetail(), EMPTY_FILTERS, TestRunWithSummary, Option, PRIORITIES, STATUSES, TYPES (+5 more)
...
Cohesion: 0.17
Nodes (10): mapTestCaseRow(), mapTestResultRow(), mapTestRunAssignmentRow(), mapTestRunRow(), fetchAllRows(), RangeResult, testRunRepository, TestResult (+2 more)
...
Cohesion: 0.15
Nodes (17): mapDashboardReportRunRow(), dashboardReportRepository, DashboardReportResultRow, countRows(), countStatuses(), ACTIVE_ISSUE_STATUSES, calculateIssueAging(), dashboardReportService (+9 more)
...
Cohesion: 0.25
Nodes (7): IssueEditor(), PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, ISSUE_PRIORITY_LABEL, ISSUE_STATUS_LABEL, ISSUE_TYPE_LABEL
...
Cohesion: 0.10
Nodes (20): 2026-07-31 — E03-T06 audit filter priority dan status Test Case, 2026-07-31 — E06-T14 status rejected approval user, 2026-07-31 — FIX-00a duplikasi domain TestCase, 2026-07-31 — FIX-00b error TypeScript ProjectDetailPage, 2026-07-31 — Integrasi compile-safe dialogs, notifications, dan profile, 2026-07-31 — Membuat task integrasi penuh source-new, 2026-07-31 — SRC-01 aktivasi dialog source-new, 2026-07-31 — SRC-02 integrasi komponen Issue (+12 more)

### Community 71 - "useScreenSize.ts"
Cohesion: 0.18
Nodes (11): IssueDialog(), IssueDialogProps, TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY, TEST_RUN_STATUS_SEVERITY, RESULT_FILTER_OPTIONS, RESULT_OPTIONS, STEP_RESULT_OPTIONS (+3 more)
...
Cohesion: 0.18
Nodes (11): 2026-07-31, Antrean Codex lengkap + renumber FEATURE_BACKLOG, Audit fitur repo pembanding, Build hijau kembali + perbaikan desain gate codex-loop, Codex task loop (otomasi antrean task), Commit porting source-new + ignore aset *-new, Penambahan roadmap: MCP server, Playwright interaktif, link repository, SRC-03 — Integrasi layout-new ke layout aktif (+3 more)
...
Cohesion: 0.40
Nodes (4): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, TEST_PLAN_STATUS_LABEL
...
## Knowledge Gaps
- **705 isolated node(s):** `SRC-DOC — Sinkronisasi dokumentasi akhir integrasi source-new`, `SRC-14 — Audit lengkap migration `supabase-new``, `SRC-09b — Port halaman Test Runs, Issues, Test Suites, dan execution detail`, `SRC-03 — Integrasi layout-new ke layout aktif`, `Build hijau kembali + perbaikan desain gate codex-loop` (+700 more)
...
- **Why does `react` connect `AttachmentPanel.tsx` to `Community 0`, `Community 1`, `Community 4`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `3. Konsep Test Management`, `ARCHITECTURE — TestManager (shiftech-test-mgr)`, `Feature Backlog — TestManager`, `TestCaseDetailPage.tsx`, `statusLabels.ts`, `schema_entity_codes.sql`, `schema_test_management_v2.sql`, `graphify reference: extra exports and benchmark`, `schema_auth.sql`, `TestManager (shiftech-test-mgr)`, `schema_project_roles.sql`, `AppTopbar.tsx`, `useProjectBreadcrumbItems.ts`, `graphify reference: transcribe video and audio`, `graphify reference: GitHub clone and cross-repo merge`, `useScreenSize.ts`, `useStoredState.ts`, `jspdf`, `2026-07-31 — FIX-00b error TypeScript ProjectDetailPage`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `query()` connect `Community 8` to `jspdf`, `graphify reference: extra exports and benchmark`, `Feature Backlog — TestManager`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `dependencies` connect `ProjectSettingsPage.tsx` to `primeflex`, `@supabase/supabase-js`, `@tanstack/react-query`, `react-dom`, `react-hook-form`, `zod`, `jspdf`, `react-markdown`, `react-router-dom`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **What connects `SRC-DOC — Sinkronisasi dokumentasi akhir integrasi source-new`, `SRC-14 — Audit lengkap migration `supabase-new``, `SRC-09b — Port halaman Test Runs, Issues, Test Suites, dan execution detail` to the rest of the system?**
