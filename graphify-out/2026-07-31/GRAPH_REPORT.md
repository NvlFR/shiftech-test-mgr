...
## Corpus Check
- 301 files · ~193,680 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1813 nodes · 3460 edges · 154 communities (127 shown, 27 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 25 edges (avg confidence: 0.6)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e23ddeb1`
...
Cohesion: 0.08
Nodes (41): AiTestCaseGeneratorDialog(), maxCaseOptions, priorityOptions, Props, ReviewDraft, CustomTestRunDialogProps, AiTestCaseResponseSchema, AiTestCaseSchema (+33 more)
...
Cohesion: 0.09
Nodes (31): IssueDialog(), IssueDialogProps, IssueEditor(), IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, ISSUE_PRIORITY_LABEL (+23 more)

### Community 7 - "Community 7"
Cohesion: 0.09
Nodes (29): mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapEnvironmentRow(), mapProfileRow(), mapProjectMemberRow(), mapProjectMemberWithProfileRow(), mapTestCaseRow() (+21 more)

### Community 8 - "Community 8"
Cohesion: 0.11
Nodes (20): TestSuiteDialog(), TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, FilterToolbar(), FilterToolbarProps, RowActionsMenu(), RowActionsMenuProps (+12 more)
...
Cohesion: 0.12
Nodes (16): PageHeader(), PageHeaderProps, useCicdPipelines(), useDashboard(), useIntegrations(), ScreenSize, useTestPlans(), downloadCsv() (+8 more)
...
Cohesion: 0.12
Nodes (18): ImportCasesDialog(), ImportCasesDialogProps, Breadcrumb(), BreadcrumbProps, TEST_CASE_PRIORITY_LABEL, TEST_CASE_PRIORITY_SEVERITY, PRIORITY_OPTIONS, TestCaseDetailPage() (+10 more)
...
Cohesion: 0.14
Nodes (18): AdminRoute(), ProtectedRoute(), useAuthContext(), useBackupRetention(), useIssueEditorOptions(), useProjectRole(), LoginPage(), PendingApprovalPage() (+10 more)
...
Cohesion: 0.21
Nodes (12): mapIssueRow(), mapModuleRow(), mapTagRow(), mapTestCaseVersionRow(), mapTestPlanCaseRow(), issueRepository, mapIssueDetails(), mapTestCaseSummary() (+4 more)

### Community 23 - "AttachmentPanel.tsx"
Cohesion: 0.17
Nodes (10): ISSUE_PRIORITY_OPTIONS, ISSUE_STATUS_OPTIONS, PRIORITY_OPTIONS, projectCache, ProjectDetailPage(), ProjectTabData, TAB_DEPENDENCIES, tabDataCache (+2 more)
...
Cohesion: 0.08
Nodes (25): dependencies, @hookform/resolvers, jspdf-autotable, primeicons, primereact, react, react-dom, react-hook-form (+17 more)

### Community 26 - "TestCaseDetailPage.tsx"
Cohesion: 0.06
Nodes (31): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, AttachmentPanel(), AttachmentPanelProps, formatFileSize(), CharacterCount(), CharacterCountProps (+23 more)

### Community 27 - "statusLabels.ts"
Cohesion: 0.12
Nodes (24): mapApiTokenRow(), mapWebhookDeliveryRow(), mapWebhookRow(), integrationRepository, testResultStepRepository, allowedEvents, integrationService, testResultStepService (+16 more)
...
Cohesion: 0.13
Nodes (21): ActivityPanel(), TABLE_LABELS, BulkActionsBar(), BulkActionsBarProps, formatDateTime(), TEST_PLAN_STATUS_SEVERITY, useActivity(), useTestPlanDetail() (+13 more)
...
Cohesion: 0.27
Nodes (8): PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_SEVERITY, useEnvironments(), MEMBER_ROLE_OPTIONS, ProjectSettingsPage(), VISIBILITY_OPTIONS, environmentRepository, environmentService
...
Cohesion: 0.27
Nodes (10): mapProjectRow(), ProjectOwnerFilter, ProjectPaginatedQuery, ProjectQuery, projectRepository, SORT_COLUMN, ProjectSortField, ProjectStatus (+2 more)
...
Cohesion: 0.19
Nodes (13): App(), BreadcrumbItem, CommentsPanel(), AuthContext, AuthContextValue, AuthProvider(), useComments(), useProfiles() (+5 more)

### Community 43 - "TestManager (shiftech-test-mgr)"
Cohesion: 0.11
Nodes (22): ProfileView(), ProfileViewProps, ISSUE_STATUS_SEVERITY, ISSUE_TYPE_SEVERITY, PROJECT_MEMBER_ROLE_SEVERITY, PROJECT_MEMBER_STATUS_LABEL, PROJECT_MEMBER_STATUS_SEVERITY, PROJECT_VISIBILITY_LABEL (+14 more)
...
Cohesion: 0.52
Nodes (6): mapAttachmentRow(), findAll(), pathFor(), remove(), upload(), withSignedUrl()
...
Cohesion: 0.17
Nodes (11): supabase, mapNotificationRow(), mapTestPlanRow(), commentRepository, profileRepository, testPlanRepository, commentService, Comment (+3 more)
...
Cohesion: 0.29
Nodes (7): mapCicdPipelineRow(), cicdRepository, CicdIngestPayload, CicdIngestResponse, CicdPipeline, CicdPipelineSecret, CicdProvider
...
Cohesion: 0.33
Nodes (6): useRequirements(), Option, PRIORITIES, RequirementsPage(), STATUSES, TYPES

### Community 72 - "package.json"
Cohesion: 0.50
Nodes (4): ProjectContext, ProjectContextValue, ProjectProvider(), Project
...
## Knowledge Gaps
- **695 isolated node(s):** `SRC-03 — Integrasi layout-new ke layout aktif`, `Build hijau kembali + perbaikan desain gate codex-loop`, `Commit porting source-new + ignore aset *-new`, `Antrean Codex lengkap + renumber FEATURE_BACKLOG`, `Codex task loop (otomasi antrean task)` (+690 more)
...
- **Why does `react` connect `Community 11` to `Community 0`, `Community 1`, `Community 4`, `Community 6`, `Community 8`, `Community 10`, `Community 12`, `What You Must Do When Invoked`, `3. Konsep Test Management`, `ARCHITECTURE — TestManager (shiftech-test-mgr)`, `Feature Backlog — TestManager`, `AttachmentPanel.tsx`, `TestCaseDetailPage.tsx`, `statusLabels.ts`, `schema_entity_codes.sql`, `schema_test_management_v2.sql`, `graphify reference: extra exports and benchmark`, `schema_auth.sql`, `graphify reference: query, path, explain`, `useTheme.tsx`, `schema_project_roles.sql`, `AppTopbar.tsx`, `issueAttachmentRepository.ts`, `graphify reference: transcribe video and audio`, `dataTablePaginator.tsx`, `useScreenSize.ts`, `package.json`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `dependencies` connect `ProjectSettingsPage.tsx` to `jspdf-autotable`, `README.md`, `testSuiteRepository.ts`, `Feature Backlog — TestManager`, `react-dom`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `query()` connect `graphify reference: extra exports and benchmark` to `Community 1`, `graphify reference: extra exports and benchmark`, `Community 6`, `Community 8`, `Feature Backlog — TestManager`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **What connects `SRC-03 — Integrasi layout-new ke layout aktif`, `Build hijau kembali + perbaikan desain gate codex-loop`, `Commit porting source-new + ignore aset *-new` to the rest of the system?**
