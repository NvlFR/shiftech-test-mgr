...
## Corpus Check
- 465 files · ~291,003 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2906 nodes · 5968 edges · 252 communities (198 shown, 54 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 48 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b419b50f`
...
6. `supabase` - 38 edges
7. `2026-08-01 — E2E-09 fallback eksekusi manual tanpa automation script` - 33 edges
8. `useProjectRole()` - 32 edges
9. `ServerConfig` - 29 edges
...
Cohesion: 0.16
Nodes (9): execFileAsync, ProjectRepositoryConfig, RepoRepository, RepositoryConfigRow, RepositorySourceType, RepoDiff, RepoService, fixture() (+1 more)
...
Cohesion: 0.12
Nodes (12): readJsonBody(), RemoteTransport, RunningHttpTransport, sendJsonError(), startHttpTransport(), config, AuthenticationError, AuthRepository (+4 more)

### Community 4 - "Community 4"
Cohesion: 0.15
Nodes (13): byteLength(), ErrorDetail, ErrorEnvelope, errorResponse(), McpToolError, paginatedResponse(), PaginationInput, PaginationMeta (+5 more)
...
Cohesion: 0.09
Nodes (33): IssueEditorProps, PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_SEVERITY, MEMBER_ROLE_OPTIONS, PERMISSION_OPTIONS, REPOSITORY_SOURCE_LABEL, REPOSITORY_SOURCE_OPTIONS, VISIBILITY_OPTIONS (+25 more)
...
Cohesion: 0.14
Nodes (14): AdminRoute(), ProtectedRoute(), auth, UserHoverCard(), UserHoverCardProps, queryKeys, AuthContext, AuthContextValue (+6 more)
...
Cohesion: 0.05
Nodes (73): JsonRecord, mapAnalysisRunSummaryRow(), mapFlakyCandidateRow(), mapIssueDetailRow(), mapIssueSummaryRow(), mapProjectRow(), mapRequirementCoverageRow(), mapRequirementDetailRow() (+65 more)

### Community 12 - "Community 12"
Cohesion: 0.05
Nodes (51): jspdf, xlsx, exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName(), mapDashboardQaLoopAuditRow(), mapDashboardReportRunRow(), normalizeHeader() (+43 more)
...
Cohesion: 0.06
Nodes (41): IssueDialog(), IssueDialogProps, mapTestRunAssignmentRow(), mapTestRunRow(), TEST_PLAN_STATUS_SEVERITY, TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY, TEST_RUN_STATUS_SEVERITY (+33 more)

### Community 17 - "What You Must Do When Invoked"
Cohesion: 0.09
Nodes (26): AiTestCaseReviewPage(), draft, drafts, mocks, modules, tags, mocks, failResult (+18 more)

### Community 18 - "3. Konsep Test Management"
Cohesion: 0.06
Nodes (58): AiTestCaseGeneratorDialog(), maxCaseOptions, priorityOptions, Props, CustomTestRunDialog(), CustomTestRunDialogProps, ImportCasesDialog(), ImportCasesDialogProps (+50 more)

### Community 19 - "2026-07-22"
Cohesion: 0.14
Nodes (20): successResponse(), withErrorHandling(), AuthenticatedToken, createMcpServer(), ProjectSession, annotations, createAnalysisToolRegistrar(), limit (+12 more)
...
Cohesion: 0.22
Nodes (11): mapCicdPipelineRow(), useCicdPipelines(), providerOptions, cicdRepository, cicdService, CicdIngestPayload, CicdIngestResponse, CicdPipeline (+3 more)

### Community 25 - "ProjectSettingsPage.tsx"
Cohesion: 0.08
Nodes (28): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, ProfileViewProps, CharacterCount(), CharacterCountProps, describeSystemEvent(), EVENT_TYPE_LABEL (+20 more)

### Community 26 - "TestCaseDetailPage.tsx"
Cohesion: 0.11
Nodes (24): ApiError, AutomationJob, AutomationJobCommand, CodegenTestCaseStep, EnvironmentMetadata, JobRepository, ReportPayload, RunnerConfig (+16 more)

### Community 27 - "statusLabels.ts"
Cohesion: 0.06
Nodes (43): App(), AppLayout(), AppLayoutInner(), AppMenu(), AppMenuitem(), AppMenuSeparator(), MenuItemModel, AppSidebar() (+35 more)
...
Cohesion: 0.15
Nodes (19): mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapProfileRow(), mapProjectMemberRow(), mapProjectMemberWithProfileRow(), mapTestCaseRow(), mapTestCaseVersionRow() (+11 more)

### Community 31 - "shiftech-test-mgr (TestManager) — OpenCode Project Rules"
Cohesion: 0.06
Nodes (33): 2026-08-01 — ADM-01 Scheduled Test Run, 2026-08-01 — ADM-02 pembatasan eksekusi dan secret management runner, 2026-08-01 — ADM-02 percobaan ulang gate verifikasi, 2026-08-01 — ADM-03 percobaan ulang gate verifikasi, 2026-08-01 — ADM-03 permission granular per project, 2026-08-01 — ADM-04 Team management, 2026-08-01 — ADM-04 Team management (perbaikan gate verifikasi), 2026-08-01 — ADM-05 Activity feed per Project (+25 more)
...
Cohesion: 0.18
Nodes (10): BeginToolCallResult, BeginToolCallRow, GovernanceRepository, GovernanceService, ToolRateLimitError, installToolGovernance(), registerTools(), unusedServer (+2 more)

### Community 35 - "graphify reference: extra exports and benchmark"
Cohesion: 0.17
Nodes (21): boolEnv(), intEnv(), InteractiveRunnerConfig, loadConfig(), loadDotEnv(), loadInteractiveConfig(), nonNegativeIntEnv(), parseCliInput() (+13 more)
...
Cohesion: 0.20
Nodes (10): ProfileView(), CommentsPanel(), useComments(), useProfileView(), UserDetailPage(), profileRepository, testSuiteRepository, profileService (+2 more)
...
Cohesion: 0.22
Nodes (12): AiAssistantPanel(), parseAssistantResult(), useAiAssistant(), aiAssistantService, AiActorContext, AiAssistantEntityType, AiAssistantMatch, AiAssistantSearchRequest (+4 more)

### Community 51 - "testSuiteRepository.ts"
Cohesion: 0.21
Nodes (10): useTestResultDetail(), displayText(), EvidenceViewer(), TAB_TYPES, TestResultDetailPage(), testResultService, TEXT_ARTIFACT_TYPES, AutomationArtifact (+2 more)
...
Cohesion: 0.21
Nodes (15): mapProjectRow(), ProjectContext, ProjectContextValue, STATUS_OPTIONS, ProjectOwnerFilter, ProjectPaginatedQuery, ProjectQuery, projectRepository (+7 more)
...
Cohesion: 0.60
Nodes (3): mapTestPlanScheduleRow(), ScheduleInput, testPlanScheduleRepository

### Community 59 - "schema_project_members.sql"
Cohesion: 0.18
Nodes (14): ReportArtifact, classifyArtifact(), collectArtifacts(), CollectedArtifact, hasCompleteFailureBundle(), REQUIRED_FAILURE_ARTIFACT_TYPES, walk(), emit() (+6 more)
...
Cohesion: 0.09
Nodes (33): IssueEditor(), IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, Breadcrumb(), BreadcrumbItem, BreadcrumbProps (+25 more)

### Community 64 - "TODO — Sprint Board Aktif"
Cohesion: 0.14
Nodes (27): activityDetail(), ActivityPanel(), TABLE_LABELS, formatDate(), formatDateTime(), useActivity(), useEnvironments(), useProjectRole() (+19 more)
...
Cohesion: 0.18
Nodes (14): JobResult, BaseUrlSanityCheckResult, checkBaseUrlReachable(), connectionDetail(), FetchLike, executeJob(), ExecutionMode, ExecutionOutcome (+6 more)
...
Cohesion: 0.23
Nodes (8): buildDuplicateReason(), toIssuePriority(), AiGatewayRequest, aiRepository, assertActor(), assertAiProjectScope(), AiGatewayDuplicateRequest, AiGatewayIssueDraftRequest
...
Cohesion: 0.29
Nodes (9): AiIssueDraftDialog(), priorities, Props, useAiIssueWorkflow(), aiIssueService, AiIssueDraft, DuplicateIssueCandidate, Issue (+1 more)
...
Cohesion: 0.16
Nodes (13): supabase, mapEnvironmentRow(), mapIssueRow(), mapModuleRow(), mapTagRow(), mapTestCaseStepRow(), environmentRepository, issueRepository (+5 more)
...
Cohesion: 0.10
Nodes (16): loadConfig(), parseBoundedInteger(), parseReadonly(), parseRerunFailedMaxTests(), requiredEnv(), ServerConfig, baseEnv, AnalysisRepositoryError (+8 more)
...
### Community 140 - "testResultRepository.ts"
Cohesion: 0.29
Nodes (6): mapTestResultRow(), mapTestResultScreenshotHistoryRow(), testResultRepository, AiIssueEnvironment, TestResult, TestResultScreenshotHistory

### Community 141 - "schema_025_fix_pgcrypto_and_audit.sql"
Cohesion: 0.19
Nodes (15): mapProjectTeamRow(), mapTeamRow(), mapTeamWithMembersRow(), useProjectTeams(), useTeams(), ProjectTeamsPage(), roles, TeamsPage() (+7 more)
...
### Community 144 - "testResultStepRepository.ts"
Cohesion: 0.47
...
### Community 162 - "activityRepository.ts"
Cohesion: 0.47
Nodes (3): activityRepository, activityService, ActivityEvent
...
## Knowledge Gaps
- **1040 isolated node(s):** `supabase`, `$schema`, `typescript`, `oxc`, `react/rules-of-hooks` (+1035 more)
...
- **Why does `useAiTestCaseReview()` connect `3. Konsep Test Management` to `What You Must Do When Invoked`, `Community 2`?**
  _High betweenness centrality (0.112) - this node is a cross-community bridge._
- **Why does `WriteService` connect `Community 2` to `TestRunDetailPage.tsx`, `2026-07-22`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `react` connect `testRunService.ts` to `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 12`, `schema_025_fix_pgcrypto_and_audit.sql`, `Community 14`, `Community 16`, `3. Konsep Test Management`, `ProjectSettingsPage.tsx`, `statusLabels.ts`, `schema_p2_workflow.sql`, `Coding Conventions`, `graphify reference: query, path, explain`, `react-hook-form`, `schema_project_lifecycle.sql`, `testSuiteRepository.ts`, `graphify reference: commit hook and native CLAUDE.md integration`, `graphify reference: incremental update and cluster-only`, `issueAttachmentRepository.ts`, `issueService.ts`, `TODO — Sprint Board Aktif`, `schema_issue_attachments.sql`, `schema_017_p1_rpc_hardening.sql`, `schema_018_p2_dashboard_reporting.sql`, `activityDescribe.ts`, `@supabase/supabase-js`, `domain.ts`?**
