...
## Corpus Check
- 289 files · ~191,641 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1771 nodes · 3528 edges · 150 communities (127 shown, 23 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 26 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9b43e4ad`
...
Cohesion: 0.18
Nodes (10): mapTestCaseRow(), mapTestResultRow(), mapTestResultStepRow(), fetchAllRows(), RangeResult, testResultRepository, testResultStepRepository, testResultStepService (+2 more)
...
Cohesion: 0.09
Nodes (25): mapCommentMentionRow(), mapCommentRow(), mapEnvironmentRow(), mapProfileRow(), mapProjectMemberRow(), mapProjectMemberWithProfileRow(), mapTestCaseStepRow(), mapTestSuiteItemRow() (+17 more)
...
Cohesion: 0.18
Nodes (12): FilterToolbar(), FilterToolbarProps, RowActionsMenu(), RowActionsMenuProps, SearchInput(), SearchInputProps, TEST_CASE_PRIORITY_SEVERITY, EMPTY_FORM (+4 more)
...
Cohesion: 0.08
Nodes (27): AdminRoute(), ProtectedRoute(), AppLayout(), AppLayoutInner(), AppMenu(), AppMenuitem(), AppMenuSeparator(), MenuItemModel (+19 more)
...
Cohesion: 0.10
Nodes (35): ProfileView(), ActivityPanel(), formatDateTime(), TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY, TEST_RUN_STATUS_LABEL, TEST_RUN_STATUS_SEVERITY, useProjectRole() (+27 more)
...
Cohesion: 0.08
Nodes (29): STATUS_OPTIONS, TestPlanDialogProps, TestSuiteDialog(), TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, AttachmentPanel(), AttachmentPanelProps (+21 more)
...
Cohesion: 0.18
Nodes (13): ProfileViewProps, ISSUE_STATUS_SEVERITY, PROJECT_MEMBER_ROLE_LABEL, PROJECT_MEMBER_ROLE_SEVERITY, PROJECT_MEMBER_STATUS_LABEL, PROJECT_MEMBER_STATUS_SEVERITY, PROJECT_STATUS_SEVERITY, PROJECT_VISIBILITY_LABEL (+5 more)

### Community 82 - "Coding Conventions"
Cohesion: 0.13
Nodes (21): BulkActionsBar(), BulkActionsBarProps, PageHeader(), PageHeaderProps, USER_ROLE_LABEL, USER_ROLE_SEVERITY, useDashboardReport(), useEnvironments() (+13 more)
...
Cohesion: 0.20
Nodes (13): mapTestPlanRow(), TEST_PLAN_STATUS_LABEL, TEST_PLAN_STATUS_SEVERITY, useTestPlans(), ProjectTestPlanTabProps, STATUS_OPTIONS, TEST_PLAN_STATUS_OPTIONS, TestPlansPage() (+5 more)
...
Cohesion: 0.16
Nodes (13): IssueEditorProps, IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, toastHelper, testRoleService, AiIssueCandidateInput (+5 more)

### Community 109 - "PageHeader.tsx"
Cohesion: 0.24
Nodes (9): iconForKind(), NOTIFICATION_KIND_ICON, NotificationPanel(), NotificationPanelProps, BreadcrumbTrail(), mapNotificationRow(), notificationRepository, notificationService (+1 more)
...
Cohesion: 0.12
Nodes (24): mapDashboardReportRunRow(), DashboardReportIssueRow, dashboardReportRepository, DashboardReportResultRow, ACTIVE_ISSUE_STATUSES, calculateIssueAging(), dashboardReportService, percent() (+16 more)
...
### Community 125 - "jspdf"
Cohesion: 0.32
Nodes (7): jspdf, xlsx, exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName(), jspdf, xlsx

### Community 126 - "testCaseStepRepository.ts"
Cohesion: 0.07
Nodes (41): AiTestCaseGeneratorDialog(), maxCaseOptions, priorityOptions, Props, CustomTestRunDialog(), CustomTestRunDialogProps, ImportCasesDialog(), ImportCasesDialogProps (+33 more)
...
Cohesion: 0.08
Nodes (21): TABLE_LABELS, UserHoverCardProps, supabase, mapActivityEventRow(), mapTestRoleRow(), mapTestRunAssignmentRow(), mapTestRunRow(), AuthContext (+13 more)
...
## Knowledge Gaps
- **684 isolated node(s):** `1. Fitur yang sudah selesai`, `Requirement Traceability`, `Environment Management`, `Test Run Enhancement`, `Test Case Productivity` (+679 more)
...
- **Why does `dependencies` connect `Community 4` to `package.json`, `jspdf`, `PageHeader.tsx`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `query()` connect `statusLabels.ts` to `TestRunDetailPage.tsx`, `schema_requirement_traceability.sql`, `handler.ts`, `csvImport.ts`, `testCaseStepRepository.ts`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `react` connect `Coding Conventions` to `primereact`, `react-hook-form`, `Community 1`, `@supabase/supabase-js`, `Community 2`, `Community 7`, `Community 9`, `Community 12`, `Community 13`, `statusLabels.ts`, `Coding Conventions`, `TestSuitesPage.tsx`, `schema_requirement_traceability.sql`, `backupRetentionRepository.ts`, `CLAUDE.md`, `csvImport.ts`, `renderMentions.tsx`, `TestRunDetailPage.tsx`, `DashboardReportPage.tsx`, `ProjectsPage.tsx`, `react-router-dom`, `PageHeader.tsx`, `primeicons`, `react-router-dom`, `testCaseStepRepository.ts`?**
