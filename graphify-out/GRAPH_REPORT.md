...
## Corpus Check
- 441 files · ~274,430 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2763 nodes · 5637 edges · 227 communities (184 shown, 43 thin omitted)
...
Cohesion: 0.14
Nodes (26): AdminRoute(), ProtectedRoute(), auth, CommentsPanel(), formatDate(), formatDateTime(), useAuthContext(), useComments() (+18 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (36): IssueEditor(), IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, describeSystemEvent(), EVENT_TYPE_LABEL, STATUS_LABEL_BY_ENTITY (+28 more)

### Community 8 - "Community 8"
Cohesion: 0.09
Nodes (22): byteLength(), ErrorDetail, ErrorEnvelope, errorResponse(), McpToolError, paginatedResponse(), PaginationInput, PaginationMeta (+14 more)
...
Cohesion: 0.11
Nodes (18): BeginToolCallResult, BeginToolCallRow, GovernanceRepository, GovernanceRepositoryError, config, createMcpServer(), GovernanceService, ToolRateLimitError (+10 more)
...
Cohesion: 0.14
Nodes (20): AppMenu(), AppMenuitem(), AppMenuSeparator(), MenuItemModel, mapProjectRow(), useProjectPins(), useProjects(), readStoredValue() (+12 more)
...
Cohesion: 0.08
Nodes (28): CustomTestRunDialog(), CustomTestRunDialogProps, ImportCasesDialog(), ImportCasesDialogProps, BulkActionsBar(), BulkActionsBarProps, downloadTestCaseImportTemplate(), exportTestCasesToExcel() (+20 more)
...
Cohesion: 0.09
Nodes (21): loadConfig(), parseBoundedInteger(), parseReadonly(), parseRerunFailedMaxTests(), requiredEnv(), ServerConfig, baseEnv, body() (+13 more)
...
Cohesion: 0.09
Nodes (36): AiAssistantPanel(), AiTestCaseGeneratorDialog(), maxCaseOptions, priorityOptions, Props, TEST_CASE_PRIORITY_LABEL, TEST_CASE_PRIORITY_SEVERITY, TEST_CASE_STATUS_LABEL (+28 more)
...
Cohesion: 0.07
Nodes (64): JsonRecord, mapAnalysisRunSummaryRow(), mapFlakyCandidateRow(), mapIssueDetailRow(), mapIssueSummaryRow(), mapProjectRow(), mapRequirementCoverageRow(), mapRequirementDetailRow() (+56 more)
...
Cohesion: 0.10
Nodes (32): mapAutomationJobLogRow(), mapAutomationJobRow(), mapAutomationRunnerRow(), mapAutomationScriptRow(), useAutomation(), useAutomationJobLogs(), AutomationPage(), jobSeverity (+24 more)
...
Cohesion: 0.11
Nodes (19): mapProjectRepositoryRow(), projectMemberRepository, CreateProjectRepositoryInput, projectRepositoryLinkRepository, UpdateProjectRepositoryInput, CredentialAction, repositoryConnectionRepository, RepositoryConnectionResultRow (+11 more)
...
Cohesion: 0.05
Nodes (60): AiIssueDraftDialog(), priorities, Props, aiIssueDraftSchema, artifactSchema, assistantEntityTypeSchema, assistantMatchSchema, assistantResponseSchema (+52 more)
...
Cohesion: 0.15
Nodes (17): mapDashboardReportRunRow(), DashboardReportIssueRow, dashboardReportRepository, DashboardReportResultRow, fetchAllRows(), RangeResult, ACTIVE_ISSUE_STATUSES, calculateIssueAging() (+9 more)
...
Cohesion: 0.07
Nodes (38): AppLayout(), AppLayoutInner(), AppSidebar(), AppSidebarMask(), AppTopbar(), BreadcrumbContext, BreadcrumbContextValue, BreadcrumbItem (+30 more)
...
Cohesion: 0.15
Nodes (14): mapTestPlanRow(), mapTestRunAssignmentRow(), mapTestRunRow(), EMPTY_FILTERS, TestRunWithSummary, profileRepository, testPlanRepository, TestRunFilters (+6 more)
...
Cohesion: 0.11
Nodes (18): App(), ProfileView(), Breadcrumb(), BreadcrumbItem, BreadcrumbProps, UserHoverCard(), UserHoverCardProps, queryKeys (+10 more)
...
Cohesion: 0.11
Nodes (16): supabase, mapEnvironmentRow(), mapNotificationRow(), mapTestCaseStepRow(), commentRepository, environmentRepository, moduleRepository, notificationRepository (+8 more)
...
Cohesion: 0.13
Nodes (11): execFileAsync, ProjectRepositoryConfig, RepoRepository, RepoRepositoryError, RepositoryConfigRow, RepositorySourceType, config, RepoService (+3 more)
...
Cohesion: 0.09
Nodes (24): IssueDialog(), IssueDialogProps, ActivityPanel(), TABLE_LABELS, PageHeader(), PageHeaderProps, TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY (+16 more)
...
Cohesion: 0.14
Nodes (18): IssueEditorProps, PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_SEVERITY, useDashboardReport(), useEnvironments(), useProfiles(), ALL, DashboardReportPage() (+10 more)

### Community 238 - "useRealtimeSync.ts"
Cohesion: 0.12
Nodes (22): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, TEST_PLAN_STATUS_LABEL, TEST_PLAN_STATUS_SEVERITY, useModules(), useTestPlanDetail(), useTestRuns() (+14 more)

## Knowledge Gaps
- **997 isolated node(s):** `supabase`, `$schema`, `typescript`, `oxc`, `react/rules-of-hooks` (+992 more)
...
- **Why does `useAiTestCaseReview()` connect `Coding Conventions` to `Community 11`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
- **Why does `WriteService` connect `Community 11` to `What You Must Do When Invoked`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **Why does `react` connect `TestResultDetailPage.tsx` to `Community 0`, `Community 6`, `Community 7`, `Community 10`, `Community 12`, `Community 16`, `ARCHITECTURE — TestManager (shiftech-test-mgr)`, `Feature Backlog — TestManager`, `AttachmentPanel.tsx`, `TestCaseDetailPage.tsx`, `Coding Conventions`, `useEnvironments.ts`, `TestManager (shiftech-test-mgr)`, `schema_project_roles.sql`, `AppTopbar.tsx`, `testSuiteRepository.ts`, `package.json`, `issueAttachmentRepository.ts`, `graphify reference: transcribe video and audio`, `useNotifications.ts`, `useTheme.tsx`, `csvImport.ts`, `AppTopbar.tsx`, `cicdRepository.ts`, `TestSuiteDialog.tsx`, `csvImport.ts`, `useRealtimeSync.ts`?**
