...
## Corpus Check
- 406 files · ~249,258 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2553 nodes · 5278 edges · 218 communities (173 shown, 45 thin omitted)
...
9. `2026-07-31 — MCP-08 write test case/test plan tools` - 26 edges
...
Cohesion: 0.07
Nodes (41): xlsx, Props, CustomTestRunDialog(), CustomTestRunDialogProps, ImportCasesDialogProps, downloadTestCaseImportTemplate(), exportTestCasesToExcel(), PROJECT_MEMBER_ROLE_LABEL (+33 more)
...
Cohesion: 0.11
Nodes (23): byteLength(), ErrorDetail, ErrorEnvelope, errorResponse(), PaginationInput, PaginationMeta, SuccessEnvelope, successResponse() (+15 more)
...
Cohesion: 0.10
Nodes (27): TestSuiteDialog(), dataTablePaginatorProps, dataTablePaginatorTemplate, FilterToolbar(), FilterToolbarProps, RowActionsMenu(), RowActionsMenuProps, SearchInput() (+19 more)
...
Cohesion: 0.10
Nodes (24): IssueDialog(), IssueDialogProps, PageHeader(), PageHeaderProps, ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY, TEST_RUN_STATUS_SEVERITY, useRequirements() (+16 more)

### Community 17 - "What You Must Do When Invoked"
Cohesion: 0.07
Nodes (32): ProfileViewProps, DescribableActivityEntry, describeSystemEvent(), EVENT_TYPE_LABEL, STATUS_LABEL_BY_ENTITY, statusLabel(), ACTIVITY_ENTITY_LABEL, ACTIVITY_ENTITY_ROUTE (+24 more)

### Community 18 - "3. Konsep Test Management"
Cohesion: 0.17
Nodes (13): AiAssistantPanel(), exportTestRunsToExcel(), exportTestRunsToPdf(), fileName(), TestRunExportRow, useAiAssistant(), useDashboard(), ProjectContext (+5 more)
...
Cohesion: 0.19
Nodes (13): mapDashboardReportRunRow(), dashboardReportRepository, DashboardReportResultRow, ACTIVE_ISSUE_STATUSES, calculateIssueAging(), dashboardReportService, percent(), RESULT_STATUSES (+5 more)
...
Cohesion: 0.12
Nodes (21): ProfileView(), Breadcrumb(), BreadcrumbItem, BreadcrumbProps, CommentsPanel(), ISSUE_TYPE_LABEL, ISSUE_TYPE_SEVERITY, AuthContext (+13 more)
...
Cohesion: 0.12
Nodes (26): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, ActivityPanel(), TABLE_LABELS, BulkActionsBar(), BulkActionsBarProps, formatDateTime() (+18 more)
...
Cohesion: 0.09
Nodes (23): mapTestPlanRow(), mapTestResultRow(), mapTestResultScreenshotHistoryRow(), mapTestRunAssignmentRow(), mapTestRunRow(), calculateTestRunSummary(), EMPTY_FILTERS, fetchAllRows() (+15 more)
...
Cohesion: 0.13
Nodes (18): IssueEditor(), IssueEditorProps, IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, DashboardReportIssueRow, projectMemberRepository (+10 more)
...
Cohesion: 0.08
Nodes (26): 2026-07-31 — MCP-08 write test case/test plan tools, 2026-07-31 — MCP-09 gate manusia approval Test Plan, 2026-07-31 — MCP-11 workflow Issue, 2026-07-31 — MCP-12 tool Automation, 2026-07-31 — MCP-13 selective rerun failed, 2026-07-31 — MCP-15 tool analisis, 2026-07-31 — MCP-16 rate limit dan audit tool MCP, 2026-08-01 — Eksekusi seluruh migration melalui MCP Supabase (+18 more)
...
Cohesion: 0.13
Nodes (27): App(), AdminRoute(), ProtectedRoute(), ImportCasesDialog(), formatDate(), AuthProvider(), useAuthContext(), useIssuesByTestRun() (+19 more)
...
Cohesion: 0.15
Nodes (10): execFileAsync, ProjectRepositoryConfig, RepoRepository, RepositoryConfigRow, RepositorySourceType, RepoDiff, RepoService, fixture() (+2 more)
...
Cohesion: 0.14
Nodes (13): supabase, mapEnvironmentRow(), mapTestCaseStepRow(), commentRepository, environmentRepository, moduleRepository, tagRepository, testCaseStepRepository (+5 more)
...
Cohesion: 0.26
Nodes (11): jspdf, exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName(), useDashboardReport(), useEnvironments(), useProfiles(), useProjects() (+3 more)

## Knowledge Gaps
- **901 isolated node(s):** `supabase`, `$schema`, `typescript`, `oxc`, `react/rules-of-hooks` (+896 more)
...
- **Why does `query()` connect `ProjectDataManagementPage.tsx` to `3. Konsep Test Management`, `graphify reference: extra exports and benchmark`, `Community 4`?**
  _High betweenness centrality (0.141) - this node is a cross-community bridge._
- **Why does `react` connect `3. Konsep Test Management` to `Community 0`, `Community 1`, `Community 4`, `Community 7`, `Community 8`, `csvImport.ts`, `Community 10`, `Community 12`, `Community 16`, `What You Must Do When Invoked`, `ARCHITECTURE — TestManager (shiftech-test-mgr)`, `Feature Backlog — TestManager`, `TestCaseDetailPage.tsx`, `statusLabels.ts`, `schema_auth.sql`, `ProjectDataManagementPage.tsx`, `TestManager (shiftech-test-mgr)`, `schema_project_roles.sql`, `AppTopbar.tsx`, `ReadService`, `issueAttachmentRepository.ts`, `graphify reference: transcribe video and audio`, `graphify reference: GitHub clone and cross-repo merge`, `react-dom`, `zod`, `AppMenu.tsx`, `useEnvironments.ts`, `useProfile.ts`, `AppTopbar.tsx`, `ProjectSettingsPage.tsx`, `csvImport.ts`, `smoke.spec.ts`?**
