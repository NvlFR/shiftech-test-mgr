...
## Summary
- 2405 nodes · 4978 edges · 198 communities (162 shown, 36 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 43 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f1b5a129`
...
Cohesion: 0.05
Nodes (61): AiIssueDraftDialog(), priorities, Props, IssueEditor(), IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS (+53 more)
...
Cohesion: 0.18
Nodes (11): mapTestPlanRow(), mapTestRunAssignmentRow(), mapTestRunRow(), calculateTestRunSummary(), EMPTY_FILTERS, useTestRuns(), testPlanRepository, TestRunFilters (+3 more)
...
Cohesion: 0.16
Nodes (10): UserHoverCard(), UserHoverCardProps, mapNotificationRow(), queryKeys, useProfile(), activityRepository, notificationRepository, activityService (+2 more)
...
Cohesion: 0.09
Nodes (23): dependencies, @hookform/resolvers, jspdf-autotable, primeflex, primeicons, react, react-hook-form, react-markdown (+15 more)
...
Cohesion: 0.11
Nodes (19): byteLength(), ErrorDetail, ErrorEnvelope, errorResponse(), PaginationInput, PaginationMeta, SuccessEnvelope, successResponse() (+11 more)
...
Cohesion: 0.08
Nodes (42): Props, CustomTestRunDialog(), CustomTestRunDialogProps, ImportCasesDialog(), ImportCasesDialogProps, downloadTestCaseImportTemplate(), exportTestCasesToExcel(), exportTestCasesToPdf() (+34 more)
...
Cohesion: 0.10
Nodes (19): CodeCursorQuery, IssueSearchQuery, ArtifactUrl, IssuePriority, IssueStatus, RequirementLink, RequirementPriority, RequirementStatus (+11 more)
...
Cohesion: 0.06
Nodes (42): AppLayout(), AppLayoutInner(), AppMenu(), AppMenuitem(), AppMenuSeparator(), MenuItemModel, AppSidebar(), AppSidebarMask() (+34 more)
...
Cohesion: 0.07
Nodes (49): IssueEditorProps, supabase, mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapEnvironmentRow(), mapIssueRow(), mapModuleRow() (+41 more)
...
Cohesion: 0.18
Nodes (13): loadConfig(), parseBoundedInteger(), parseReadonly(), parseRerunFailedMaxTests(), requiredEnv(), baseEnv, readJsonBody(), RemoteTransport (+5 more)

### Community 158 - "repoRepository.ts"
Cohesion: 0.21
Nodes (8): ProjectRepositoryConfig, RepoRepositoryError, RepositoryConfigRow, RepositorySourceType, config, RepoDiff, fixture(), run
...
Cohesion: 0.15
Nodes (27): AiAssistantPanel(), AdminRoute(), ProtectedRoute(), ProfileView(), formatDateTime(), useAiAssistant(), useAuthContext(), useBackupRetention() (+19 more)
...
Cohesion: 0.21
Nodes (10): PROJECT_MEMBER_ROLE_LABEL, useIssueEditorOptions(), MEMBER_ROLE_OPTIONS, REPOSITORY_SOURCE_LABEL, REPOSITORY_SOURCE_OPTIONS, VISIBILITY_OPTIONS, environmentService, projectMemberService (+2 more)

### Community 183 - "useAuthContext"
Cohesion: 0.11
Nodes (23): App(), Breadcrumb(), BreadcrumbItem, BreadcrumbProps, CommentsPanel(), ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY, ISSUE_TYPE_LABEL (+15 more)
...
## Knowledge Gaps
- **838 isolated node(s):** `1. Fitur yang sudah selesai`, `Requirement Traceability`, `Environment Management`, `Test Run Enhancement`, `Test Case Productivity` (+833 more)
...
- **Why does `query()` connect `ProjectDataManagementPage.tsx` to `graphify reference: extra exports and benchmark`, `schema_auth.sql`?**
