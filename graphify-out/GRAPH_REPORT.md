...
## Summary
- 1830 nodes · 3694 edges · 174 communities (141 shown, 33 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 28 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e28fbe3f`
...
Cohesion: 0.16
Nodes (16): ProfileViewProps, ISSUE_STATUS_SEVERITY, PROJECT_MEMBER_ROLE_SEVERITY, PROJECT_MEMBER_STATUS_LABEL, PROJECT_MEMBER_STATUS_SEVERITY, PROJECT_VISIBILITY_LABEL, PROJECT_VISIBILITY_SEVERITY, TagSeverity (+8 more)

### Community 7 - "Community 7"
Cohesion: 0.11
Nodes (25): mapActivityEventRow(), mapCicdPipelineRow(), mapCommentMentionRow(), mapCommentRow(), mapProfileRow(), mapProjectMemberRow(), mapProjectMemberWithProfileRow(), mapProjectRow() (+17 more)

### Community 8 - "Community 8"
Cohesion: 0.11
Nodes (21): TestSuiteDialog(), TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, dataTablePaginatorProps, dataTablePaginatorTemplate, FilterToolbar(), FilterToolbarProps (+13 more)

### Community 9 - "Community 9"
Cohesion: 0.14
Nodes (12): CustomTestRunDialog(), CustomTestRunDialogProps, ISSUE_PRIORITY_SEVERITY, ISSUE_PRIORITY_OPTIONS, ISSUE_STATUS_OPTIONS, PRIORITY_OPTIONS, projectCache, ProjectTabData (+4 more)
...
Cohesion: 0.13
Nodes (18): IssueEditorProps, mapEnvironmentRow(), mapTestRoleRow(), PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_SEVERITY, MEMBER_ROLE_OPTIONS, VISIBILITY_OPTIONS, environmentRepository (+10 more)
...
Cohesion: 0.20
Nodes (10): supabase, mapTestCaseStepRow(), commentRepository, testCaseStepRepository, commentService, testCaseStepService, ActivityEvent, Comment (+2 more)

### Community 18 - "3. Konsep Test Management"
Cohesion: 0.15
Nodes (16): cicdRepository, testResultStepRepository, testResultStepService, ActivityAction, AutomationArtifact, CicdIngestPayload, CicdIngestResponse, CicdIngestResultInput (+8 more)
...
Cohesion: 0.18
Nodes (11): PageHeader(), PageHeaderProps, useCicdPipelines(), readStoredValue(), useStoredState(), useTestPlans(), CicdIntegrationPage(), providerOptions (+3 more)

### Community 22 - "Architecture"
Cohesion: 0.36
Nodes (8): mapIssueRow(), mapModuleRow(), mapTagRow(), issueRepository, mapIssueDetails(), mapTestCaseSummary(), Issue, IssueWithDetails

### Community 23 - "AttachmentPanel.tsx"
Cohesion: 0.19
Nodes (11): BreadcrumbItem, UserHoverCard(), UserHoverCardProps, queryKeys, AuthContext, AuthContextValue, useProfile(), useProjectBreadcrumbItems() (+3 more)
...
Cohesion: 0.12
Nodes (17): dependencies, jspdf, jspdf-autotable, primeicons, primereact, react, remark-gfm, @tanstack/react-query (+9 more)
...
Cohesion: 0.26
Nodes (10): BreadcrumbContext, BreadcrumbContextValue, BreadcrumbItem, BreadcrumbProvider(), useBreadcrumbContext(), Breadcrumb(), BreadcrumbCollapsed(), BreadcrumbProps (+2 more)

### Community 40 - "graphify reference: query, path, explain"
Cohesion: 0.25
Nodes (10): mapTestRunAssignmentRow(), mapTestRunRow(), EMPTY_FILTERS, TestRunWithSummary, TestRunFilters, testRunRepository, testRunService, TestRun (+2 more)
...
Cohesion: 0.09
Nodes (30): exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName(), mapDashboardReportRunRow(), useDashboardReport(), useProfiles(), useProjects(), ALL (+22 more)
...
Cohesion: 0.13
Nodes (23): IssueEditor(), IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, ISSUE_PRIORITY_LABEL, ISSUE_STATUS_LABEL, ISSUE_TYPE_LABEL (+15 more)
...
Cohesion: 0.21
Nodes (11): ActivityPanel(), TABLE_LABELS, CommentsPanel(), formatDateTime(), useActivity(), useComments(), PRIORITY_OPTIONS, TestCaseDetail (+3 more)
...
Cohesion: 0.20
Nodes (9): IssueDialog(), IssueDialogProps, TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY, TEST_RUN_STATUS_SEVERITY, useTestRunDetail(), RESULT_FILTER_OPTIONS, RESULT_OPTIONS (+1 more)
...
Cohesion: 0.23
Nodes (10): ImportCasesDialog(), ImportCasesDialogProps, ImportedTestCaseRow, normalizeHeader(), normalizePriority(), parseTestCaseExcel(), valueFrom(), testCaseService (+2 more)
...
Cohesion: 0.60
Nodes (3): ProfileView(), useProfileView(), UserDetailPage()
...
Cohesion: 0.27
Nodes (7): AdminRoute(), ProtectedRoute(), AppTopbar(), useAuthContext(), useNotifications(), LoginPage(), PendingApprovalPage()
...
Cohesion: 0.38
Nodes (5): AiAssistantPanel(), TEST_CASE_PRIORITY_SEVERITY, useAiAssistant(), priorities, statuses
...
## Knowledge Gaps
- **705 isolated node(s):** `supabase`, `$schema`, `typescript`, `oxc`, `react/rules-of-hooks` (+700 more)
...
- **Why does `react` connect `Feature Backlog — TestManager` to `Community 0`, `Community 4`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `What You Must Do When Invoked`, `ARCHITECTURE — TestManager (shiftech-test-mgr)`, `AttachmentPanel.tsx`, `TestCaseDetailPage.tsx`, `statusLabels.ts`, `schema_entity_codes.sql`, `schema_test_management_v2.sql`, `AppLayout.tsx`, `useAiIssueWorkflow.ts`, `graphify reference: extra exports and benchmark`, `Module`, `AppMenu.tsx`, `useAuthContext`, `TestCasesPage.tsx`, `schema_auth.sql`, `graphify reference: query, path, explain`, `TestManager (shiftech-test-mgr)`, `schema_project_roles.sql`, `AppTopbar.tsx`, `useProjectBreadcrumbItems.ts`, `graphify reference: transcribe video and audio`, `graphify reference: GitHub clone and cross-repo merge`, `useScreenSize.ts`, `3. Konsep Test Management`, `jspdf`, `2026-07-31 — FIX-00b error TypeScript ProjectDetailPage`, `zod`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `dependencies` connect `ProjectSettingsPage.tsx` to `primeflex`, `@supabase/supabase-js`, `@tanstack/react-query`, `react-dom`, `react-hook-form`, `@hookform/resolvers`, `jspdf`, `react-markdown`, `react-router-dom`?**
