...
## Corpus Check
- 417 files · ~257,784 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2623 nodes · 5400 edges · 220 communities (178 shown, 42 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 46 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c2a4d4fd`
...
Cohesion: 0.07
Nodes (48): AiIssueDraftDialog(), priorities, Props, IssueEditor(), IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS (+40 more)
...
Cohesion: 0.07
Nodes (61): JsonRecord, mapAnalysisRunSummaryRow(), mapFlakyCandidateRow(), mapIssueDetailRow(), mapIssueSummaryRow(), mapProjectRow(), mapRequirementCoverageRow(), mapRequirementDetailRow() (+53 more)
...
Cohesion: 0.10
Nodes (22): IssueDialog(), IssueDialogProps, ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY, TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY, TEST_RUN_STATUS_SEVERITY, useDashboard() (+14 more)
...
Cohesion: 0.13
Nodes (20): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, BulkActionsBar(), BulkActionsBarProps, TEST_PLAN_STATUS_LABEL, TEST_PLAN_STATUS_SEVERITY, useTestPlanDetail() (+12 more)

### Community 17 - "What You Must Do When Invoked"
Cohesion: 0.08
Nodes (31): byteLength(), ErrorDetail, ErrorEnvelope, errorResponse(), McpToolError, paginatedResponse(), PaginationInput, PaginationMeta (+23 more)
...
Cohesion: 0.09
Nodes (30): mapAutomationJobLogRow(), mapAutomationJobRow(), mapAutomationRunnerRow(), mapAutomationScriptRow(), automationRepository, testResultStepRepository, automationService, testResultStepService (+22 more)

### Community 22 - "Architecture"
Cohesion: 0.11
Nodes (25): ProfileView(), ProfileViewProps, ActivityPanel(), TABLE_LABELS, Breadcrumb(), BreadcrumbItem, BreadcrumbProps, CommentsPanel() (+17 more)
...
Cohesion: 0.19
Nodes (12): mapTestRunAssignmentRow(), mapTestRunRow(), calculateTestRunSummary(), EMPTY_FILTERS, TestRunWithSummary, testPlanRepository, testResultRepository, TestRunFilters (+4 more)
...
Cohesion: 0.12
Nodes (23): AppMenu(), AppMenuitem(), AppMenuSeparator(), MenuItemModel, useDashboardReport(), useEnvironments(), useProfiles(), readStoredPins() (+15 more)
...
Cohesion: 0.08
Nodes (36): AppLayout(), AppLayoutInner(), AppSidebar(), AppSidebarMask(), AppTopbar(), BreadcrumbContext, BreadcrumbContextValue, BreadcrumbItem (+28 more)
...
Cohesion: 0.10
Nodes (38): AiAssistantPanel(), TestSuiteDialog(), dataTablePaginatorProps, dataTablePaginatorTemplate, FilterToolbar(), FilterToolbarProps, PageHeader(), PageHeaderProps (+30 more)
...
Cohesion: 0.21
Nodes (7): mapNotificationRow(), queryKeys, activityRepository, notificationRepository, activityService, notificationService, Notification
...
Cohesion: 0.24
Nodes (8): IssueEditorProps, projectMemberRepository, testRoleRepository, testRoleService, ProjectMember, ProjectMemberRole, ProjectMemberWithProfile, TestRole
...
Cohesion: 0.07
Nodes (41): Props, CustomTestRunDialog(), CustomTestRunDialogProps, downloadTestCaseImportTemplate(), exportTestCasesToExcel(), exportTestCasesToPdf(), PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_SEVERITY (+33 more)
...
Cohesion: 0.13
Nodes (14): supabase, mapEnvironmentRow(), mapTestCaseStepRow(), mapTestPlanRow(), commentRepository, environmentRepository, moduleRepository, tagRepository (+6 more)
...
Cohesion: 0.14
Nodes (10): execFileAsync, ProjectRepositoryConfig, RepoRepository, RepoRepositoryError, RepositoryConfigRow, RepositorySourceType, RepoService, fixture() (+2 more)
...
Cohesion: 0.12
Nodes (28): App(), AdminRoute(), ProtectedRoute(), ImportCasesDialog(), ImportCasesDialogProps, AuthContext, AuthProvider(), useAuthContext() (+20 more)
...
Cohesion: 0.10
Nodes (23): DescribableActivityEntry, describeSystemEvent(), EVENT_TYPE_LABEL, STATUS_LABEL_BY_ENTITY, statusLabel(), ACTIVITY_ENTITY_LABEL, ACTIVITY_ENTITY_ROUTE, ActivityEntityType (+15 more)
...
## Knowledge Gaps
- **920 isolated node(s):** `supabase`, `$schema`, `typescript`, `oxc`, `react/rules-of-hooks` (+915 more)
...
- **Why does `query()` connect `issueAttachmentRepository.ts` to `Community 8`, `ProjectDataManagementPage.tsx`, `graphify reference: extra exports and benchmark`, `useAuthContext`?**
  _High betweenness centrality (0.143) - this node is a cross-community bridge._
- **Why does `react` connect `issueAttachmentRepository.ts` to `Community 0`, `Community 1`, `Community 7`, `Community 8`, `csvImport.ts`, `Community 10`, `Community 12`, `Community 16`, `3. Konsep Test Management`, `Feature Backlog — TestManager`, `Architecture`, `TestCaseDetailPage.tsx`, `schema_test_management_v2.sql`, `schema_auth.sql`, `ProjectDataManagementPage.tsx`, `TestManager (shiftech-test-mgr)`, `schema_project_roles.sql`, `AppTopbar.tsx`, `testSuiteRepository.ts`, `useProjectBreadcrumbItems.ts`, `graphify reference: transcribe video and audio`, `useNotifications.ts`, `csvImport.ts`, `react-dom`, `ServerConfig`, `useRealtimeSync.ts`, `useAuthContext`, `AppTopbar.tsx`, `csvImport.ts`?**
