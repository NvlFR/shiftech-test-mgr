...
## Corpus Check
- 422 files · ~263,442 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2655 nodes · 5468 edges · 227 communities (178 shown, 49 thin omitted)
...
Cohesion: 0.06
Nodes (53): AiIssueDraftDialog(), priorities, Props, aiIssueDraftSchema, artifactSchema, assistantEntityTypeSchema, assistantMatchSchema, assistantResponseSchema (+45 more)
...
Cohesion: 0.12
Nodes (15): App(), ImportCasesDialogProps, BreadcrumbItem, UserHoverCard(), UserHoverCardProps, queryKeys, AuthContext, AuthProvider() (+7 more)
...
Cohesion: 0.10
Nodes (28): AppLayout(), AppLayoutInner(), AppSidebar(), AppSidebarMask(), AppTopbar(), BreadcrumbContext, BreadcrumbContextValue, BreadcrumbItem (+20 more)

### Community 17 - "What You Must Do When Invoked"
Cohesion: 0.13
Nodes (20): byteLength(), ErrorDetail, ErrorEnvelope, errorResponse(), paginatedResponse(), PaginationInput, PaginationMeta, SuccessEnvelope (+12 more)
...
Cohesion: 0.16
Nodes (14): mapTestPlanRow(), mapTestRunAssignmentRow(), mapTestRunRow(), useTestRunDetail(), EMPTY_FILTERS, TestRunWithSummary, useTestRuns(), testPlanRepository (+6 more)
...
Cohesion: 0.12
Nodes (18): normalizePageSize(), CodeCursorQuery, TestResultListQuery, TestRunListQuery, ProjectSession, decodeCursor(), decodeResultCursor(), encodeCodeCursor (+10 more)

### Community 23 - "AttachmentPanel.tsx"
Cohesion: 0.12
Nodes (33): AdminRoute(), ProtectedRoute(), ImportCasesDialog(), formatDate(), formatDateTime(), useAuthContext(), useBackupRetention(), useProjectRepositories() (+25 more)
...
Cohesion: 0.12
Nodes (17): dependencies, jspdf, jspdf-autotable, primeflex, primereact, react, react-router-dom, remark-gfm (+9 more)
...
Cohesion: 0.14
Nodes (22): AppMenu(), AppMenuitem(), AppMenuSeparator(), MenuItemModel, ProjectContext, ProjectContextValue, ProjectProvider(), readStoredPins() (+14 more)

### Community 40 - "graphify reference: query, path, explain"
Cohesion: 0.11
Nodes (25): mapRequirementLinkRow(), mapRequirementRow(), mapLink(), requirementRepository, testResultStepRepository, testResultStepService, ActivityAction, AutomationJobLogStream (+17 more)
...
Cohesion: 0.09
Nodes (30): TestSuiteDialog(), dataTablePaginatorProps, dataTablePaginatorTemplate, FilterToolbar(), FilterToolbarProps, PageHeader(), PageHeaderProps, RowActionsMenu() (+22 more)
...
Cohesion: 0.09
Nodes (32): exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName(), mapDashboardReportRunRow(), useDashboardReport(), useEnvironments(), useProfiles(), ALL (+24 more)
...
Cohesion: 0.10
Nodes (35): AiAssistantPanel(), Props, BulkActionsBar(), BulkActionsBarProps, exportTestCasesToPdf(), TEST_CASE_PRIORITY_LABEL, TEST_CASE_PRIORITY_SEVERITY, TEST_CASE_STATUS_LABEL (+27 more)
...
Cohesion: 0.07
Nodes (44): IssueDialog(), IssueDialogProps, IssueEditor(), IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, ProfileViewProps (+36 more)
...
Cohesion: 0.33
Nodes (5): mapNotificationRow(), useNotifications(), notificationRepository, notificationService, Notification
...
Cohesion: 0.36
Nodes (5): ActivityPanel(), TABLE_LABELS, useActivity(), activityRepository, activityService

### Community 139 - "config.ts"
Cohesion: 0.08
Nodes (26): loadConfig(), parseBoundedInteger(), parseReadonly(), parseRerunFailedMaxTests(), requiredEnv(), ServerConfig, baseEnv, readJsonBody() (+18 more)
...
Cohesion: 0.09
Nodes (36): supabase, mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapIssueRow(), mapModuleRow(), mapProfileRow(), mapProjectMemberRow() (+28 more)
...
Cohesion: 0.08
Nodes (30): xlsx, CustomTestRunDialog(), CustomTestRunDialogProps, STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, downloadTestCaseImportTemplate(), exportTestCasesToExcel() (+22 more)
...
Cohesion: 0.19
Nodes (11): IssueEditorProps, mapTestRoleRow(), useIssueEditorOptions(), projectMemberRepository, testRoleRepository, projectMemberService, testRoleService, ProjectMember (+3 more)
...
## Knowledge Gaps
- **937 isolated node(s):** `supabase`, `$schema`, `typescript`, `oxc`, `react/rules-of-hooks` (+932 more)
...
- **Why does `react` connect `Community 7` to `Community 0`, `Community 1`, `Community 10`, `Community 12`, `Community 16`, `ARCHITECTURE — TestManager (shiftech-test-mgr)`, `Feature Backlog — TestManager`, `AttachmentPanel.tsx`, `TestCaseDetailPage.tsx`, `Coding Conventions`, `schema_auth.sql`, `useEnvironments.ts`, `TestManager (shiftech-test-mgr)`, `schema_project_roles.sql`, `AppTopbar.tsx`, `testSuiteRepository.ts`, `issueAttachmentRepository.ts`, `schema_project_members.sql`, `graphify reference: transcribe video and audio`, `useNotifications.ts`, `useTheme.tsx`, `csvImport.ts`, `AppTopbar.tsx`, `useEnvironments.ts`, `AppTopbar.tsx`, `csvImport.ts`?**
