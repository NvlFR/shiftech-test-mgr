...
## Corpus Check
- 285 files · ~187,899 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2595 nodes · 4247 edges · 296 communities (204 shown, 92 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 19 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `16314840`
...
- `DashboardReportIssueRow` --references--> `IssueStatus`  [EXTRACTED]
  frontend/src/repositories/dashboardReportRepository.ts → frontend/src/types/domain.ts
- `IssueEditorProps` --references--> `Attachment`  [EXTRACTED]
  frontend/src/components/issues/IssueEditor.tsx → frontend/src/types/domain.ts
- `IssueEditorProps` --references--> `Module`  [EXTRACTED]
  frontend/src/components/issues/IssueEditor.tsx → frontend/src/types/domain.ts

## Import Cycles
- None detected.

## Communities (296 total, 92 thin omitted)
...
Cohesion: 0.18
Nodes (13): mapApiTokenRow(), mapWebhookDeliveryRow(), mapWebhookRow(), integrationRepository, allowedEvents, integrationService, ApiToken, ApiTokenScope (+5 more)
...
Cohesion: 0.11
Nodes (27): IssueEditorProps, IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY, ISSUE_STATUS_LABEL (+19 more)

### Community 4 - "Community 4"
Cohesion: 0.08
Nodes (25): dependencies, @hookform/resolvers, jspdf-autotable, primeflex, primeicons, primereact, react, react-dom (+17 more)
...
Cohesion: 0.20
Nodes (11): AdminRoute(), ProtectedRoute(), ActivityPanel(), useAuthContext(), useBackupRetention(), useProjectRole(), PendingApprovalPage(), ProjectDataManagementPage() (+3 more)
...
Cohesion: 0.08
Nodes (33): CustomTestRunDialog(), CustomTestRunDialogProps, ActivityPanel(), TABLE_LABELS, BulkActionsBar(), BulkActionsBarProps, TEST_PLAN_STATUS_LABEL, TEST_RESULT_STATUS_LABEL (+25 more)
...
Cohesion: 0.12
Nodes (20): PageHeader(), PageHeaderProps, LoginPage(), downloadCsv(), HomePage(), eventOptions, IntegrationsPage(), scopeOptions (+12 more)
...
Cohesion: 0.12
Nodes (23): ImportCasesDialog(), ImportCasesDialogProps, mapProjectRow(), PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_LABEL, PROJECT_STATUS_SEVERITY, ProjectContext, ProjectContextValue (+15 more)
...
Cohesion: 0.08
Nodes (40): AiAssistantPanel(), AiIssueDraftDialog(), priorities, aiIssueDraftSchema, assistantEntityTypeSchema, assistantMatchSchema, assistantResponseSchema, buildDuplicateReason() (+32 more)
...
Cohesion: 0.15
Nodes (16): App(), MODE_ICON, ThemeToggle(), MODE_ICON, ThemeToggle(), AuthProvider(), applyTheme(), getSystemPrefersDark() (+8 more)
...
Cohesion: 0.04
Nodes (13): BulkActionsBarProps, ColumnHeaderMenuProps, FilterToolbarProps, PageHeaderProps, UserHoverCardProps, ScreenSize, ScreenSize, STATUS_OPTIONS (+5 more)
...
Cohesion: 0.10
Nodes (17): supabase, mapEnvironmentRow(), environmentRepository, issueAttachmentRepository, mapRow(), withSignedUrl(), moduleRepository, tagRepository (+9 more)
...
Cohesion: 0.19
Nodes (8): Props, mapTestCaseRow(), mapTestResultRow(), testResultRepository, issueService, Issue, TestResult, TestResultWithDetails
...
Cohesion: 0.14
Nodes (14): mapAutomationJobRow(), mapAutomationRunnerRow(), mapAutomationScriptRow(), AutomationPage(), jobSeverity, runnerOnline(), automationRepository, automationService (+6 more)
...
Cohesion: 0.08
Nodes (36): AppMenu(), EnrichedProject, AppMenuitem(), AppMenuSeparator(), MenuItemModel, OwnerProjectLabel(), OwnerProjectLabelProps, truncate() (+28 more)
...
Cohesion: 0.13
Nodes (19): TestSuiteDialog(), TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, FilterToolbar(), FilterToolbarProps, RowActionsMenu(), RowActionsMenuProps (+11 more)
...
Cohesion: 0.10
Nodes (19): ActivityPanelProps, CharacterCount(), CharacterCountProps, CommentEditor(), CommentEditorProps, MarkdownPreview(), MarkdownPreviewProps, MentionTextarea() (+11 more)
...
Cohesion: 0.16
Nodes (18): Props, TEST_CASE_PRIORITY_LABEL, TEST_CASE_PRIORITY_SEVERITY, TEST_CASE_STATUS_LABEL, TEST_CASE_STATUS_SEVERITY, Option, PRIORITY_OPTIONS, ProjectTestCaseTab() (+10 more)
...
Cohesion: 0.10
Nodes (25): mapRequirementLinkRow(), mapRequirementRow(), mapTestResultStepRow(), mapLink(), requirementRepository, testResultStepRepository, requirementService, testResultStepService (+17 more)
...
Cohesion: 0.36
Nodes (3): mapTestPlanRow(), testPlanRepository, testPlanService
...
Cohesion: 0.33
Nodes (4): STATUS_OPTIONS, TestPlanDialogProps, CharacterCount(), CharacterCountProps
...
Cohesion: 0.24
Nodes (9): CommentsPanel(), UsernamePickerProps, formatDateTime(), AuthContext, AuthContextValue, useComments(), UserManagementPage(), profileService (+1 more)
...
Cohesion: 0.12
Nodes (18): mapTestRunAssignmentRow(), mapTestRunRow(), EMPTY_FILTERS, TestRunWithSummary, Option, PRIORITIES, RequirementsPage(), STATUSES (+10 more)
...
Cohesion: 0.33
Nodes (6): 2026-07-31, Antrean Codex lengkap + renumber FEATURE_BACKLOG, Audit fitur repo pembanding, Codex task loop (otomasi antrean task), Commit porting source-new + ignore aset *-new, Penambahan roadmap: MCP server, Playwright interaktif, link repository

## Knowledge Gaps
- **959 isolated node(s):** `Commit porting source-new + ignore aset *-new`, `Antrean Codex lengkap + renumber FEATURE_BACKLOG`, `Codex task loop (otomasi antrean task)`, `Penambahan roadmap: MCP server, Playwright interaktif, link repository`, `Audit fitur repo pembanding` (+954 more)
...
- **Why does `react` connect `Coding Conventions` to `Community 1`, `Community 2`, `Community 3`, `ProjectDetailPage.tsx`, `useTheme.tsx`, `Community 7`, `Community 9`, `Community 12`, `renderMentions.tsx`, `Community 13`, `ImportCasesDialog.tsx`, `scripts`, `IssueTab.tsx`, `TestCaseTab.tsx`, `AttachmentPanel.tsx`, `statusLabels.ts`, `Breadcrumb.tsx`, `TestCaseTab.tsx`, `TestRunResultDetailPage.tsx`, `TestCaseDialog.tsx`, `Coding Conventions`, `useProjectPins.tsx`, `UserManagementPage.tsx`, `primereact`, `TestCaseDetailPage.tsx`, `TestSuitesPage.tsx`, `schema_requirement_traceability.sql`, `react-hook-form`, `DuplicateTestPlanDialog.tsx`, `ColumnHeaderMenu.tsx`, `useProjectPins.tsx`, `useStoredState.ts`, `testRoleRepository.ts`, `FilterToolbar.tsx`, `backupRetentionRepository.ts`, `CLAUDE.md`, `package.json`, `primeicons`, `primereact`, `@supabase/supabase-js`, `testRunRepository.ts`, `contract.test.ts`, `dashboardReportRepository.ts`, `ProjectsPage.tsx`, `package.json`, `primeflex`, `primeicons`, `react-router-dom`, `@supabase/supabase-js`, `jspdf`, `TestPlanDetailPage.tsx`?**
...
- **Why does `query()` connect `handler.ts` to `schema_requirement_traceability.sql`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **What connects `Commit porting source-new + ignore aset *-new`, `Antrean Codex lengkap + renumber FEATURE_BACKLOG`, `Codex task loop (otomasi antrean task)` to the rest of the system?**
