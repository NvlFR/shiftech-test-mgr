...
## Corpus Check
- 420 files · ~259,513 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2633 nodes · 5438 edges · 224 communities (182 shown, 42 thin omitted)
...
Cohesion: 0.06
Nodes (70): JsonRecord, mapAnalysisRunSummaryRow(), mapFlakyCandidateRow(), mapIssueDetailRow(), mapIssueSummaryRow(), mapProjectRow(), mapRequirementCoverageRow(), mapRequirementDetailRow() (+62 more)
...
Cohesion: 0.11
Nodes (26): IssueEditor(), IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, ActivityPanel(), TABLE_LABELS, BreadcrumbItem (+18 more)
...
Cohesion: 0.10
Nodes (25): byteLength(), ErrorDetail, ErrorEnvelope, errorResponse(), paginatedResponse(), PaginationInput, PaginationMeta, SuccessEnvelope (+17 more)
...
Cohesion: 0.11
Nodes (28): ImportCasesDialogProps, ProjectContext, ProjectContextValue, STATUS_OPTIONS, ProjectOwnerFilter, ProjectPaginatedQuery, ProjectQuery, projectRepository (+20 more)
...
Cohesion: 0.07
Nodes (42): TestSuiteDialog(), TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, ProfileViewProps, CharacterCount(), CharacterCountProps, dataTablePaginatorProps (+34 more)
...
Cohesion: 0.20
Nodes (8): AdminRoute(), ProtectedRoute(), queryKeys, useAuthContext(), useProjectBreadcrumbItems(), PendingApprovalPage(), activityRepository, activityService
...
Cohesion: 0.07
Nodes (36): IssueDialog(), IssueDialogProps, mapTestRoleRow(), TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY, TEST_RUN_STATUS_SEVERITY, calculateTestRunSummary(), useDashboard() (+28 more)
...
Cohesion: 0.15
Nodes (16): mapDashboardReportRunRow(), DashboardReportIssueRow, dashboardReportRepository, DashboardReportResultRow, fetchAllRows(), RangeResult, ACTIVE_ISSUE_STATUSES, calculateIssueAging() (+8 more)
...
Cohesion: 0.17
Nodes (14): IssueEditorProps, PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_SEVERITY, MEMBER_ROLE_OPTIONS, REPOSITORY_SOURCE_LABEL, REPOSITORY_SOURCE_OPTIONS, VISIBILITY_OPTIONS, testRoleRepository (+6 more)
...
Cohesion: 0.10
Nodes (19): loadConfig(), parseBoundedInteger(), parseReadonly(), parseRerunFailedMaxTests(), requiredEnv(), ServerConfig, baseEnv, config (+11 more)
...
Cohesion: 0.10
Nodes (31): Props, CustomTestRunDialog(), CustomTestRunDialogProps, ImportCasesDialog(), Breadcrumb(), BreadcrumbProps, downloadTestCaseImportTemplate(), TEST_CASE_PRIORITY_SEVERITY (+23 more)
...
Cohesion: 0.12
Nodes (16): supabase, mapNotificationRow(), mapTestCaseStepRow(), mapTestRunAssignmentRow(), mapTestRunRow(), commentRepository, moduleRepository, notificationRepository (+8 more)
...
Cohesion: 0.15
Nodes (24): ProfileView(), formatDate(), useIssuesByTestRun(), useProfileView(), useProjectRole(), useScreenSize(), useTestPlanDetail(), useTestRuns() (+16 more)
...
Cohesion: 0.11
Nodes (27): mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapIssueRow(), mapModuleRow(), mapProfileRow(), mapProjectMemberRow(), mapProjectMemberWithProfileRow() (+19 more)
...
Cohesion: 0.05
Nodes (49): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, BulkActionsBar(), BulkActionsBarProps, describeSystemEvent(), EVENT_TYPE_LABEL, STATUS_LABEL_BY_ENTITY (+41 more)
...
## Knowledge Gaps
- **924 isolated node(s):** `supabase`, `$schema`, `typescript`, `oxc`, `react/rules-of-hooks` (+919 more)
...
- **Why does `useAiTestCaseReview()` connect `activityDescribe.ts` to `ProjectDataManagementPage.tsx`, `Community 11`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `WriteService` connect `Community 11` to `What You Must Do When Invoked`, `statusLabels.ts`, `Architecture`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `react` connect `issueAttachmentRepository.ts` to `Community 0`, `Community 1`, `Community 7`, `Community 8`, `csvImport.ts`, `Community 10`, `Community 12`, `Community 16`, `3. Konsep Test Management`, `ARCHITECTURE — TestManager (shiftech-test-mgr)`, `Feature Backlog — TestManager`, `TestCaseDetailPage.tsx`, `schema_auth.sql`, `ProjectDataManagementPage.tsx`, `TestManager (shiftech-test-mgr)`, `schema_project_roles.sql`, `AppTopbar.tsx`, `useProjectBreadcrumbItems.ts`, `graphify reference: transcribe video and audio`, `useNotifications.ts`, `useTheme.tsx`, `csvImport.ts`, `react-dom`, `ServerConfig`, `AppMenu.tsx`, `useAuthContext`, `useEnvironments.ts`, `useProfile.ts`, `AppTopbar.tsx`, `activityDescribe.ts`, `csvImport.ts`?**
