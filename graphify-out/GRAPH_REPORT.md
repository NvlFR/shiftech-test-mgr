...
## Summary
- 1727 nodes · 3482 edges · 147 communities (121 shown, 26 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 26 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `93d98028`
...
Cohesion: 0.14
Nodes (17): ISSUE_PRIORITY_SEVERITY, TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY, TEST_RUN_STATUS_LABEL, TEST_RUN_STATUS_SEVERITY, useIssuesByTestRun(), useTestRunAnalysis(), useTestRunDetail() (+9 more)
...
Cohesion: 0.14
Nodes (16): projectMemberRepository, testResultStepRepository, projectMemberService, testResultStepService, ActivityAction, AutomationArtifact, CicdIngestResultInput, CicdIngestStatus (+8 more)
...
Cohesion: 0.10
Nodes (29): ProfileView(), BulkActionsBar(), BulkActionsBarProps, formatDate(), mapTestPlanRow(), ISSUE_STATUS_SEVERITY, PROJECT_MEMBER_ROLE_SEVERITY, PROJECT_VISIBILITY_LABEL (+21 more)
...
Cohesion: 0.26
Nodes (12): ImportCasesDialogProps, mapProjectRow(), STATUS_OPTIONS, ProjectQuery, projectRepository, SORT_COLUMN, projectService, Project (+4 more)
...
Cohesion: 0.20
Nodes (10): mapDashboardReportRunRow(), mapTestResultRow(), DashboardReportIssueRow, DashboardReportResultRow, issueRepository, fetchAllRows(), RangeResult, testResultRepository (+2 more)
...
Cohesion: 0.11
Nodes (34): AdminRoute(), ProtectedRoute(), useBreadcrumbContext(), ActivityPanel(), Breadcrumb(), BreadcrumbItem, BreadcrumbProps, formatDateTime() (+26 more)
...
Cohesion: 0.10
Nodes (25): TestSuiteDialog(), TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, ProfileViewProps, FilterToolbar(), FilterToolbarProps, PageHeader() (+17 more)
...
### Community 125 - "jspdf"
Cohesion: 0.10
Nodes (24): STATUS_OPTIONS, TestPlanDialogProps, AttachmentPanel(), AttachmentPanelProps, formatFileSize(), CharacterCount(), CharacterCountProps, CommentEditorProps (+16 more)
...
Cohesion: 0.08
Nodes (33): xlsx, CustomTestRunDialog(), CustomTestRunDialogProps, ImportCasesDialog(), downloadTestCaseImportTemplate(), exportTestCasesToExcel(), exportTestCasesToPdf(), TEST_CASE_STATUS_LABEL (+25 more)

### Community 149 - "TestCaseTab.tsx"
Cohesion: 0.10
Nodes (23): Props, IssueEditorProps, IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, ISSUE_PRIORITY_LABEL, ISSUE_STATUS_LABEL (+15 more)

### Community 156 - "package.json"
Cohesion: 0.11
Nodes (15): TABLE_LABELS, UserHoverCardProps, supabase, mapActivityEventRow(), mapTestCaseStepRow(), activityRepository, moduleRepository, profileRepository (+7 more)
...
Cohesion: 0.24
Nodes (11): AiTestCaseGeneratorDialog(), maxCaseOptions, priorityOptions, ReviewDraft, parseRequirementFile(), toAiTestCaseSource(), TEST_CASE_PRIORITY_LABEL, DEFAULT_OPTIONS (+3 more)
...
Cohesion: 0.15
Nodes (23): mapCommentMentionRow(), mapCommentRow(), mapIssueRow(), mapModuleRow(), mapProfileRow(), mapProjectMemberRow(), mapProjectMemberWithProfileRow(), mapTagRow() (+15 more)
...
Cohesion: 0.23
Nodes (10): mapTestRunAssignmentRow(), mapTestRunRow(), EMPTY_FILTERS, TestRunWithSummary, useTestRuns(), testCaseRepository, TestRunFilters, testRunRepository (+2 more)
...
## Knowledge Gaps
- **664 isolated node(s):** `supabase`, `$schema`, `typescript`, `oxc`, `react/rules-of-hooks` (+659 more)
...
- **Why does `react` connect `react-router-dom` to `Community 1`, `Community 2`, `Community 3`, `Community 9`, `Community 12`, `Community 13`, `scripts`, `TestCaseTab.tsx`, `statusLabels.ts`, `package.json`, `Breadcrumb.tsx`, `Coding Conventions`, `TestSuitesPage.tsx`, `schema_requirement_traceability.sql`, `ColumnHeaderMenu.tsx`, `testRoleRepository.ts`, `backupRetentionRepository.ts`, `package.json`, `Coding Conventions`, `ProjectsPage.tsx`, `package.json`, `primeicons`, `react-router-dom`, `jspdf`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `dependencies` connect `Community 4` to `useProjectPins.tsx`, `primeicons`, `2026-07-31`, `@supabase/supabase-js`, `ColumnHeaderMenu.tsx`, `scripts`, `package.json`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `query()` connect `handler.ts` to `Community 3`, `Community 9`, `schema_requirement_traceability.sql`, `scripts`, `TestCaseTab.tsx`, `primeicons`?**
