...
## Summary
- 2517 nodes · 5215 edges · 206 communities (167 shown, 39 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 45 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ac645aa1`
...
Cohesion: 0.08
Nodes (41): Props, CustomTestRunDialog(), CustomTestRunDialogProps, ImportCasesDialog(), downloadTestCaseImportTemplate(), exportTestCasesToExcel(), exportTestCasesToPdf(), TEST_CASE_PRIORITY_LABEL (+33 more)
...
Cohesion: 0.10
Nodes (22): TestSuiteDialog(), TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, CharacterCount(), CharacterCountProps, FilterToolbar(), FilterToolbarProps (+14 more)
...
Cohesion: 0.07
Nodes (43): IssueEditor(), IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, ProfileViewProps, describeSystemEvent(), EVENT_TYPE_LABEL (+35 more)
...
Cohesion: 0.14
Nodes (13): ProfileView(), Breadcrumb(), BreadcrumbItem, BreadcrumbProps, TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY, useProfileView(), useTestResultDetail() (+5 more)
...
Cohesion: 0.09
Nodes (29): exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName(), mapDashboardReportRunRow(), useDashboardReport(), useProjects(), ALL, DashboardReportPage() (+21 more)
...
Cohesion: 0.12
Nodes (12): ErrorDetail, ErrorEnvelope, errorResponse(), McpToolError, PaginationInput, PaginationMeta, SuccessEnvelope, body() (+4 more)
...
Cohesion: 0.13
Nodes (21): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, ActivityPanel(), TABLE_LABELS, BulkActionsBar(), BulkActionsBarProps, formatDateTime() (+13 more)
...
Cohesion: 0.13
Nodes (20): mapCicdPipelineRow(), cicdRepository, testResultStepRepository, cicdService, testResultStepService, ActivityAction, CicdIngestPayload, CicdIngestResponse (+12 more)
...
Cohesion: 0.14
Nodes (15): CommentsPanel(), supabase, mapEnvironmentRow(), mapTestRunAssignmentRow(), mapTestRunRow(), useComments(), commentRepository, environmentRepository (+7 more)
...
Cohesion: 0.07
Nodes (39): mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapIssueRow(), mapModuleRow(), mapProfileRow(), mapProjectMemberRow(), mapProjectMemberWithProfileRow() (+31 more)
...
Cohesion: 0.11
Nodes (23): IssueDialog(), IssueDialogProps, dataTablePaginatorProps, dataTablePaginatorTemplate, TEST_RUN_STATUS_SEVERITY, useProfiles(), ScreenSize, EMPTY_FILTERS (+15 more)
...
Cohesion: 0.11
Nodes (34): AiAssistantPanel(), PageHeader(), PageHeaderProps, formatDate(), useAiAssistant(), useCicdPipelines(), useDashboard(), useIssueEditorOptions() (+26 more)
...
Cohesion: 0.13
Nodes (17): byteLength(), normalizePageSize(), paginatedResponse(), TestResultListQuery, decodeCursor(), decodeResultCursor(), encodeCodeCursor, encodeRequirementCursor() (+9 more)
...
## Knowledge Gaps
- **886 isolated node(s):** `supabase`, `$schema`, `typescript`, `oxc`, `react/rules-of-hooks` (+881 more)
