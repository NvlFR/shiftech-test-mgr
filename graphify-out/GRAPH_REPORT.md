...
## Corpus Check
- 403 files · ~245,438 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2533 nodes · 5255 edges · 206 communities (166 shown, 40 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 45 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `99085681`
...
Cohesion: 0.07
Nodes (43): AiIssueDraftDialog(), priorities, Props, aiIssueDraftSchema, assistantEntityTypeSchema, assistantMatchSchema, assistantResponseSchema, buildDuplicateReason() (+35 more)
...
Cohesion: 0.08
Nodes (39): Props, CustomTestRunDialog(), CustomTestRunDialogProps, ImportCasesDialog(), ImportCasesDialogProps, exportTestCasesToExcel(), exportTestCasesToPdf(), TEST_CASE_PRIORITY_SEVERITY (+31 more)
...
Cohesion: 0.10
Nodes (23): IssueDialog(), IssueDialogProps, Breadcrumb(), BreadcrumbProps, TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY, useTestResultDetail(), useTestRunAnalysis() (+15 more)
...
Cohesion: 0.12
Nodes (22): TestSuiteDialog(), dataTablePaginatorProps, dataTablePaginatorTemplate, FilterToolbar(), FilterToolbarProps, RowActionsMenu(), RowActionsMenuProps, SearchInput() (+14 more)
...
Cohesion: 0.13
Nodes (23): IssueEditor(), IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY, ISSUE_STATUS_LABEL (+15 more)
...
Cohesion: 0.14
Nodes (19): mapAutomationJobLogRow(), mapAutomationJobRow(), mapAutomationRunnerRow(), mapAutomationScriptRow(), useAutomation(), useAutomationJobLogs(), AutomationPage(), jobSeverity (+11 more)
...
Cohesion: 0.18
Nodes (13): EnvironmentMetadata, JobRepository, ReportPayload, GitCommand, inspectLocalRepository(), LocalRepositoryMetadata, execFileAsync, GitCommand (+5 more)
...
Cohesion: 0.26
Nodes (10): mapRequirementLinkRow(), mapRequirementRow(), mapLink(), requirementRepository, Requirement, RequirementLink, RequirementLinkType, RequirementPriority (+2 more)
...
Cohesion: 0.10
Nodes (31): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, BulkActionsBar(), BulkActionsBarProps, formatDate(), ISSUE_STATUS_SEVERITY, PROJECT_MEMBER_ROLE_SEVERITY (+23 more)
...
Cohesion: 0.09
Nodes (27): mapCicdPipelineRow(), cicdRepository, testResultStepRepository, cicdService, testResultService, TEXT_ARTIFACT_TYPES, testResultStepService, ActivityAction (+19 more)
...
Cohesion: 0.20
Nodes (10): 14. Urutan implementasi yang disarankan, 15. Catatan keputusan teknis, 1. Fitur yang sudah selesai, 4. AI Integration, 6. Administrasi dan kolaborasi, 7. Integrasi penuh source-new ke aplikasi aktif, Checklist per folder, Definition of Done (+2 more)
...
Cohesion: 0.11
Nodes (18): supabase, mapEnvironmentRow(), mapTestCaseStepRow(), mapTestRunAssignmentRow(), mapTestRunRow(), commentRepository, environmentRepository, profileRepository (+10 more)
...
Cohesion: 0.08
Nodes (39): mapActivityEventRow(), mapApiTokenRow(), mapCommentMentionRow(), mapCommentRow(), mapIssueRow(), mapModuleRow(), mapProfileRow(), mapProjectMemberRow() (+31 more)
...
Cohesion: 0.15
Nodes (14): ProfileView(), ProfileViewProps, BreadcrumbItem, PROJECT_VISIBILITY_LABEL, PROJECT_VISIBILITY_SEVERITY, TEST_SUITE_VISIBILITY_LABEL, TEST_SUITE_VISIBILITY_SEVERITY, AuthContextValue (+6 more)
...
Cohesion: 0.09
Nodes (23): loadConfig(), parseBoundedInteger(), parseReadonly(), parseRerunFailedMaxTests(), requiredEnv(), ServerConfig, baseEnv, body() (+15 more)
...
Cohesion: 0.18
Nodes (13): AutomationJob, JobResult, collectEnvironmentMetadata(), DEFAULT_VIEWPORT, parseViewport(), VersionCommand, executeJob(), ExecutionMode (+5 more)
...
Cohesion: 0.09
Nodes (39): AdminRoute(), ProtectedRoute(), PageHeader(), PageHeaderProps, AuthContext, useAuthContext(), useBackupRetention(), useCicdPipelines() (+31 more)
...
Cohesion: 0.22
Nodes (9): IssueEditorProps, mapTestRoleRow(), projectMemberRepository, testRoleRepository, testRoleService, ProjectMember, ProjectMemberRole, ProjectMemberWithProfile (+1 more)
...
Cohesion: 0.25
Nodes (8): 12.1 Kerangka halaman, 12.2 Panel konfigurasi MCP, 12.3 Langkah bernomor + perintah siap salin, 12.4 Agent Skills pack, 12.5 Prompt starter, 12.6 Keamanan (jangan dilewat), 12.7 Kualitas UI, 12. Halaman "Connect your agent" (MCP + Skills + Prompt)
...
Cohesion: 0.36
Nodes (7): ReportArtifact, classifyArtifact(), collectArtifacts(), CollectedArtifact, hasCompleteFailureBundle(), REQUIRED_FAILURE_ARTIFACT_TYPES, walk()
...
Cohesion: 0.36
Nodes (7): xlsx, downloadTestCaseImportTemplate(), normalizeHeader(), normalizePriority(), parseTestCaseExcel(), valueFrom(), xlsx

## Knowledge Gaps
- **889 isolated node(s):** `supabase`, `$schema`, `typescript`, `oxc`, `react/rules-of-hooks` (+884 more)
...
- **Why does `query()` connect `ProjectDataManagementPage.tsx` to `graphify reference: extra exports and benchmark`, `Community 4`, `Community 8`, `3. Konsep Test Management`, `graphify reference: GitHub clone and cross-repo merge`?**
  _High betweenness centrality (0.145) - this node is a cross-community bridge._
- **Why does `react` connect `Community 6` to `Community 0`, `Community 1`, `Community 4`, `Community 8`, `csvImport.ts`, `Community 10`, `Community 12`, `Community 16`, `3. Konsep Test Management`, `ARCHITECTURE — TestManager (shiftech-test-mgr)`, `Feature Backlog — TestManager`, `TestCaseDetailPage.tsx`, `schema_auth.sql`, `ProjectDataManagementPage.tsx`, `schema_project_roles.sql`, `AppTopbar.tsx`, `ReadService`, `issueAttachmentRepository.ts`, `graphify reference: transcribe video and audio`, `graphify reference: GitHub clone and cross-repo merge`, `csvImport.ts`, `react-dom`, `AppTopbar.tsx`, `csvImport.ts`, `smoke.spec.ts`?**
