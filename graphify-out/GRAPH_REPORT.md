...
## Corpus Check
- 301 files · ~193,657 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1813 nodes · 3638 edges · 159 communities (130 shown, 29 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 27 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `63508e93`
...
Cohesion: 0.09
Nodes (38): AiTestCaseGeneratorDialog(), maxCaseOptions, priorityOptions, Props, ReviewDraft, CustomTestRunDialog(), CustomTestRunDialogProps, AiTestCaseResponseSchema (+30 more)
...
Cohesion: 0.06
Nodes (40): IssueEditor(), IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName() (+32 more)
...
Cohesion: 0.11
Nodes (23): ProfileView(), Breadcrumb(), BreadcrumbItem, BreadcrumbProps, CommentsPanel(), ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY, ISSUE_TYPE_LABEL (+15 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (41): IssueEditorProps, mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapEnvironmentRow(), mapIssueRow(), mapModuleRow(), mapProfileRow() (+33 more)

### Community 8 - "Community 8"
Cohesion: 0.16
Nodes (14): TestSuiteDialog(), FilterToolbar(), FilterToolbarProps, RowActionsMenu(), RowActionsMenuProps, SearchInput(), SearchInputProps, TEST_CASE_PRIORITY_SEVERITY (+6 more)
...
Cohesion: 0.27
Nodes (11): AppLayout(), AppLayoutInner(), AppSidebar(), AppSidebarMask(), AppTopbar(), isDesktop(), LayoutContext, LayoutContextValue (+3 more)

### Community 12 - "Community 12"
Cohesion: 0.19
Nodes (17): mapRestorePreviewRow(), mapRestoreResultRow(), mapRetentionCleanupPreviewRow(), mapRetentionCleanupResultRow(), mapRetentionPolicyRow(), backup(), cleanup(), cleanupPreview() (+9 more)
...
Cohesion: 0.18
Nodes (13): dataTablePaginatorProps, dataTablePaginatorTemplate, ImportedTestCaseRow, PRIORITY_OPTIONS, priorities, statuses, moduleService, tagService (+5 more)

### Community 18 - "3. Konsep Test Management"
Cohesion: 0.11
Nodes (24): mapRequirementLinkRow(), mapRequirementRow(), mapLink(), requirementRepository, testResultStepRepository, requirementService, testResultStepService, ActivityAction (+16 more)
...
Cohesion: 0.14
Nodes (22): ActivityPanel(), TABLE_LABELS, formatDate(), formatDateTime(), useActivity(), useIssueEditorOptions(), useProjectRole(), ScreenSize (+14 more)

### Community 21 - "Feature Backlog — TestManager"
Cohesion: 0.09
Nodes (28): ImportCasesDialog(), ImportCasesDialogProps, ProfileViewProps, downloadTestCaseImportTemplate(), exportTestCasesToExcel(), exportTestCasesToPdf(), TEST_CASE_PRIORITY_LABEL, TEST_CASE_STATUS_SEVERITY (+20 more)

### Community 22 - "Architecture"
Cohesion: 0.23
Nodes (9): AdminRoute(), ProtectedRoute(), AuthContext, AuthContextValue, useAuthContext(), useNotifications(), LoginPage(), PendingApprovalPage() (+1 more)
...
Cohesion: 0.10
Nodes (21): dependencies, @hookform/resolvers, jspdf, primeflex, primereact, react, react-hook-form, react-markdown (+13 more)

### Community 26 - "TestCaseDetailPage.tsx"
Cohesion: 0.11
Nodes (20): TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, AttachmentPanel(), AttachmentPanelProps, formatFileSize(), CharacterCount(), CharacterCountProps (+12 more)
...
Cohesion: 0.09
Nodes (34): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, PageHeader(), PageHeaderProps, TEST_PLAN_STATUS_LABEL, TEST_PLAN_STATUS_SEVERITY, useRequirements() (+26 more)
...
Cohesion: 0.28
Nodes (7): BulkActionsBar(), BulkActionsBarProps, MEMBER_ROLE_OPTIONS, VISIBILITY_OPTIONS, projectMemberService, testRoleService, ProjectMemberRole
...
Cohesion: 0.12
Nodes (21): describeSystemEvent(), EVENT_TYPE_LABEL, STATUS_LABEL_BY_ENTITY, statusLabel(), ISSUE_STATUS_LABEL, ISSUE_STATUS_SEVERITY, PROJECT_MEMBER_ROLE_LABEL, PROJECT_MEMBER_ROLE_SEVERITY (+13 more)
...
Cohesion: 0.17
Nodes (12): BreadcrumbContext, BreadcrumbContextValue, BreadcrumbItem, BreadcrumbProvider(), useBreadcrumbContext(), iconForKind(), NOTIFICATION_KIND_ICON, NotificationPanel() (+4 more)
...
Cohesion: 0.13
Nodes (17): supabase, mapAttachmentRow(), mapTestPlanRow(), findAll(), pathFor(), remove(), upload(), withSignedUrl() (+9 more)
...
Cohesion: 0.36
Nodes (5): useBackupRetention(), ProjectDataManagementPage(), backupRetentionRepository, backupRetentionService, RetentionPolicy
...
Cohesion: 0.47
Nodes (3): mapNotificationRow(), notificationRepository, Notification
...
- **Why does `react` connect `Community 6` to `Community 0`, `Community 1`, `Community 4`, `Community 8`, `Community 10`, `Community 11`, `What You Must Do When Invoked`, `3. Konsep Test Management`, `ARCHITECTURE — TestManager (shiftech-test-mgr)`, `Feature Backlog — TestManager`, `Architecture`, `AttachmentPanel.tsx`, `TestCaseDetailPage.tsx`, `statusLabels.ts`, `schema_entity_codes.sql`, `schema_test_management_v2.sql`, `graphify reference: query, path, explain`, `useTheme.tsx`, `schema_project_roles.sql`, `AppTopbar.tsx`, `useProjectBreadcrumbItems.ts`, `issueAttachmentRepository.ts`, `graphify reference: transcribe video and audio`, `graphify reference: GitHub clone and cross-repo merge`, `dataTablePaginator.tsx`, `useScreenSize.ts`, `package.json`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `dependencies` connect `ProjectSettingsPage.tsx` to `primeicons`, `jspdf-autotable`, `react-router-dom`, `react-markdown`, `testSuiteRepository.ts`, `react-dom`, `@tanstack/react-query`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `query()` connect `ARCHITECTURE — TestManager (shiftech-test-mgr)` to `Community 1`, `graphify reference: extra exports and benchmark`, `Community 6`, `Feature Backlog — TestManager`, `AttachmentPanel.tsx`?**
