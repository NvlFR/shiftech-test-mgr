...
## Summary
- 2474 nodes · 5140 edges · 199 communities (164 shown, 35 thin omitted)
...
Cohesion: 0.11
Nodes (24): Props, Breadcrumb(), downloadTestCaseImportTemplate(), exportTestCasesToExcel(), exportTestCasesToPdf(), TEST_CASE_STATUS_SEVERITY, ImportedTestCaseRow, Option (+16 more)
...
Cohesion: 0.15
Nodes (13): PageHeader(), PageHeaderProps, useDashboard(), useRequirements(), downloadCsv(), HomePage(), Option, PRIORITIES (+5 more)

### Community 8 - "Community 8"
Cohesion: 0.09
Nodes (29): TestSuiteDialog(), TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, CharacterCount(), CharacterCountProps, dataTablePaginatorProps, dataTablePaginatorTemplate (+21 more)
...
Cohesion: 0.10
Nodes (24): ProfileView(), ProfileViewProps, describeSystemEvent(), EVENT_TYPE_LABEL, STATUS_LABEL_BY_ENTITY, statusLabel(), ISSUE_STATUS_LABEL, ISSUE_STATUS_SEVERITY (+16 more)

### Community 17 - "What You Must Do When Invoked"
Cohesion: 0.19
Nodes (13): PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_SEVERITY, useEnvironments(), useProjectRepositories(), MEMBER_ROLE_OPTIONS, ProjectSettingsPage(), REPOSITORY_SOURCE_LABEL, REPOSITORY_SOURCE_OPTIONS (+5 more)

### Community 18 - "3. Konsep Test Management"
Cohesion: 0.13
Nodes (18): IssueDialog(), IssueDialogProps, TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY, TEST_RUN_STATUS_SEVERITY, useIssuesByTestRun(), useTestRunAnalysis(), useTestRunDetail() (+10 more)
...
Cohesion: 0.15
Nodes (16): mapDashboardReportRunRow(), mapTestCaseRow(), mapTestResultRow(), dashboardReportRepository, DashboardReportResultRow, fetchAllRows(), RangeResult, ACTIVE_ISSUE_STATUSES (+8 more)
...
Cohesion: 0.14
Nodes (17): ActivityPanel(), TABLE_LABELS, CommentsPanel(), formatDateTime(), ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY, ISSUE_TYPE_SEVERITY, useActivity() (+9 more)
...
Cohesion: 0.32
Nodes (9): exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName(), useDashboardReport(), ALL, DashboardReportPage(), dashboardReportService, DashboardReport (+1 more)
...
Cohesion: 0.08
Nodes (38): CustomTestRunDialog(), CustomTestRunDialogProps, STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, BulkActionsBar(), BulkActionsBarProps, TEST_PLAN_STATUS_LABEL (+30 more)
...
Cohesion: 0.12
Nodes (22): AdminRoute(), ProtectedRoute(), ImportCasesDialog(), AppTopbar(), useBreadcrumbContext(), BreadcrumbCollapsed(), BreadcrumbItem, BreadcrumbProps (+14 more)
...
Cohesion: 0.26
Nodes (16): formatDate(), useProjectRole(), useScreenSize(), useTestPlans(), CicdIntegrationPage(), ProjectDetailPage(), ProjectsPage(), TestCasesPage() (+8 more)
...
Cohesion: 0.15
Nodes (15): IssueEditor(), IssueEditorProps, IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, ISSUE_TYPE_LABEL, DashboardReportIssueRow (+7 more)
...
Cohesion: 0.13
Nodes (15): supabase, mapEnvironmentRow(), mapTestRunAssignmentRow(), mapTestRunRow(), commentRepository, environmentRepository, moduleRepository, profileRepository (+7 more)
...
- **Why does `query()` connect `ProjectDataManagementPage.tsx` to `Community 1`, `graphify reference: extra exports and benchmark`, `Community 4`, `What You Must Do When Invoked`, `3. Konsep Test Management`?**
