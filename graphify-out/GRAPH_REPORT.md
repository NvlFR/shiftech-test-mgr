...
## Summary
- 1898 nodes · 3818 edges · 166 communities (131 shown, 35 thin omitted)
...
Cohesion: 0.06
Nodes (41): jspdf, xlsx, AppMenu(), AppMenuitem(), AppMenuSeparator(), MenuItemModel, downloadTestCaseImportTemplate(), exportTestCasesToExcel() (+33 more)
...
Cohesion: 0.10
Nodes (25): IssueDialog(), IssueDialogProps, ProfileView(), ISSUE_STATUS_SEVERITY, ISSUE_TYPE_SEVERITY, PROJECT_MEMBER_ROLE_SEVERITY, PROJECT_MEMBER_STATUS_LABEL, PROJECT_MEMBER_STATUS_SEVERITY (+17 more)
...
Cohesion: 0.14
Nodes (18): TestSuiteDialog(), ProfileViewProps, dataTablePaginatorProps, dataTablePaginatorTemplate, FilterToolbar(), FilterToolbarProps, SearchInput(), SearchInputProps (+10 more)

### Community 9 - "Community 9"
Cohesion: 0.21
Nodes (8): IssueEditorProps, mapTestRoleRow(), projectMemberRepository, testRoleRepository, ProjectMember, ProjectMemberRole, ProjectMemberWithProfile, TestRole
...
Cohesion: 0.13
Nodes (14): supabase, mapNotificationRow(), mapTestCaseStepRow(), mapTestPlanRow(), commentRepository, moduleRepository, notificationRepository, tagRepository (+6 more)
...
Cohesion: 0.13
Nodes (19): mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapProfileRow(), mapProjectMemberRow(), mapProjectMemberWithProfileRow(), mapTestSuiteItemRow(), mapTestSuiteItemStepRow() (+11 more)
...
Cohesion: 0.09
Nodes (31): Props, ImportCasesDialog(), ImportCasesDialogProps, ActivityPanel(), TABLE_LABELS, TEST_CASE_PRIORITY_LABEL, TEST_CASE_PRIORITY_SEVERITY, TEST_CASE_STATUS_SEVERITY (+23 more)
...
Cohesion: 0.07
Nodes (39): IssueEditor(), IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName() (+31 more)
...
Cohesion: 0.18
Nodes (13): Breadcrumb(), BreadcrumbItem, BreadcrumbProps, CommentsPanel(), AuthContext, AuthContextValue, useComments(), useProfileView() (+5 more)

### Community 71 - "useScreenSize.ts"
Cohesion: 0.14
Nodes (29): AdminRoute(), ProtectedRoute(), formatDate(), formatDateTime(), useAuthContext(), useCicdPipelines(), useIssuesByTestRun(), useProjectRepositories() (+21 more)

### Community 72 - "3. Konsep Test Management"
Cohesion: 0.12
Nodes (19): PageHeader(), PageHeaderProps, ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY, ISSUE_STATUS_LABEL, useIssueAttachments(), useRequirements(), IssueDetail (+11 more)
...
Cohesion: 0.29
Nodes (7): AiAssistantPanel(), useAiAssistant(), useDashboard(), useProjectContext(), downloadCsv(), HomePage(), testRunService
...
Cohesion: 0.16
Nodes (11): RowActionsMenu(), RowActionsMenuProps, PROJECT_MEMBER_ROLE_LABEL, useIssueEditorOptions(), MEMBER_ROLE_OPTIONS, REPOSITORY_SOURCE_LABEL, REPOSITORY_SOURCE_OPTIONS, VISIBILITY_OPTIONS (+3 more)
...
## Knowledge Gaps
- **726 isolated node(s):** `supabase`, `$schema`, `typescript`, `oxc`, `react/rules-of-hooks` (+721 more)
...
- **Why does `react` connect `ProjectSettingsPage.tsx` to `Community 0`, `Community 1`, `Community 4`, `Community 6`, `Community 8`, `Community 10`, `Community 12`, `What You Must Do When Invoked`, `3. Konsep Test Management`, `Feature Backlog — TestManager`, `AttachmentPanel.tsx`, `TestCaseDetailPage.tsx`, `statusLabels.ts`, `schema_auth.sql`, `graphify reference: query, path, explain`, `TestManager (shiftech-test-mgr)`, `schema_project_roles.sql`, `AppTopbar.tsx`, `issueAttachmentRepository.ts`, `graphify reference: transcribe video and audio`, `graphify reference: GitHub clone and cross-repo merge`, `useAuthContext`, `useScreenSize.ts`, `3. Konsep Test Management`, `useStoredState.ts`, `2026-07-31 — FIX-00b error TypeScript ProjectDetailPage`, `zod`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `query()` connect `useScreenSize.ts` to `graphify reference: extra exports and benchmark`, `2026-07-31 — FIX-00b error TypeScript ProjectDetailPage`, `Community 4`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `dependencies` connect `ProjectSettingsPage.tsx` to `testRunExporter.ts`, `react-router-dom`, `extraction-spec.md`, `Community 4`, `Breadcrumb.tsx`, `useRealtimeSync.ts`, `primeicons`, `@supabase/supabase-js`?**
