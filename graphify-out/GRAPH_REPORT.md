...
## Summary
- 2285 nodes · 4688 edges · 184 communities (153 shown, 31 thin omitted)
...
Cohesion: 0.16
Nodes (8): AutomationEnqueueInput, AutomationRepository, AutomationRepositoryError, config, AutomationService, invalid(), normalizeLabels(), Uuid
...
## Knowledge Gaps
- **817 isolated node(s):** `supabase`, `$schema`, `typescript`, `oxc`, `react/rules-of-hooks` (+812 more)
...
- **Why does `WriteService` connect `Community 11` to `Community 16`, `schema_test_management_v2.sql`?**
