...
## Summary
- 2548 nodes · 5272 edges · 220 communities (174 shown, 46 thin omitted)
...
10. `2026-07-31 — MCP-08 write test case/test plan tools` - 25 edges
...
Cohesion: 0.05
Nodes (54): AiAssistantPanel(), AiIssueDraftDialog(), priorities, Props, aiIssueDraftSchema, assistantEntityTypeSchema, assistantMatchSchema, assistantResponseSchema (+46 more)
...
Cohesion: 0.10
Nodes (31): Props, ImportCasesDialogProps, BulkActionsBar(), BulkActionsBarProps, exportTestCasesToPdf(), TEST_CASE_PRIORITY_LABEL, TEST_CASE_PRIORITY_SEVERITY, TEST_CASE_STATUS_LABEL (+23 more)
...
Cohesion: 0.14
Nodes (17): byteLength(), ErrorDetail, ErrorEnvelope, errorResponse(), PaginationInput, PaginationMeta, SuccessEnvelope, successResponse() (+9 more)

### Community 7 - "Community 7"
Cohesion: 0.12
Nodes (26): mapApiTokenRow(), mapWebhookDeliveryRow(), mapWebhookRow(), useIntegrations(), eventOptions, IntegrationsPage(), scopeOptions, integrationRepository (+18 more)
...
Cohesion: 0.19
Nodes (13): mapTestRunAssignmentRow(), mapTestRunRow(), useTestRunDetail(), EMPTY_FILTERS, TestRunWithSummary, useTestRuns(), TestRunFilters, testRunRepository (+5 more)

### Community 17 - "What You Must Do When Invoked"
Cohesion: 0.07
Nodes (31): IssueDialog(), IssueDialogProps, ProfileView(), ProfileViewProps, DescribableActivityEntry, describeSystemEvent(), EVENT_TYPE_LABEL, STATUS_LABEL_BY_ENTITY (+23 more)

### Community 18 - "3. Konsep Test Management"
Cohesion: 0.15
Nodes (12): loadConfig(), parseBoundedInteger(), parseReadonly(), parseRerunFailedMaxTests(), requiredEnv(), baseEnv, AnalysisRepositoryError, config (+4 more)
...
Cohesion: 0.11
Nodes (26): exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName(), mapDashboardReportRunRow(), useDashboardReport(), useEnvironments(), useProfiles(), useProjects() (+18 more)
...
Cohesion: 0.14
Nodes (21): mapProjectRow(), PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_SEVERITY, MEMBER_ROLE_OPTIONS, REPOSITORY_SOURCE_LABEL, REPOSITORY_SOURCE_OPTIONS, VISIBILITY_OPTIONS, STATUS_OPTIONS (+13 more)
...
Cohesion: 0.12
Nodes (18): mapProjectRepositoryRow(), useProjectRepositories(), projectMemberRepository, CreateProjectRepositoryInput, projectRepositoryLinkRepository, UpdateProjectRepositoryInput, CredentialAction, repositoryConnectionRepository (+10 more)
...
Cohesion: 0.16
Nodes (15): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, CharacterCount(), CharacterCountProps, TEST_PLAN_STATUS_LABEL, TEST_PLAN_STATUS_SEVERITY, ProjectTestPlanTab() (+7 more)
...
Cohesion: 0.07
Nodes (45): supabase, mapActivityEventRow(), mapAutomationJobLogRow(), mapAutomationJobRow(), mapAutomationRunnerRow(), mapAutomationScriptRow(), mapCommentMentionRow(), mapCommentRow() (+37 more)
...
Cohesion: 0.09
Nodes (33): App(), IssueEditor(), IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, Breadcrumb(), BreadcrumbItem (+25 more)
...
Cohesion: 0.18
Nodes (23): ActivityPanel(), TABLE_LABELS, formatDate(), formatDateTime(), useActivity(), useIssuesByTestRun(), useProjectRole(), useScreenSize() (+15 more)
...
Cohesion: 0.22
Nodes (6): readJsonBody(), RemoteTransport, RunningHttpTransport, sendJsonError(), startHttpTransport(), ProjectSession
...
Cohesion: 0.17
Nodes (11): GovernanceRepository, createMcpServer(), GovernanceService, ToolRateLimitError, createAutomationReadToolRegistrar(), createAutomationWriteToolRegistrar(), installToolGovernance(), registerTools() (+3 more)
...
Cohesion: 0.10
Nodes (22): xlsx, CustomTestRunDialog(), CustomTestRunDialogProps, ImportCasesDialog(), downloadTestCaseImportTemplate(), exportTestCasesToExcel(), ImportedTestCaseRow, normalizeHeader() (+14 more)
...
## Knowledge Gaps
- **899 isolated node(s):** `supabase`, `$schema`, `typescript`, `oxc`, `react/rules-of-hooks` (+894 more)
