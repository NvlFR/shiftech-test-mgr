...
## Corpus Check
- 383 files · ~231,601 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2399 nodes · 4965 edges · 198 communities (165 shown, 33 thin omitted)
...
Cohesion: 0.10
Nodes (14): loadConfig(), parseBoundedInteger(), parseReadonly(), parseRerunFailedMaxTests(), requiredEnv(), ServerConfig, AuthenticatedToken, AuthenticationError (+6 more)

### Community 8 - "Community 8"
Cohesion: 0.09
Nodes (30): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, TestSuiteDialog(), ProfileViewProps, dataTablePaginatorProps, dataTablePaginatorTemplate, FilterToolbar() (+22 more)
...
Cohesion: 0.10
Nodes (38): AdminRoute(), ProtectedRoute(), PageHeader(), PageHeaderProps, formatDate(), useAuthContext(), useAutomation(), useBackupRetention() (+30 more)
...
Cohesion: 0.06
Nodes (35): AppLayout(), AppLayoutInner(), AppMenu(), AppMenuitem(), AppMenuSeparator(), MenuItemModel, AppSidebar(), AppSidebarMask() (+27 more)

### Community 22 - "Architecture"
Cohesion: 0.10
Nodes (12): ReadRepository, ReadRepositoryError, config, IssueDetail, IssueSummary, Project, RequirementCoverage, TestCaseDetail (+4 more)
...
Cohesion: 0.10
Nodes (28): byteLength(), ErrorDetail, ErrorEnvelope, errorResponse(), paginatedResponse(), PaginationInput, PaginationMeta, SuccessEnvelope (+20 more)
...
Cohesion: 0.07
Nodes (44): Props, ImportCasesDialog(), BulkActionsBar(), BulkActionsBarProps, downloadTestCaseImportTemplate(), exportTestCasesToExcel(), exportTestCasesToPdf(), TEST_CASE_PRIORITY_LABEL (+36 more)
...
Cohesion: 0.10
Nodes (29): ActivityPanel(), TABLE_LABELS, BreadcrumbItem, CommentsPanel(), formatDateTime(), ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY, ISSUE_STATUS_LABEL (+21 more)
...
Cohesion: 0.13
Nodes (17): IssueEditor(), IssueEditorProps, IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, DashboardReportIssueRow, projectMemberRepository (+9 more)
...
Cohesion: 0.17
Nodes (13): TestResultListQuery, ProjectScopeError, ProjectSession, encodeCodeCursor, encodeRequirementCursor(), encodeTestCaseCursor(), encodeTestResultCursor(), ResultCursor (+5 more)
...
Cohesion: 0.15
Nodes (14): AiAssistantPanel(), useAiAssistant(), useDashboard(), useProjectContext(), EMPTY_FILTERS, TestRunWithSummary, downloadCsv(), HomePage() (+6 more)
...
Cohesion: 0.11
Nodes (22): IssueDialog(), IssueDialogProps, ISSUE_STATUS_SEVERITY, PROJECT_MEMBER_ROLE_LABEL, PROJECT_MEMBER_ROLE_SEVERITY, PROJECT_MEMBER_STATUS_LABEL, PROJECT_MEMBER_STATUS_SEVERITY, PROJECT_STATUS_LABEL (+14 more)
...
Cohesion: 0.13
Nodes (22): CodeCursorQuery, IssueSearchQuery, RequirementListQuery, TestCaseSearchQuery, TestRunListQuery, ArtifactUrl, IssuePriority, IssueStatus (+14 more)
...
Cohesion: 0.25
Nodes (8): 2026-07-31 — MCP-08 write test case/test plan tools, 2026-07-31 — MCP-09 gate manusia approval Test Plan, 2026-07-31 — MCP-11 workflow Issue, 2026-07-31 — MCP-12 tool Automation, 2026-07-31 — MCP-13 selective rerun failed, 2026-07-31 — MCP-15 tool analisis, 2026-07-31 — MCP-16 rate limit dan audit tool MCP, 2026-08-01 — Eksekusi seluruh migration melalui MCP Supabase

### Community 181 - "ReadService"
Cohesion: 0.16
Nodes (16): PROJECT_STATUS_SEVERITY, useDashboardReport(), useEnvironments(), useProfiles(), useProjectRepositories(), useProjects(), ALL, DashboardReportPage() (+8 more)
...
## Knowledge Gaps
- **841 isolated node(s):** `supabase`, `$schema`, `typescript`, `oxc`, `react/rules-of-hooks` (+836 more)
...
- **Why does `query()` connect `3. Konsep Test Management` to `AppTopbar.tsx`, `graphify reference: extra exports and benchmark`, `ReadService`, `schema_auth.sql`?**
