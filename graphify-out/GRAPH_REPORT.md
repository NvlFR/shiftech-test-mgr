...
## Summary
- 2221 nodes · 4536 edges · 180 communities (148 shown, 32 thin omitted)
...
Cohesion: 0.11
Nodes (22): mapAutomationJobRow(), mapAutomationRunnerRow(), mapAutomationScriptRow(), automationRepository, testResultStepRepository, automationService, testResultStepService, ActivityAction (+14 more)
...
Cohesion: 0.23
Nodes (28): JsonRecord, mapIssueDetailRow(), mapIssueSummaryRow(), mapProjectRow(), mapRequirementCoverageRow(), mapRequirementDetailRow(), mapRequirementSummaryRow(), mapRunCounts() (+20 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (33): loadConfig(), parseReadonly(), requiredEnv(), ServerConfig, authService, config, readService, server (+25 more)

### Community 8 - "Community 8"
Cohesion: 0.11
Nodes (26): AiAssistantPanel(), TestSuiteDialog(), dataTablePaginatorProps, dataTablePaginatorTemplate, FilterToolbar(), FilterToolbarProps, PageHeader(), PageHeaderProps (+18 more)
...
Cohesion: 0.22
Nodes (4): normalizePageSize(), decodeCursor(), decodeResultCursor(), ReadService
...
Cohesion: 0.07
Nodes (33): mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapEnvironmentRow(), mapProfileRow(), mapProjectMemberRow(), mapProjectMemberWithProfileRow(), mapTestCaseStepRow() (+25 more)
...
Cohesion: 0.18
Nodes (13): PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_SEVERITY, useAutomation(), useEnvironments(), AutomationPage(), jobSeverity, runnerOnline(), MEMBER_ROLE_OPTIONS (+5 more)

### Community 22 - "Architecture"
Cohesion: 0.17
Nodes (3): ReadRepository, Project, RequirementCoverage

### Community 23 - "AttachmentPanel.tsx"
Cohesion: 0.13
Nodes (19): supabase, mapIssueRow(), mapModuleRow(), mapTagRow(), mapTestCaseVersionRow(), mapTestPlanCaseRow(), mapTestRoleRow(), commentRepository (+11 more)
...
Cohesion: 0.08
Nodes (34): IssueDialog(), IssueDialogProps, STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, BulkActionsBar(), BulkActionsBarProps, TEST_PLAN_STATUS_SEVERITY (+26 more)
...
Cohesion: 0.13
Nodes (18): ProfileView(), Breadcrumb(), BreadcrumbItem, BreadcrumbProps, ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY, ISSUE_TYPE_SEVERITY, useProfileView() (+10 more)
...
Cohesion: 0.07
Nodes (40): AiTestCaseGeneratorDialog(), maxCaseOptions, priorityOptions, Props, CustomTestRunDialog(), CustomTestRunDialogProps, ImportCasesDialog(), ImportCasesDialogProps (+32 more)
...
Cohesion: 0.12
Nodes (20): IssueEditor(), IssueEditorProps, IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, ISSUE_TYPE_LABEL, useIssueEditorOptions() (+12 more)
...
Cohesion: 0.14
Nodes (25): formatDate(), useDashboard(), useIssuesByTestRun(), ProjectContext, ProjectContextValue, ProjectProvider(), useProjectContext(), useProjectRole() (+17 more)
...
Cohesion: 0.23
Nodes (9): mapDashboardReportRunRow(), mapTestCaseRow(), mapTestResultRow(), mapTestResultStepRow(), DashboardReportResultRow, fetchAllRows(), RangeResult, TestResult (+1 more)
...
Cohesion: 0.40
Nodes (3): mapNotificationRow(), notificationRepository, notificationService
...
Cohesion: 0.13
Nodes (18): AdminRoute(), ProtectedRoute(), ActivityPanel(), TABLE_LABELS, CommentsPanel(), UserHoverCard(), UserHoverCardProps, formatDateTime() (+10 more)
...
Cohesion: 0.10
Nodes (25): ProfileViewProps, describeSystemEvent(), EVENT_TYPE_LABEL, STATUS_LABEL_BY_ENTITY, statusLabel(), ISSUE_STATUS_LABEL, ISSUE_STATUS_SEVERITY, PROJECT_MEMBER_ROLE_SEVERITY (+17 more)
...
- **Why does `query()` connect `testSuiteRepository.ts` to `Community 8`, `graphify reference: extra exports and benchmark`, `schema_auth.sql`?**
  _High betweenness centrality (0.129) - this node is a cross-community bridge._
- **Why does `Uuid` connect `testRunService.ts` to `3. Konsep Test Management`, `Community 7`?**
  _High betweenness centrality (0.112) - this node is a cross-community bridge._
- **Why does `WriteService` connect `Community 7` to `schema_test_management_v2.sql`?**
