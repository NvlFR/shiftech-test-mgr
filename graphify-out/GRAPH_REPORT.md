...
## Corpus Check
- 346 files · ~214,058 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2130 nodes · 4280 edges · 179 communities (147 shown, 32 thin omitted)
...
Cohesion: 0.15
Nodes (34): JsonRecord, mapProjectRow(), mapRunCounts(), mapTestCaseDetailRow(), mapTestCaseSummaryRow(), mapTestPlanDetailRow(), mapTestPlanSummaryRow(), mapTestResultSummaryRow() (+26 more)
...
Cohesion: 0.10
Nodes (28): AdminRoute(), ProtectedRoute(), AppTopbar(), useBreadcrumbContext(), ProfileView(), Breadcrumb(), BreadcrumbCollapsed(), BreadcrumbItem (+20 more)
...
Cohesion: 0.09
Nodes (25): mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapProfileRow(), mapProjectMemberRow(), mapProjectMemberWithProfileRow(), mapTestCaseStepRow(), mapTestSuiteItemRow() (+17 more)
...
Cohesion: 0.21
Nodes (9): authService, config, readService, server, transport, registerTools(), unusedServer, ToolRegistrar (+1 more)

### Community 22 - "Architecture"
Cohesion: 0.13
Nodes (16): supabase, mapEnvironmentRow(), mapTestResultRow(), mapTestResultStepRow(), commentRepository, environmentRepository, moduleRepository, tagRepository (+8 more)

### Community 23 - "AttachmentPanel.tsx"
Cohesion: 0.13
Nodes (18): mapIssueRow(), mapModuleRow(), mapTagRow(), mapTestCaseRow(), mapTestCaseVersionRow(), mapTestPlanCaseRow(), mapTestRoleRow(), issueRepository (+10 more)
...
Cohesion: 0.07
Nodes (27): dependencies, @hookform/resolvers, jspdf-autotable, primeflex, primeicons, primereact, react-dom, react-hook-form (+19 more)

### Community 26 - "TestCaseDetailPage.tsx"
Cohesion: 0.09
Nodes (26): TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, AttachmentPanel(), AttachmentPanelProps, formatFileSize(), CharacterCount(), CharacterCountProps (+18 more)
...
Cohesion: 0.06
Nodes (40): DescribableActivityEntry, describeSystemEvent(), EVENT_TYPE_LABEL, STATUS_LABEL_BY_ENTITY, statusLabel(), ACTIVITY_ENTITY_LABEL, ACTIVITY_ENTITY_ROUTE, ActivityEntityType (+32 more)
...
Cohesion: 0.15
Nodes (14): IssueDialog(), IssueDialogProps, TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY, TEST_RUN_STATUS_SEVERITY, useIssuesByTestRun(), useTestRunAnalysis(), useTestRunDetail() (+6 more)
...
Cohesion: 0.14
Nodes (18): mapDashboardReportRunRow(), DashboardReportIssueRow, dashboardReportRepository, DashboardReportResultRow, fetchAllRows(), RangeResult, ACTIVE_ISSUE_STATUSES, calculateIssueAging() (+10 more)
...
Cohesion: 0.11
Nodes (23): IssueEditor(), IssueEditorProps, IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, ISSUE_TYPE_LABEL, projectMemberRepository (+15 more)
...
Cohesion: 0.17
Nodes (12): useBackupRetention(), useIssueAttachments(), useIssueEditorOptions(), useProjectRole(), IssueDetail, IssueDetailPage(), STATUS_OPTIONS, ProjectDataManagementPage() (+4 more)
...
Cohesion: 0.15
Nodes (17): PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_SEVERITY, useAutomation(), useEnvironments(), useProjectRepositories(), AutomationPage(), jobSeverity, runnerOnline() (+9 more)
...
Cohesion: 0.12
Nodes (21): AiAssistantPanel(), ProfileViewProps, mapProjectRow(), useAiAssistant(), useDashboard(), ProjectContext, ProjectContextValue, useProjectContext() (+13 more)
...
Cohesion: 0.12
Nodes (21): Props, ImportCasesDialog(), ImportCasesDialogProps, ISSUE_PRIORITY_OPTIONS, ISSUE_STATUS_OPTIONS, PRIORITY_OPTIONS, projectCache, ProjectTabData (+13 more)
...
## Knowledge Gaps
- **798 isolated node(s):** `supabase`, `$schema`, `typescript`, `oxc`, `react/rules-of-hooks` (+793 more)
...
- **Why does `query()` connect `Community 8` to `TestRunDetailPage.tsx`, `graphify reference: extra exports and benchmark`, `issueAttachmentRepository.ts`, `schema_entity_codes.sql`, `graphify reference: GitHub clone and cross-repo merge`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `react` connect `testSuiteRepository.ts` to `Community 0`, `Community 1`, `Community 4`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `ARCHITECTURE — TestManager (shiftech-test-mgr)`, `Architecture`, `TestCaseDetailPage.tsx`, `statusLabels.ts`, `schema_entity_codes.sql`, `TestRunDetailPage.tsx`, `schema_auth.sql`, `graphify reference: query, path, explain`, `TestManager (shiftech-test-mgr)`, `schema_project_roles.sql`, `AppTopbar.tsx`, `testSuiteRepository.ts`, `useStoredState.ts`, `issueAttachmentRepository.ts`, `graphify reference: transcribe video and audio`, `graphify reference: GitHub clone and cross-repo merge`, `useAuthContext`, `AppLayout.tsx`, `csvImport.ts`, `useStoredState.ts`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `Uuid` connect `testRunService.ts` to `Community 7`?**
