...
## Corpus Check
- 301 files · ~194,825 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1817 nodes · 3673 edges · 161 communities (135 shown, 26 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 28 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fa64df21`
...
Cohesion: 0.19
Nodes (16): ImportCasesDialog(), ImportCasesDialogProps, mapProjectRow(), STATUS_OPTIONS, ProjectOwnerFilter, ProjectPaginatedQuery, ProjectQuery, projectRepository (+8 more)
...
Cohesion: 0.18
Nodes (13): PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_LABEL, PROJECT_STATUS_SEVERITY, ImportedTestCaseRow, MEMBER_ROLE_OPTIONS, VISIBILITY_OPTIONS, PRIORITY_OPTIONS, moduleService (+5 more)

### Community 18 - "3. Konsep Test Management"
Cohesion: 0.12
Nodes (25): mapRequirementLinkRow(), useRequirements(), Option, PRIORITIES, RequirementsPage(), STATUSES, TYPES, mapLink() (+17 more)
...
Cohesion: 0.17
Nodes (22): formatDate(), useCicdPipelines(), useProjectRole(), useScreenSize(), useTestPlans(), LoginPage(), CicdIntegrationPage(), providerOptions (+14 more)
...
Cohesion: 0.16
Nodes (15): mapTestCaseRow(), mapTestResultRow(), mapTestRunAssignmentRow(), mapTestRunRow(), EMPTY_FILTERS, TestRunWithSummary, fetchAllRows(), RangeResult (+7 more)
...
Cohesion: 0.33
Nodes (7): useDashboardReport(), useEnvironments(), useProfiles(), useProjects(), ALL, DashboardReportPage(), profileService
...
Cohesion: 0.12
Nodes (19): supabase, mapIssueRow(), mapModuleRow(), mapTagRow(), mapTestCaseVersionRow(), mapTestPlanCaseRow(), mapTestPlanRow(), mapTestRoleRow() (+11 more)
...
Cohesion: 0.17
Nodes (12): downloadTestCaseImportTemplate(), exportTestCasesToExcel(), exportTestCasesToPdf(), TEST_CASE_STATUS_LABEL, TEST_CASE_STATUS_SEVERITY, Option, PRIORITY_OPTIONS, ProjectTestCaseTab() (+4 more)
...
Cohesion: 0.10
Nodes (27): IssueDialog(), IssueDialogProps, ProfileViewProps, ISSUE_STATUS_SEVERITY, PROJECT_MEMBER_ROLE_SEVERITY, PROJECT_MEMBER_STATUS_LABEL, PROJECT_MEMBER_STATUS_SEVERITY, PROJECT_VISIBILITY_LABEL (+19 more)
...
Cohesion: 0.16
Nodes (14): AppTopbar(), BreadcrumbContext, BreadcrumbContextValue, BreadcrumbItem, BreadcrumbProvider(), useBreadcrumbContext(), BreadcrumbCollapsed(), BreadcrumbTrail() (+6 more)
...
## Knowledge Gaps
- **698 isolated node(s):** `supabase`, `$schema`, `typescript`, `oxc`, `react/rules-of-hooks` (+693 more)
