...
## Corpus Check
- 509 files · ~305,296 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3203 nodes · 6446 edges · 276 communities (222 shown, 54 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 60 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `59f9c5fc`
...
1. `react` - 99 edges
2. `2026-08-01 — E2E-09 fallback eksekusi manual tanpa automation script` - 56 edges
...
Cohesion: 0.14
Nodes (17): aiIssueDraftSchema, artifactSchema, assistantEntityTypeSchema, assistantMatchSchema, assistantResponseSchema, calculateDuplicateConfidence(), duplicateCandidateSchema, duplicateResponseSchema (+9 more)
...
Cohesion: 0.11
Nodes (15): DuplicateIssueDraft, IssuePriority, IssueStatus, IssueWriteInput, TestCaseChanges, TestCaseWriteInput, TestResultWriteStatus, toCaseRow() (+7 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (32): loadConfig(), parseBoundedInteger(), parseReadonly(), parseRerunFailedMaxTests(), ServerConfig, baseEnv, transportFor(), AnalysisRepositoryError (+24 more)
...
Cohesion: 0.07
Nodes (36): mapAutomationJobLogRow(), mapAutomationJobRow(), mapAutomationRunnerRow(), mapAutomationScriptRow(), automationRepository, testResultStepRepository, automationService, testResultStepService (+28 more)
...
Cohesion: 0.31
Nodes (8): mapProjectRow(), ProjectOwnerFilter, ProjectPaginatedQuery, ProjectQuery, SORT_COLUMN, ProjectSortField, ProjectStatus, SortDirection
...
Cohesion: 0.07
Nodes (32): byteLength(), ErrorDetail, ErrorEnvelope, errorResponse(), McpToolError, PaginationInput, PaginationMeta, SuccessEnvelope (+24 more)
...
Cohesion: 0.08
Nodes (38): App(), AdminRoute(), ProtectedRoute(), auth, BreadcrumbItem, CommentsPanel(), UserHoverCard(), UserHoverCardProps (+30 more)
...
Cohesion: 0.10
Nodes (26): AnalysisOutputSchema, AnalysisRequest, Artifact, AssistantOutputSchema, AssistantRequest, computeDuplicateConfidence(), csvCell(), DuplicateOutputSchema (+18 more)
...
Cohesion: 0.05
Nodes (60): AiAssistantPanel(), AiTestCaseGeneratorDialog(), maxCaseOptions, priorityOptions, Props, CustomTestRunDialog(), CustomTestRunDialogProps, ImportCasesDialog() (+52 more)

### Community 26 - "TestCaseDetailPage.tsx"
Cohesion: 0.10
Nodes (27): AutomationJobCommand, BootstrapConnectionConfig, CodegenTestCaseStep, EnvironmentMetadata, JobRepository, RedeemedRunner, ReportPayload, collectEnvironmentMetadata() (+19 more)

### Community 27 - "statusLabels.ts"
Cohesion: 0.16
Nodes (27): formatDateTime(), useAutomation(), useAutomationJobLogs(), useCicdPipelines(), useEnvironments(), useIssuesByTestRun(), useProjectRole(), useScreenSize() (+19 more)
...
Cohesion: 0.04
Nodes (56): 2026-08-01 — ADM-01 Scheduled Test Run, 2026-08-01 — ADM-02 pembatasan eksekusi dan secret management runner, 2026-08-01 — ADM-02 percobaan ulang gate verifikasi, 2026-08-01 — ADM-03 percobaan ulang gate verifikasi, 2026-08-01 — ADM-03 permission granular per project, 2026-08-01 — ADM-04 Team management, 2026-08-01 — ADM-04 Team management (perbaikan gate verifikasi), 2026-08-01 — ADM-05 Activity feed per Project (+48 more)
...
Cohesion: 0.11
Nodes (21): PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_SEVERITY, useProjectRepositories(), MEMBER_ROLE_OPTIONS, PERMISSION_OPTIONS, REPOSITORY_SOURCE_LABEL, REPOSITORY_SOURCE_OPTIONS, VISIBILITY_OPTIONS (+13 more)
...
Cohesion: 0.17
Nodes (19): canonicalAction, ErrorEnvelope, GatewayRequest, OUTPUT_SCHEMA_HINT, requestInput(), SuccessEnvelope, analysisResponse(), completeWithRetry() (+11 more)

### Community 37 - "Coding Conventions"
Cohesion: 0.08
Nodes (56): JsonRecord, mapAnalysisRunSummaryRow(), mapFlakyCandidateRow(), mapIssueDetailRow(), mapIssueSummaryRow(), mapProjectRow(), mapRequirementCoverageRow(), mapRequirementDetailRow() (+48 more)

### Community 38 - "README.md"
Cohesion: 0.15
Nodes (7): AutomationApi, JobLogStream, RunnerConfig, isRunnerTokenRejected(), JobLogStreamer, Runner, sleep()
...
Cohesion: 0.07
Nodes (28): bin, tm-runner, dependencies, @testmanager/agent-core, description, devDependencies, @types/node, typescript (+20 more)
...
Cohesion: 0.10
Nodes (27): TestSuiteDialog(), dataTablePaginatorProps, dataTablePaginatorTemplate, FilterToolbar(), FilterToolbarProps, PageHeader(), PageHeaderProps, RowActionsMenu() (+19 more)
...
Cohesion: 0.10
Nodes (24): mapRestorePreviewRow(), mapRestoreResultRow(), mapRetentionCleanupPreviewRow(), mapRetentionCleanupResultRow(), mapRetentionPolicyRow(), backup(), backupRetentionRepository, cleanup() (+16 more)
...
Cohesion: 0.26
Nodes (8): mapCicdPipelineRow(), cicdRepository, cicdService, CicdIngestPayload, CicdIngestResponse, CicdPipeline, CicdPipelineSecret, CicdProvider

### Community 59 - "schema_project_members.sql"
Cohesion: 0.22
Nodes (13): parseAssistantResult(), AiGatewayRequest, aiRepository, aiAssistantService, AiActorContext, AiAssistantEntityType, AiAssistantMatch, AiAssistantSearchRequest (+5 more)
...
Cohesion: 0.07
Nodes (38): IssueDialog(), IssueDialogProps, STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, TEST_PLAN_STATUS_LABEL, TEST_PLAN_STATUS_SEVERITY, TEST_RUN_STATUS_LABEL (+30 more)
...
Cohesion: 0.17
Nodes (14): AppMenu(), AppMenuitem(), AppMenuSeparator(), MenuItemModel, formatDate(), PROJECT_STATUS_LABEL, useProjectPins(), useProjects() (+6 more)

### Community 102 - "aiIssueService.ts"
Cohesion: 0.09
Nodes (31): exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName(), mapDashboardQaLoopAuditRow(), mapDashboardReportRunRow(), useDashboardReport(), useProfiles(), ALL (+23 more)
...
Cohesion: 0.08
Nodes (40): supabase, mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapEnvironmentRow(), mapIssueRow(), mapModuleRow(), mapProfileRow() (+32 more)
...
Cohesion: 0.13
Nodes (13): TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, mapTestSuiteItemRow(), mapTestSuiteItemStepRow(), mapTestSuiteRow(), SuiteItemInput, testSuiteRepository (+5 more)
...
Cohesion: 0.14
Nodes (22): AppLayout(), AppLayoutInner(), AppSidebar(), AppSidebarMask(), AppTopbar(), BreadcrumbContext, BreadcrumbContextValue, BreadcrumbItem (+14 more)
...
Cohesion: 0.20
Nodes (11): useAiTestCaseReview(), useDashboard(), ProjectContext, ProjectContextValue, ProjectProvider(), useProjectContext(), downloadCsv(), HomePage() (+3 more)

### Community 208 - "writeService.ts"
Cohesion: 0.21
...
### Community 213 - "contract.test.ts"
Cohesion: 0.24
...
### Community 258 - "@tanstack/react-query"
Cohesion: 0.39
...
Cohesion: 0.09
Nodes (23): ProfileView(), ProfileViewProps, ISSUE_STATUS_SEVERITY, PROJECT_MEMBER_ROLE_SEVERITY, PROJECT_MEMBER_STATUS_LABEL, PROJECT_MEMBER_STATUS_SEVERITY, PROJECT_VISIBILITY_LABEL, PROJECT_VISIBILITY_SEVERITY (+15 more)

### Community 260 - "package.json"
Cohesion: 0.27
Nodes (9): IssueEditor(), IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, AiIssueCandidateInput, ExternalLink, IssuePriority (+1 more)
...
### Community 266 - "@tanstack/react-query"
Cohesion: 0.39
Nodes (7): AiIssueDraftDialog(), priorities, Props, useAiIssueWorkflow(), AiIssueDraft, DuplicateIssueCandidate, TestResultWithDetails

### Community 267 - "@tanstack/react-query"
Cohesion: 0.33
Nodes (6): activityDetail(), ActivityPanel(), TABLE_LABELS, useActivity(), activityRepository, activityService

### Community 268 - "zod"
Cohesion: 0.29
Nodes (5): buildDuplicateReason(), parseDuplicateCandidates(), aiIssueService, assertActor(), assertAiProjectScope()

### Community 270 - "RepoAdapter"
Cohesion: 0.39
Nodes (5): testResultService, TEXT_ARTIFACT_TYPES, AutomationArtifact, ScreenshotComparison, ViewableAutomationArtifact

### Community 273 - "typescript"
Cohesion: 0.29
...
## Knowledge Gaps
- **1133 isolated node(s):** `supabase`, `$schema`, `typescript`, `oxc`, `react/rules-of-hooks` (+1128 more)
...
- **Why does `useAiTestCaseReview()` connect `jspdf-autotable` to `ProjectSettingsPage.tsx`, `Community 2`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `WriteService` connect `Community 2` to `schema_issue_attachments.sql`, `Community 12`, `Community 14`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `query()` connect `statusLabels.ts` to `ProjectSettingsPage.tsx`, `schema.sql`, `What You Must Do When Invoked`?**
