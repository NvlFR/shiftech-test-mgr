...
## Corpus Check
- 414 files · ~253,011 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2590 nodes · 5332 edges · 225 communities (181 shown, 44 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 45 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `49aa32d9`
...
4. `Worklog` - 39 edges
5. `supabase` - 36 edges
6. `2026-07-31 — MCP-08 write test case/test plan tools` - 31 edges
...
Cohesion: 0.15
Nodes (20): AiTestCaseGeneratorDialog(), maxCaseOptions, priorityOptions, ReviewDraft, toAiTestCaseSource(), DEFAULT_OPTIONS, useAiTestCaseGenerator(), aiTestCaseRepository (+12 more)

### Community 1 - "Community 1"
Cohesion: 0.16
Nodes (15): AiIssueDraftDialog(), priorities, Props, buildDuplicateReason(), formatDraftMetadata(), toIssuePriority(), useAiIssueWorkflow(), aiIssueService (+7 more)
...
Cohesion: 0.07
Nodes (35): xlsx, CustomTestRunDialog(), CustomTestRunDialogProps, ImportCasesDialog(), STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, BulkActionsBar() (+27 more)
...
Cohesion: 0.10
Nodes (31): mapApiTokenRow(), mapWebhookDeliveryRow(), mapWebhookRow(), useIntegrations(), eventOptions, IntegrationsPage(), scopeOptions, integrationRepository (+23 more)

### Community 8 - "Community 8"
Cohesion: 0.15
Nodes (15): TestSuiteDialog(), dataTablePaginatorProps, dataTablePaginatorTemplate, FilterToolbar(), FilterToolbarProps, RowActionsMenu(), RowActionsMenuProps, SearchInput() (+7 more)
...
Cohesion: 0.12
Nodes (30): App(), AiAssistantPanel(), AdminRoute(), ProtectedRoute(), formatDate(), useAiAssistant(), AuthContext, AuthContextValue (+22 more)
...
Cohesion: 0.11
Nodes (22): ProfileViewProps, describeSystemEvent(), EVENT_TYPE_LABEL, STATUS_LABEL_BY_ENTITY, statusLabel(), ISSUE_STATUS_SEVERITY, ISSUE_TYPE_SEVERITY, PROJECT_MEMBER_ROLE_SEVERITY (+14 more)
...
Cohesion: 0.12
Nodes (23): AppMenu(), AppMenuitem(), AppMenuSeparator(), MenuItemModel, exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName(), useDashboardReport() (+15 more)
...
Cohesion: 0.10
Nodes (24): jspdf, IssueDialog(), IssueDialogProps, PageHeader(), PageHeaderProps, TEST_RUN_STATUS_SEVERITY, exportTestRunsToExcel(), exportTestRunsToPdf() (+16 more)

### Community 28 - "schema_entity_codes.sql"
Cohesion: 0.12
Nodes (20): AutomationJob, CodegenTestCaseStep, EnvironmentMetadata, JobRepository, ReportPayload, collectEnvironmentMetadata(), DEFAULT_VIEWPORT, parseViewport() (+12 more)
...
Cohesion: 0.06
Nodes (41): AppLayout(), AppLayoutInner(), AppSidebar(), AppSidebarMask(), AppTopbar(), BreadcrumbContext, BreadcrumbContextValue, BreadcrumbItem (+33 more)
...
Cohesion: 0.15
Nodes (17): IssueEditorProps, PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_SEVERITY, useEnvironments(), useProjectRepositories(), MEMBER_ROLE_OPTIONS, ProjectSettingsPage(), REPOSITORY_SOURCE_LABEL (+9 more)
...
Cohesion: 0.14
Nodes (22): IssueEditor(), IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY, ISSUE_STATUS_LABEL (+14 more)
...
Cohesion: 0.12
Nodes (15): ProfileView(), Breadcrumb(), BreadcrumbItem, BreadcrumbProps, TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY, useProfileView(), useProjectBreadcrumbItems() (+7 more)
...
Cohesion: 0.27
Nodes (8): mapTestRunAssignmentRow(), mapTestRunRow(), EMPTY_FILTERS, TestRunWithSummary, TestRunFilters, testRunRepository, TestRun, TestRunAssignment
...
Cohesion: 0.08
Nodes (23): loadConfig(), parseBoundedInteger(), parseReadonly(), parseRerunFailedMaxTests(), requiredEnv(), ServerConfig, baseEnv, readJsonBody() (+15 more)

### Community 149 - "smoke.spec.ts"
Cohesion: 0.16
Nodes (6): AutomationApi, JobLogStream, hasCompleteFailureBundle(), JobLogStreamer, Runner, sleep()
...
Cohesion: 0.06
Nodes (31): 2026-07-31 — MCP-08 write test case/test plan tools, 2026-07-31 — MCP-09 gate manusia approval Test Plan, 2026-07-31 — MCP-11 workflow Issue, 2026-07-31 — MCP-12 tool Automation, 2026-07-31 — MCP-13 selective rerun failed, 2026-07-31 — MCP-15 tool analisis, 2026-07-31 — MCP-16 rate limit dan audit tool MCP, 2026-08-01 — Eksekusi seluruh migration melalui MCP Supabase (+23 more)

### Community 165 - "useAuthContext"
Cohesion: 0.17
Nodes (17): JobResult, ReportArtifact, classifyArtifact(), collectArtifacts(), CollectedArtifact, REQUIRED_FAILURE_ARTIFACT_TYPES, walk(), BaseUrlSanityCheckResult (+9 more)
...
Cohesion: 0.10
Nodes (32): Props, exportTestCasesToExcel(), exportTestCasesToPdf(), TEST_CASE_PRIORITY_LABEL, TEST_CASE_PRIORITY_SEVERITY, TEST_CASE_STATUS_LABEL, TEST_CASE_STATUS_SEVERITY, useTestPlanDetail() (+24 more)
...
Cohesion: 0.13
Nodes (15): supabase, mapEnvironmentRow(), mapTestCaseStepRow(), commentRepository, environmentRepository, moduleRepository, profileRepository, tagRepository (+7 more)

### Community 183 - "AppLayout.tsx"
Cohesion: 0.14
Nodes (15): aiIssueDraftSchema, assistantEntityTypeSchema, assistantMatchSchema, assistantResponseSchema, calculateDuplicateConfidence(), duplicateCandidateSchema, duplicateResponseSchema, normaliseAiText() (+7 more)
...
### Community 204 - "zod"
Cohesion: 0.33
Nodes (7): ActivityPanel(), TABLE_LABELS, CommentsPanel(), formatDateTime(), useActivity(), useComments(), TestCaseDetailPage()
...
### Community 209 - "api.ts"
Cohesion: 0.29
Nodes (10): AiGatewayRequest, aiRepository, aiAssistantService, AiActorContext, AiAssistantEntityType, AiAssistantMatch, AiAssistantSearchRequest, AiAssistantSearchResult (+2 more)
...
### Community 216 - "dashboardRepository.ts"
Cohesion: 0.15
Nodes (13): mapDashboardReportRunRow(), DashboardReportIssueRow, dashboardReportRepository, DashboardReportResultRow, countRows(), countStatuses(), dashboardRepository, fetchAllRows() (+5 more)
...
## Knowledge Gaps
- **908 isolated node(s):** `1. Fitur yang sudah selesai`, `Requirement Traceability`, `Environment Management`, `Test Run Enhancement`, `Test Case Productivity` (+903 more)
...
- **Why does `query()` connect `Community 16` to `ProjectDataManagementPage.tsx`, `graphify reference: extra exports and benchmark`, `testSuiteRepository.ts`?**
  _High betweenness centrality (0.142) - this node is a cross-community bridge._
- **Why does `Uuid` connect `testRunService.ts` to `Community 9`, `Community 11`, `AttachmentPanel.tsx`?**
  _High betweenness centrality (0.140) - this node is a cross-community bridge._
- **Why does `react` connect `Community 16` to `Community 0`, `Community 1`, `Community 4`, `Community 7`, `Community 8`, `csvImport.ts`, `Community 10`, `Community 12`, `3. Konsep Test Management`, `ARCHITECTURE — TestManager (shiftech-test-mgr)`, `Feature Backlog — TestManager`, `TestCaseDetailPage.tsx`, `statusLabels.ts`, `schema_auth.sql`, `ProjectDataManagementPage.tsx`, `TestManager (shiftech-test-mgr)`, `schema_project_roles.sql`, `AppTopbar.tsx`, `testSuiteRepository.ts`, `useProjectBreadcrumbItems.ts`, `graphify reference: transcribe video and audio`, `graphify reference: GitHub clone and cross-repo merge`, `csvImport.ts`, `react-dom`, `zod`, `api.ts`, `dashboardRepository.ts`, `AppTopbar.tsx`, `csvImport.ts`, `smoke.spec.ts`?**
