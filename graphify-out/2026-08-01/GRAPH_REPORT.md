...
## Corpus Check
- 391 files · ~237,449 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2454 nodes · 5098 edges · 204 communities (165 shown, 39 thin omitted)
...
## Communities (204 total, 39 thin omitted)
...
Cohesion: 0.15
Nodes (21): AiIssueDraftDialog(), priorities, Props, formatDraftMetadata(), parseDuplicateCandidates(), toIssuePriority(), useAiIssueWorkflow(), AiGatewayRequest (+13 more)
...
Cohesion: 0.05
Nodes (58): ApiError, AutomationApi, AutomationJob, JobRepository, JobResult, ReportArtifact, ReportPayload, classify() (+50 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (50): xlsx, AiTestCaseGeneratorDialog(), maxCaseOptions, priorityOptions, Props, CustomTestRunDialog(), CustomTestRunDialogProps, ImportCasesDialogProps (+42 more)
...
Cohesion: 0.18
Nodes (13): jspdf, exportTestRunsToExcel(), exportTestRunsToPdf(), fileName(), TestRunExportRow, useDashboard(), ProjectContext, ProjectContextValue (+5 more)
...
Cohesion: 0.12
Nodes (20): ProfileViewProps, describeSystemEvent(), EVENT_TYPE_LABEL, STATUS_LABEL_BY_ENTITY, statusLabel(), ISSUE_STATUS_LABEL, ISSUE_STATUS_SEVERITY, PROJECT_MEMBER_ROLE_SEVERITY (+12 more)
...
Cohesion: 0.12
Nodes (20): PageHeader(), PageHeaderProps, useAutomation(), useCicdPipelines(), useRequirements(), useTestPlans(), AutomationPage(), jobSeverity (+12 more)
...
Cohesion: 0.22
Nodes (11): dashboardReportRepository, ACTIVE_ISSUE_STATUSES, calculateIssueAging(), dashboardReportService, percent(), RESULT_STATUSES, withSummary(), DashboardIssueAging (+3 more)
...
Cohesion: 0.09
Nodes (28): mapAutomationJobRow(), mapAutomationRunnerRow(), mapAutomationScriptRow(), mapCicdPipelineRow(), automationRepository, cicdRepository, automationService, ActivityAction (+20 more)
...
Cohesion: 0.15
Nodes (14): aiIssueDraftSchema, assistantEntityTypeSchema, assistantMatchSchema, assistantResponseSchema, buildDuplicateReason(), calculateDuplicateConfidence(), duplicateCandidateSchema, duplicateResponseSchema (+6 more)

### Community 40 - "graphify reference: query, path, explain"
Cohesion: 0.09
Nodes (27): ProfileView(), BreadcrumbItem, BreadcrumbProps, CommentsPanel(), UserHoverCard(), UserHoverCardProps, ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY (+19 more)
...
Cohesion: 0.24
Nodes (9): AiAssistantPanel(), parseAssistantResult(), useAiAssistant(), aiAssistantService, assertActor(), assertAiProjectScope(), AiActorContext, AiAssistantEntityType (+1 more)
...
Cohesion: 0.15
Nodes (20): AppLayout(), AppLayoutInner(), AppSidebar(), AppSidebarMask(), AppTopbar(), BreadcrumbContext, BreadcrumbContextValue, BreadcrumbItem (+12 more)
...
Cohesion: 0.09
Nodes (36): AppMenu(), AppMenuitem(), AppMenuSeparator(), MenuItemModel, exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName(), PROJECT_MEMBER_ROLE_LABEL (+28 more)
...
Cohesion: 0.07
Nodes (40): IssueDialog(), IssueDialogProps, STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, BulkActionsBar(), BulkActionsBarProps, mapTestRunAssignmentRow() (+32 more)
...
Cohesion: 0.07
Nodes (37): mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapDashboardReportRunRow(), mapIssueRow(), mapModuleRow(), mapProfileRow(), mapProjectMemberRow() (+29 more)
...
Cohesion: 0.12
Nodes (17): 2026-07-31 — MCP-08 write test case/test plan tools, 2026-07-31 — MCP-09 gate manusia approval Test Plan, 2026-07-31 — MCP-11 workflow Issue, 2026-07-31 — MCP-12 tool Automation, 2026-07-31 — MCP-13 selective rerun failed, 2026-07-31 — MCP-15 tool analisis, 2026-07-31 — MCP-16 rate limit dan audit tool MCP, 2026-08-01 — Eksekusi seluruh migration melalui MCP Supabase (+9 more)
...
Cohesion: 0.12
Nodes (29): AdminRoute(), ProtectedRoute(), ImportCasesDialog(), formatDate(), formatDateTime(), queryKeys, useAuthContext(), useBackupRetention() (+21 more)
...
Cohesion: 0.12
Nodes (17): supabase, mapEnvironmentRow(), mapTestResultRow(), mapTestResultStepRow(), DashboardReportResultRow, environmentRepository, moduleRepository, fetchAllRows() (+9 more)

### Community 199 - "useComments.ts"
Cohesion: 0.52
Nodes (4): commentRepository, commentService, Comment, CommentTargetType

## Knowledge Gaps
- **859 isolated node(s):** `2026-07-31 — MCP-14 tool konteks repository`, `2026-07-31 — MCP-10 tool workflow Test Run`, `2026-07-31 — REPO-08 traceability repository pada Test Run`, `2026-07-31 — REPO-07 mode `local_path` pada runner`, `2026-07-31 — REPO-04 tab Repository di Project Settings` (+854 more)
...
- **Why does `query()` connect `ProjectDataManagementPage.tsx` to `graphify reference: extra exports and benchmark`, `TestManager (shiftech-test-mgr)`, `Community 4`?**
