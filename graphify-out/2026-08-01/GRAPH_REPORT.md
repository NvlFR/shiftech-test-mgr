...
## Corpus Check
- 405 files · ~248,075 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2548 nodes · 5259 edges · 227 communities (180 shown, 47 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 45 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d2fd1e80`
...
9. `2026-07-31 — MCP-08 write test case/test plan tools` - 25 edges
...
Cohesion: 0.18
Nodes (20): boolEnv(), intEnv(), InteractiveRunnerConfig, loadConfig(), loadDotEnv(), loadInteractiveConfig(), nonNegativeIntEnv(), parseCliInput() (+12 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (38): xlsx, Props, ImportCasesDialog(), ImportCasesDialogProps, downloadTestCaseImportTemplate(), exportTestCasesToExcel(), exportTestCasesToPdf(), TEST_CASE_PRIORITY_LABEL (+30 more)
...
Cohesion: 0.16
Nodes (17): byteLength(), ErrorDetail, ErrorEnvelope, errorResponse(), paginatedResponse(), PaginationInput, PaginationMeta, SuccessEnvelope (+9 more)
...
Cohesion: 0.09
Nodes (33): TestSuiteDialog(), TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, ProfileViewProps, CharacterCount(), CharacterCountProps, dataTablePaginatorProps (+25 more)
...
Cohesion: 0.12
Nodes (19): IssueDialog(), IssueDialogProps, TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY, TEST_RUN_STATUS_SEVERITY, calculateTestRunSummary(), useTestRunDetail(), EMPTY_FILTERS (+11 more)

### Community 17 - "What You Must Do When Invoked"
Cohesion: 0.10
Nodes (24): ProfileView(), describeSystemEvent(), EVENT_TYPE_LABEL, STATUS_LABEL_BY_ENTITY, statusLabel(), ISSUE_STATUS_LABEL, ISSUE_STATUS_SEVERITY, PROJECT_MEMBER_ROLE_SEVERITY (+16 more)

### Community 18 - "3. Konsep Test Management"
Cohesion: 0.17
Nodes (10): loadConfig(), parseBoundedInteger(), parseReadonly(), parseRerunFailedMaxTests(), requiredEnv(), baseEnv, AnalysisRepositoryError, config (+2 more)
...
Cohesion: 0.10
Nodes (25): mapCicdPipelineRow(), useAutomation(), useAutomationJobLogs(), useCicdPipelines(), useTestPlans(), AutomationPage(), jobSeverity, runnerOnline() (+17 more)

### Community 22 - "Architecture"
Cohesion: 0.12
Nodes (17): normalizePageSize(), TestResultListQuery, TestRunListQuery, ProjectSession, decodeCursor(), decodeResultCursor(), encodeCodeCursor, encodeRequirementCursor() (+9 more)
...
Cohesion: 0.21
Nodes (9): JobRepository, RunnerConfig, execFileAsync, GitCommand, gitEnvironment(), InspectRepository, prepareJobRepository(), resolveSubdirectory() (+1 more)
...
Cohesion: 0.12
Nodes (19): mapProjectRepositoryRow(), useProjectRepositories(), projectMemberRepository, CreateProjectRepositoryInput, projectRepositoryLinkRepository, UpdateProjectRepositoryInput, CredentialAction, repositoryConnectionRepository (+11 more)
...
Cohesion: 0.08
Nodes (36): CustomTestRunDialog(), CustomTestRunDialogProps, STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, ActivityPanel(), TABLE_LABELS, Breadcrumb() (+28 more)
...
Cohesion: 0.11
Nodes (26): mapActivityEventRow(), mapAutomationJobLogRow(), mapAutomationJobRow(), mapAutomationRunnerRow(), mapAutomationScriptRow(), mapCommentMentionRow(), mapCommentRow(), mapProfileRow() (+18 more)
...
Cohesion: 0.07
Nodes (45): IssueEditor(), IssueEditorProps, IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, mapTestRoleRow(), ISSUE_PRIORITY_LABEL (+37 more)
...
Cohesion: 0.15
Nodes (9): ServerConfig, config, AuthenticatedToken, AuthenticationError, AuthRepository, TokenAuthenticationRow, AuthService, ProjectScopeError (+1 more)

### Community 149 - "smoke.spec.ts"
Cohesion: 0.24
Nodes (4): AutomationApi, JobLogStream, JobLogStreamer, Runner
...
Cohesion: 0.08
Nodes (25): 2026-07-31 — MCP-08 write test case/test plan tools, 2026-07-31 — MCP-09 gate manusia approval Test Plan, 2026-07-31 — MCP-11 workflow Issue, 2026-07-31 — MCP-12 tool Automation, 2026-07-31 — MCP-13 selective rerun failed, 2026-07-31 — MCP-15 tool analisis, 2026-07-31 — MCP-16 rate limit dan audit tool MCP, 2026-08-01 — Eksekusi seluruh migration melalui MCP Supabase (+17 more)

### Community 165 - "useAuthContext"
Cohesion: 0.23
Nodes (11): BaseUrlSanityCheckResult, checkBaseUrlReachable(), connectionDetail(), FetchLike, executeJob(), ExecutionMode, ExecutionOutcome, ExecutionTarget (+3 more)
...
Cohesion: 0.24
Nodes (18): formatDate(), useIssuesByTestRun(), useProjectRole(), useScreenSize(), ProjectDetailPage(), ProjectSettingsPage(), ProjectsPage(), TestCaseDetailPage() (+10 more)
...
### Community 182 - "useStoredState.ts"
Cohesion: 0.43
...
Cohesion: 0.22
Nodes (4): execFileAsync, RepoRepository, RepoService, createRepoToolRegistrar()
...
Cohesion: 0.10
Nodes (21): CodeCursorQuery, IssueSearchQuery, RequirementListQuery, TestCaseSearchQuery, ArtifactUrl, IssuePriority, IssueStatus, RequirementLink (+13 more)
...
### Community 199 - "primeicons"
Cohesion: 0.16
Nodes (12): ApiError, AutomationJob, EnvironmentMetadata, JobResult, ReportPayload, collectEnvironmentMetadata(), DEFAULT_VIEWPORT, parseViewport() (+4 more)
...
### Community 206 - "TestResultDetailPage.tsx"
Cohesion: 0.21
...
### Community 208 - "AppMenu.tsx"
Cohesion: 0.39
Nodes (6): AppMenu(), AppMenuitem(), AppMenuSeparator(), MenuItemModel, readStoredPins(), useProjectPins()

### Community 209 - "useEnvironments.ts"
Cohesion: 0.16
Nodes (9): supabase, mapEnvironmentRow(), mapTestCaseStepRow(), environmentRepository, moduleRepository, profileRepository, tagRepository, testCaseStepRepository (+1 more)
...
### Community 211 - "NotificationPanel.tsx"
Cohesion: 0.23
...
### Community 212 - "useProfile.ts"
Cohesion: 0.26
Nodes (6): UserHoverCard(), UserHoverCardProps, queryKeys, useProfile(), activityRepository, activityService

### Community 220 - "repoRepository.ts"
Cohesion: 0.15
Nodes (11): ProjectRepositoryConfig, RepoRepositoryError, RepositoryConfigRow, RepositorySourceType, config, RepoDiff, fixture(), run (+3 more)

### Community 221 - "ProjectSettingsPage.tsx"
Cohesion: 0.22
Nodes (10): PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_SEVERITY, MEMBER_ROLE_OPTIONS, REPOSITORY_SOURCE_LABEL, REPOSITORY_SOURCE_OPTIONS, VISIBILITY_OPTIONS, environmentService, projectMemberService (+2 more)

### Community 222 - "ProjectDataManagementPage.tsx"
Cohesion: 0.27
...
- **Why does `query()` connect `ProjectDataManagementPage.tsx` to `Community 1`, `graphify reference: extra exports and benchmark`, `Community 4`?**
