...
## Corpus Check
- 441 files · ~274,230 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2762 nodes · 5628 edges · 236 communities (192 shown, 44 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 48 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d50b87a0`
...
Cohesion: 0.21
Nodes (16): boolEnv(), intEnv(), loadConfig(), loadDotEnv(), loadInteractiveConfig(), nonNegativeIntEnv(), parseCliInput(), parseCliOptions() (+8 more)
...
Cohesion: 0.11
Nodes (30): IssueDialog(), IssueDialogProps, TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY, TEST_RUN_STATUS_LABEL, TEST_RUN_STATUS_SEVERITY, useIntegrations(), useIssuesByTestRun() (+22 more)

### Community 7 - "Community 7"
Cohesion: 0.10
Nodes (28): ProfileViewProps, ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY, ISSUE_STATUS_LABEL, ISSUE_STATUS_SEVERITY, ISSUE_TYPE_LABEL, ISSUE_TYPE_SEVERITY, PROJECT_MEMBER_ROLE_SEVERITY (+20 more)

### Community 8 - "Community 8"
Cohesion: 0.12
Nodes (20): byteLength(), ErrorDetail, ErrorEnvelope, errorResponse(), PaginationInput, PaginationMeta, SuccessEnvelope, successResponse() (+12 more)

### Community 9 - "Community 9"
Cohesion: 0.14
Nodes (9): AutomationEnqueueInput, AutomationRepository, AutomationRepositoryError, AutomationRerunFailedInput, config, AutomationService, invalid(), isConfirmationRequired() (+1 more)
...
Cohesion: 0.13
Nodes (23): ImportCasesDialogProps, PageHeader(), PageHeaderProps, mapProjectRow(), useDashboardReport(), useProfiles(), ProjectContext, ProjectContextValue (+15 more)
...
Cohesion: 0.23
Nodes (9): IssueEditorProps, projectMemberRepository, testRoleRepository, projectMemberService, testRoleService, ProjectMember, ProjectMemberRole, ProjectMemberWithProfile (+1 more)
...
Cohesion: 0.08
Nodes (25): loadConfig(), parseBoundedInteger(), parseReadonly(), parseRerunFailedMaxTests(), requiredEnv(), ServerConfig, baseEnv, readJsonBody() (+17 more)
...
Cohesion: 0.08
Nodes (35): mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapEnvironmentRow(), mapIssueRow(), mapModuleRow(), mapProfileRow(), mapProjectMemberRow() (+27 more)
...
Cohesion: 0.08
Nodes (43): AiTestCaseGeneratorDialog(), maxCaseOptions, priorityOptions, Props, downloadTestCaseImportTemplate(), exportTestCasesToExcel(), exportTestCasesToPdf(), TEST_CASE_PRIORITY_LABEL (+35 more)
...
Cohesion: 0.13
Nodes (19): normalizePageSize(), paginatedResponse(), RequirementListQuery, TestCaseSearchQuery, TestResultListQuery, TestRunListQuery, decodeCursor(), decodeResultCursor() (+11 more)
...
Cohesion: 0.08
Nodes (31): mapAutomationJobLogRow(), mapAutomationJobRow(), mapAutomationRunnerRow(), mapAutomationScriptRow(), automationRepository, testResultStepRepository, automationService, testResultStepService (+23 more)
...
Cohesion: 0.13
Nodes (11): McpToolError, AnalysisRepository, AnalysisRepositoryError, AnalysisService, annotations, createAnalysisToolRegistrar(), limit, lookbackRuns (+3 more)
...
Cohesion: 0.11
Nodes (23): mapDashboardReportRunRow(), DashboardReportIssueRow, dashboardReportRepository, DashboardReportResultRow, countRows(), countStatuses(), dashboardRepository, fetchAllRows() (+15 more)
...
Cohesion: 0.12
Nodes (21): AppLayout(), AppLayoutInner(), AppMenu(), AppMenuitem(), AppMenuSeparator(), MenuItemModel, AppSidebar(), AppSidebarMask() (+13 more)
...
Cohesion: 0.19
Nodes (16): parseAssistantResult(), AiGatewayRequest, aiRepository, aiAssistantService, AiActorContext, AiAssistantEntityType, AiAssistantMatch, AiAssistantSearchRequest (+8 more)
...
Cohesion: 0.16
Nodes (13): IssueEditor(), IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, testResultRepository, { create, findExecutionContext }, VALID_PRIORITIES (+5 more)
...
Cohesion: 0.16
Nodes (18): JobResult, ReportArtifact, classifyArtifact(), collectArtifacts(), CollectedArtifact, hasCompleteFailureBundle(), REQUIRED_FAILURE_ARTIFACT_TYPES, walk() (+10 more)
...
Cohesion: 0.08
Nodes (30): App(), AdminRoute(), ProtectedRoute(), auth, ImportCasesDialog(), AppTopbar(), useBreadcrumbContext(), ProfileView() (+22 more)
...
Cohesion: 0.12
Nodes (16): iconForKind(), NOTIFICATION_KIND_ICON, NotificationPanel(), NotificationPanelProps, supabase, mapNotificationRow(), commentRepository, moduleRepository (+8 more)
...
Cohesion: 0.13
Nodes (11): execFileAsync, ProjectRepositoryConfig, RepoRepository, RepoRepositoryError, RepositoryConfigRow, RepositorySourceType, RepoDiff, RepoService (+3 more)
...
Cohesion: 0.26
Nodes (8): ApiError, RunnerConfig, emit(), Level, log, MIME, SignResponse, uploadArtifacts()
...
Cohesion: 0.15
Nodes (19): TestSuiteDialog(), dataTablePaginatorProps, dataTablePaginatorTemplate, FilterToolbar(), FilterToolbarProps, RowActionsMenu(), RowActionsMenuProps, SearchInput() (+11 more)

### Community 200 - "csvImport.ts"
Cohesion: 0.21
...
### Community 209 - "cicdRepository.ts"
Cohesion: 0.17
...
### Community 214 - "testResultRepository.ts"
Cohesion: 0.21
Nodes (9): useTestResultDetail(), displayText(), EvidenceViewer(), TAB_TYPES, TestResultDetailPage(), testResultService, TEXT_ARTIFACT_TYPES, ScreenshotComparison (+1 more)

### Community 215 - "useAiIssueWorkflow.ts"
Cohesion: 0.27
Nodes (8): ActivityPanel(), TABLE_LABELS, CommentsPanel(), formatDate(), formatDateTime(), useActivity(), useComments(), TestCaseDetailPage()

### Community 216 - "schema_074_e2e12_ai_issue_draft.sql"
Cohesion: 0.67
Nodes (3): guard_issue_draft_verification(), issues, trg_guard_issue_draft_verification

### Community 217 - "TestSuiteDialog.tsx"
Cohesion: 0.17
Nodes (12): AiAssistantPanel(), BulkActionsBar(), BulkActionsBarProps, useAiAssistant(), useAiTestCaseReview(), useDashboard(), useProjectContext(), downloadCsv() (+4 more)

### Community 220 - "testResultStepRepository.ts"
Cohesion: 0.22
...
### Community 227 - "codegen.ts"
Cohesion: 0.52
Nodes (6): codegenScriptRef(), createCodegenInvocation(), formatCodegenChecklist(), runCodegen(), selectTestCase(), waitForExit()

### Community 229 - "Breadcrumb.tsx"
Cohesion: 0.12
Nodes (16): 2026-08-01 — E2E-09 fallback eksekusi manual tanpa automation script, 2026-08-01 — E2E-10 draft Issue otomatis dari Test Result FAIL, 2026-08-01 — E2E-11 duplicate Issue menjadi komentar, 2026-08-01 — E2E-12 gate draft Issue hasil AI, 2026-08-01 — TEST-01 infrastruktur test frontend, 2026-08-01 — TEST-02 utilitas test bersama frontend, 2026-08-01 — TEST-03 invariant penyimpanan hasil dan summary Test Run, 2026-08-01 — TEST-04 invariant re-run dan completion manual Test Run (+8 more)

### Community 230 - "react-markdown"
Cohesion: 0.22
...
### Community 231 - "aiIssueService.ts"
Cohesion: 0.25
Nodes (6): buildDuplicateReason(), parseDuplicateCandidates(), toIssuePriority(), aiIssueService, assertActor(), assertAiProjectScope()

### Community 232 - "mappers.test.ts"
Cohesion: 0.40
Nodes (4): camelizeKey(), camelizeRow(), Mapper, timestamps

### Community 233 - "useAiIssueWorkflow.ts"
Cohesion: 0.43
Nodes (6): AiIssueDraftDialog(), priorities, Props, useAiIssueWorkflow(), DuplicateIssueCandidate, TestResultWithDetails

### Community 236 - "TestResultDetailPage.tsx"
Cohesion: 0.16
Nodes (15): PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_LABEL, PROJECT_STATUS_SEVERITY, useAutomation(), useAutomationJobLogs(), useEnvironments(), useTestPlans(), AutomationPage() (+7 more)

### Community 238 - "useRealtimeSync.ts"
Cohesion: 0.08
Nodes (26): CustomTestRunDialog(), CustomTestRunDialogProps, STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, TEST_PLAN_STATUS_LABEL, TEST_PLAN_STATUS_SEVERITY, ImportedTestCaseRow (+18 more)

## Knowledge Gaps
- **995 isolated node(s):** `supabase`, `$schema`, `typescript`, `oxc`, `react/rules-of-hooks` (+990 more)
...
- **Why does `useAiTestCaseReview()` connect `TestSuiteDialog.tsx` to `Community 11`, `Coding Conventions`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
- **Why does `WriteService` connect `Community 11` to `What You Must Do When Invoked`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **Why does `react` connect `useTheme.tsx` to `Community 0`, `Community 6`, `Community 7`, `Community 10`, `config.ts`, `Community 12`, `Community 16`, `ARCHITECTURE — TestManager (shiftech-test-mgr)`, `Feature Backlog — TestManager`, `AttachmentPanel.tsx`, `TestCaseDetailPage.tsx`, `Coding Conventions`, `useEnvironments.ts`, `TestManager (shiftech-test-mgr)`, `schema_project_roles.sql`, `AppTopbar.tsx`, `package.json`, `graphify reference: transcribe video and audio`, `useNotifications.ts`, `csvImport.ts`, `AppTopbar.tsx`, `CLAUDE.md`, `cicdRepository.ts`, `testResultRepository.ts`, `useAiIssueWorkflow.ts`, `AppTopbar.tsx`, `TestSuiteDialog.tsx`, `csvImport.ts`, `useStoredState.ts`, `useAiIssueWorkflow.ts`, `TestResultDetailPage.tsx`, `useRealtimeSync.ts`?**
