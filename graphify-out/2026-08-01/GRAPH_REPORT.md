...
## Corpus Check
- 415 files · ~254,396 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2596 nodes · 5315 edges · 232 communities (183 shown, 49 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 45 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `decb199c`
...
4. `Worklog` - 39 edges
5. `supabase` - 35 edges
6. `2026-07-31 — MCP-08 write test case/test plan tools` - 32 edges
7. `ServerConfig` - 29 edges
8. `useProjectRole()` - 26 edges
...
Cohesion: 0.08
Nodes (41): AiIssueDraftDialog(), priorities, Props, aiIssueDraftSchema, assistantEntityTypeSchema, assistantMatchSchema, assistantResponseSchema, buildDuplicateReason() (+33 more)
...
Cohesion: 0.11
Nodes (25): TestSuiteDialog(), dataTablePaginatorProps, dataTablePaginatorTemplate, FilterToolbar(), FilterToolbarProps, RowActionsMenu(), RowActionsMenuProps, SearchInput() (+17 more)
...
Cohesion: 0.11
Nodes (31): AiAssistantPanel(), AdminRoute(), ProtectedRoute(), formatDate(), useAiAssistant(), useAuthContext(), useBackupRetention(), useCicdPipelines() (+23 more)

### Community 17 - "What You Must Do When Invoked"
Cohesion: 0.14
Nodes (18): byteLength(), ErrorDetail, ErrorEnvelope, errorResponse(), paginatedResponse(), PaginationInput, PaginationMeta, SuccessEnvelope (+10 more)

### Community 18 - "3. Konsep Test Management"
Cohesion: 0.14
Nodes (17): IssueDialog(), IssueDialogProps, PageHeader(), PageHeaderProps, ISSUE_PRIORITY_SEVERITY, useIssuesByTestRun(), useTestRunAnalysis(), useTestRunDetail() (+9 more)
...
Cohesion: 0.18
Nodes (12): useAutomation(), AutomationPage(), jobSeverity, runnerOnline(), automationRepository, automationService, AutomationBrowser, AutomationJob (+4 more)
...
Cohesion: 0.17
Nodes (17): Uuid, CredentialAction, CredentialRequest, CredentialResponse, maskCredential(), parseCredentialRequest(), projectCredentialResponse(), corsHeaders (+9 more)

### Community 24 - "testRunService.ts"
Cohesion: 0.09
Nodes (24): AnalysisOutputSchema, AnalysisRequest, AssistantOutputSchema, AssistantRequest, computeDuplicateConfidence(), DuplicateOutputSchema, DuplicateRequest, ErrorEnvelope (+16 more)
...
Cohesion: 0.26
Nodes (10): jspdf, exportTestRunsToExcel(), exportTestRunsToPdf(), fileName(), TestRunExportRow, useDashboard(), useProjectContext(), downloadCsv() (+2 more)

### Community 28 - "schema_entity_codes.sql"
Cohesion: 0.16
Nodes (13): ApiError, JobRepository, RunnerConfig, GitCommand, inspectLocalRepository(), LocalRepositoryMetadata, execFileAsync, GitCommand (+5 more)
...
Cohesion: 0.15
Nodes (25): canonicalAction, GatewayErrorCode, requestInput(), RequestSchema, analysisResponse(), completeWithRetry(), env, errorResponse() (+17 more)

### Community 37 - "Coding Conventions"
Cohesion: 0.17
Nodes (7): McpToolError, AnalysisService, ProjectSession, annotations, createAnalysisToolRegistrar(), limit, lookbackRuns
...
Cohesion: 0.18
Nodes (17): ImportCasesDialog(), ImportCasesDialogProps, mapProjectRow(), ProjectContext, ProjectContextValue, STATUS_OPTIONS, ProjectOwnerFilter, ProjectPaginatedQuery (+9 more)
...
Cohesion: 0.09
Nodes (31): AppLayout(), AppLayoutInner(), AppMenu(), AppMenuitem(), AppMenuSeparator(), MenuItemModel, AppSidebar(), AppSidebarMask() (+23 more)
...
Cohesion: 0.12
Nodes (19): IssueEditor(), IssueEditorProps, IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, mapTestRoleRow(), DashboardReportIssueRow (+11 more)
...
Cohesion: 0.07
Nodes (42): App(), ProfileView(), ProfileViewProps, ActivityPanel(), TABLE_LABELS, Breadcrumb(), BreadcrumbItem, BreadcrumbProps (+34 more)
...
Cohesion: 0.11
Nodes (22): mapCicdPipelineRow(), mapTestResultStepRow(), cicdRepository, testResultStepRepository, cicdService, testResultStepService, ActivityAction, AutomationJobLogStream (+14 more)
...
Cohesion: 0.15
Nodes (18): exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName(), PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_SEVERITY, useDashboardReport(), useEnvironments(), useProfiles() (+10 more)
...
Cohesion: 0.21
Nodes (11): mapTestPlanRow(), mapTestRunAssignmentRow(), mapTestRunRow(), EMPTY_FILTERS, TestRunWithSummary, testPlanRepository, TestRunFilters, testRunRepository (+3 more)
...
Cohesion: 0.12
Nodes (15): loadConfig(), parseBoundedInteger(), parseReadonly(), parseRerunFailedMaxTests(), requiredEnv(), ServerConfig, baseEnv, config (+7 more)
...
Cohesion: 0.06
Nodes (32): 2026-07-31 — MCP-08 write test case/test plan tools, 2026-07-31 — MCP-09 gate manusia approval Test Plan, 2026-07-31 — MCP-11 workflow Issue, 2026-07-31 — MCP-12 tool Automation, 2026-07-31 — MCP-13 selective rerun failed, 2026-07-31 — MCP-15 tool analisis, 2026-07-31 — MCP-16 rate limit dan audit tool MCP, 2026-08-01 — Eksekusi seluruh migration melalui MCP Supabase (+24 more)

### Community 165 - "useAuthContext"
Cohesion: 0.16
Nodes (16): AutomationJob, CodegenTestCaseStep, EnvironmentMetadata, JobResult, ReportPayload, collectEnvironmentMetadata(), DEFAULT_VIEWPORT, parseViewport() (+8 more)
...
Cohesion: 0.06
Nodes (61): xlsx, Props, CustomTestRunDialog(), CustomTestRunDialogProps, STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, BulkActionsBar() (+53 more)
...
Cohesion: 0.08
Nodes (22): supabase, mapEnvironmentRow(), mapTestCaseStepRow(), activityRepository, commentRepository, environmentRepository, moduleRepository, CredentialAction (+14 more)
...
Cohesion: 0.24
Nodes (9): CodegenTestCase, emit(), Level, log, discoverPlaywrightScripts(), IGNORED_DIRECTORIES, runScriptSync(), selectTestCase() (+1 more)

### Community 193 - "registry.ts"
Cohesion: 0.13
Nodes (15): BeginToolCallResult, BeginToolCallRow, GovernanceRepository, GovernanceRepositoryError, config, createMcpServer(), GovernanceService, ToolRateLimitError (+7 more)
...
Cohesion: 0.24
Nodes (10): ReportArtifact, classifyArtifact(), collectArtifacts(), CollectedArtifact, hasCompleteFailureBundle(), REQUIRED_FAILURE_ARTIFACT_TYPES, walk(), MIME (+2 more)
...
Cohesion: 0.13
Nodes (16): normalizePageSize(), TestResultListQuery, decodeCursor(), decodeResultCursor(), encodeCodeCursor, encodeRequirementCursor(), encodeTestCaseCursor(), encodeTestResultCursor() (+8 more)

### Community 209 - "testSuiteRepository.ts"
Cohesion: 0.18
...
### Community 211 - "useTheme.tsx"
Cohesion: 0.23
Nodes (11): MODE_ICON, ThemeToggle(), applyTheme(), getSystemPrefersDark(), resolve(), THEME_HREF, ThemeContext, ThemeContextValue (+3 more)

### Community 212 - "TestResultDetailPage.tsx"
Cohesion: 0.28
Nodes (6): TEST_RESULT_STATUS_LABEL, useTestResultDetail(), displayText(), EvidenceViewer(), TAB_TYPES, TestResultDetailPage()
...
Cohesion: 0.33
Nodes (6): testResultRepository, testResultService, TEXT_ARTIFACT_TYPES, AutomationArtifact, ScreenshotComparison, ViewableAutomationArtifact
...
Cohesion: 0.29
Nodes (6): describeSystemEvent(), EVENT_TYPE_LABEL, STATUS_LABEL_BY_ENTITY, statusLabel(), ISSUE_STATUS_LABEL, PROJECT_STATUS_LABEL

### Community 224 - "dashboardRepository.ts"
Cohesion: 0.39
Nodes (5): countRows(), countStatuses(), dashboardRepository, dashboardService, DashboardStats

### Community 226 - "httpTransport.ts"
Cohesion: 0.43
...
### Community 228 - "activityRoutes.ts"
Cohesion: 0.33
Nodes (4): DescribableActivityEntry, ACTIVITY_ENTITY_LABEL, ACTIVITY_ENTITY_ROUTE, ActivityEntityType

### Community 230 - "baseUrlSanityCheck.ts"
Cohesion: 0.50
Nodes (4): BaseUrlSanityCheckResult, checkBaseUrlReachable(), connectionDetail(), FetchLike

## Knowledge Gaps
- **910 isolated node(s):** `1. Fitur yang sudah selesai`, `Requirement Traceability`, `Environment Management`, `Test Run Enhancement`, `Test Case Productivity` (+905 more)
...
- **Why does `query()` connect `Community 16` to `ProjectDataManagementPage.tsx`, `3. Konsep Test Management`, `graphify reference: extra exports and benchmark`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `Uuid` connect `AttachmentPanel.tsx` to `testRunService.ts`, `Community 9`, `Community 11`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `react` connect `Community 8` to `Community 0`, `Community 1`, `Community 7`, `csvImport.ts`, `Community 10`, `Community 12`, `Community 16`, `3. Konsep Test Management`, `ARCHITECTURE — TestManager (shiftech-test-mgr)`, `Feature Backlog — TestManager`, `TestCaseDetailPage.tsx`, `statusLabels.ts`, `schema_auth.sql`, `ProjectDataManagementPage.tsx`, `TestManager (shiftech-test-mgr)`, `schema_project_roles.sql`, `testSuiteRepository.ts`, `useProjectBreadcrumbItems.ts`, `graphify reference: transcribe video and audio`, `graphify reference: GitHub clone and cross-repo merge`, `csvImport.ts`, `react-dom`, `useTheme.tsx`, `TestResultDetailPage.tsx`, `testResultService.ts`, `AppTopbar.tsx`, `dashboardRepository.ts`, `csvImport.ts`, `smoke.spec.ts`?**
