...
## Corpus Check
- 396 files · ~239,343 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2474 nodes · 5142 edges · 204 communities (162 shown, 42 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 45 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `937932e5`
...
Cohesion: 0.05
Nodes (63): ApiError, AutomationApi, AutomationJob, EnvironmentMetadata, JobRepository, JobResult, ReportArtifact, ReportPayload (+55 more)

### Community 4 - "Community 4"
Cohesion: 0.12
Nodes (21): Props, PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_SEVERITY, MEMBER_ROLE_OPTIONS, REPOSITORY_SOURCE_LABEL, REPOSITORY_SOURCE_OPTIONS, VISIBILITY_OPTIONS, PRIORITY_OPTIONS (+13 more)
...
Cohesion: 0.12
Nodes (8): normalizePageSize(), paginatedResponse(), ReadRepository, decodeCursor(), ReadService, createReadToolRegistrar(), ArtifactUrl, Project

### Community 7 - "Community 7"
Cohesion: 0.10
Nodes (23): PageHeader(), PageHeaderProps, ISSUE_PRIORITY_SEVERITY, exportTestRunsToExcel(), exportTestRunsToPdf(), fileName(), TestRunExportRow, useDashboard() (+15 more)

### Community 8 - "Community 8"
Cohesion: 0.08
Nodes (33): TestSuiteDialog(), TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, dataTablePaginatorProps, dataTablePaginatorTemplate, FilterToolbar(), FilterToolbarProps (+25 more)
...
Cohesion: 0.11
Nodes (26): IssueDialog(), IssueDialogProps, TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY, TEST_RUN_STATUS_SEVERITY, useEnvironments(), useTestPlanDetail(), useTestRunAnalysis() (+18 more)
...
Cohesion: 0.09
Nodes (29): exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName(), mapDashboardReportRunRow(), useDashboardReport(), ALL, DashboardReportPage(), DashboardReportIssueRow (+21 more)
...
Cohesion: 0.14
Nodes (16): byteLength(), ErrorDetail, ErrorEnvelope, errorResponse(), PaginationInput, PaginationMeta, SuccessEnvelope, successResponse() (+8 more)
...
Cohesion: 0.10
Nodes (28): ActivityPanel(), TABLE_LABELS, BreadcrumbItem, CommentsPanel(), UserHoverCard(), UserHoverCardProps, formatDateTime(), ISSUE_PRIORITY_LABEL (+20 more)
...
Cohesion: 0.33
Nodes (4): testSuiteRepository, ItemInput, TestSuiteItem, TestSuiteItemWithSteps
...
Cohesion: 0.07
Nodes (32): xlsx, CustomTestRunDialog(), CustomTestRunDialogProps, STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, BulkActionsBar(), BulkActionsBarProps (+24 more)
...
Cohesion: 0.24
Nodes (11): AppTopbar(), useBreadcrumbContext(), ProfileView(), Breadcrumb(), BreadcrumbCollapsed(), BreadcrumbProps, BreadcrumbTrail(), truncateLabel() (+3 more)
...
Cohesion: 0.07
Nodes (43): supabase, mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapEnvironmentRow(), mapIssueRow(), mapModuleRow(), mapProfileRow() (+35 more)
...
Cohesion: 0.10
Nodes (20): ServerConfig, AuthenticatedToken, AuthenticationError, AuthRepository, TokenAuthenticationRow, TestResultListQuery, AuthService, ProjectScopeError (+12 more)
...
Cohesion: 0.13
Nodes (28): AdminRoute(), ProtectedRoute(), ImportCasesDialog(), formatDate(), useAuthContext(), useIssuesByTestRun(), useProjectRepositories(), useProjectRole() (+20 more)
...
Cohesion: 0.17
Nodes (13): IssueEditor(), IssueEditorProps, IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, ISSUE_TYPE_LABEL, testRoleRepository (+5 more)
...
Cohesion: 0.11
Nodes (15): execFileAsync, ProjectRepositoryConfig, RepoRepository, RepoRepositoryError, RepositoryConfigRow, RepositorySourceType, config, RepoDiff (+7 more)
...
## Knowledge Gaps
- **864 isolated node(s):** `supabase`, `$schema`, `typescript`, `oxc`, `react/rules-of-hooks` (+859 more)
...
- **Why does `query()` connect `ProjectDataManagementPage.tsx` to `Community 8`, `Community 1`, `graphify reference: extra exports and benchmark`?**
