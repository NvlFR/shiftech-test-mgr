...
## Corpus Check
- 390 files · ~236,571 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2441 nodes · 5077 edges · 195 communities (162 shown, 33 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 44 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a7ea3fd1`
...
Cohesion: 0.09
Nodes (38): AiTestCaseGeneratorDialog(), maxCaseOptions, priorityOptions, ReviewDraft, CustomTestRunDialog(), CustomTestRunDialogProps, AiTestCaseResponseSchema, AiTestCaseSchema (+30 more)
...
Cohesion: 0.06
Nodes (47): ApiError, AutomationApi, AutomationJob, JobRepository, JobResult, ReportArtifact, ReportPayload, classify() (+39 more)

### Community 4 - "Community 4"
Cohesion: 0.08
Nodes (35): Props, exportTestCasesToExcel(), exportTestCasesToPdf(), PROJECT_STATUS_SEVERITY, TEST_CASE_PRIORITY_LABEL, TEST_CASE_PRIORITY_SEVERITY, TEST_CASE_STATUS_LABEL, TEST_CASE_STATUS_SEVERITY (+27 more)
...
Cohesion: 0.09
Nodes (18): McpToolError, DuplicateIssueDraft, IssuePriority, IssueStatus, IssueWriteInput, config, TestCaseChanges, TestCaseWriteInput (+10 more)
...
Cohesion: 0.09
Nodes (28): IssueEditor(), describeSystemEvent(), EVENT_TYPE_LABEL, STATUS_LABEL_BY_ENTITY, statusLabel(), ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY, ISSUE_STATUS_LABEL (+20 more)

### Community 17 - "What You Must Do When Invoked"
Cohesion: 0.15
Nodes (11): AnalysisRepository, AnalysisRepositoryError, config, AnalysisService, annotations, createAnalysisToolRegistrar(), limit, lookbackRuns (+3 more)

### Community 18 - "3. Konsep Test Management"
Cohesion: 0.09
Nodes (30): IssueDialog(), IssueDialogProps, PageHeader(), PageHeaderProps, mapTestRunAssignmentRow(), mapTestRunRow(), TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY (+22 more)
...
Cohesion: 0.17
Nodes (14): mapDashboardReportRunRow(), dashboardReportRepository, DashboardReportResultRow, fetchAllRows(), RangeResult, ACTIVE_ISSUE_STATUSES, calculateIssueAging(), dashboardReportService (+6 more)
...
Cohesion: 0.11
Nodes (24): mapRequirementLinkRow(), mapRequirementRow(), mapTestResultStepRow(), useRequirements(), mapLink(), requirementRepository, testResultStepRepository, requirementService (+16 more)
...
Cohesion: 0.29
Nodes (8): BreadcrumbItem, AuthContext, AuthContextValue, useProfiles(), useProjectBreadcrumbItems(), ROLE_OPTIONS, profileService, Profile
...
Cohesion: 0.32
Nodes (7): xlsx, exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName(), downloadTestCaseImportTemplate(), DashboardReport, xlsx
...
Cohesion: 0.18
Nodes (17): ImportCasesDialog(), ImportCasesDialogProps, ProjectContext, ProjectContextValue, ProjectProvider(), STATUS_OPTIONS, ProjectOwnerFilter, ProjectPaginatedQuery (+9 more)
...
Cohesion: 0.10
Nodes (34): supabase, mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapEnvironmentRow(), mapIssueRow(), mapModuleRow(), mapProfileRow() (+26 more)
...
Cohesion: 0.04
Nodes (48): 2026-07-31 — E03-T06 audit filter priority dan status Test Case, 2026-07-31 — E06-T14 status rejected approval user, 2026-07-31 — FIX-00a duplikasi domain TestCase, 2026-07-31 — FIX-00b error TypeScript ProjectDetailPage, 2026-07-31 — Integrasi compile-safe dialogs, notifications, dan profile, 2026-07-31 — MCP-01 fondasi MCP server stdio, 2026-07-31 — MCP-02 autentikasi dan project scoping MCP, 2026-07-31 — MCP-03 helper response bersama (+40 more)
...
Cohesion: 0.16
Nodes (23): AdminRoute(), ProtectedRoute(), formatDate(), useAuthContext(), useBackupRetention(), useProjectRole(), useScreenSize(), LoginPage() (+15 more)

### Community 176 - "ProjectSettingsPage.tsx"
Cohesion: 0.14
Nodes (17): PROJECT_MEMBER_ROLE_LABEL, useDashboardReport(), useEnvironments(), useProjectRepositories(), useProjects(), ALL, DashboardReportPage(), MEMBER_ROLE_OPTIONS (+9 more)
...
Cohesion: 0.13
Nodes (19): IssueEditorProps, IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, mapTestRoleRow(), DashboardReportIssueRow, projectMemberRepository (+11 more)

### Community 183 - "useAuthContext"
Cohesion: 0.18
Nodes (14): AppTopbar(), BreadcrumbContext, BreadcrumbContextValue, BreadcrumbItem, useBreadcrumbContext(), ProfileView(), Breadcrumb(), BreadcrumbCollapsed() (+6 more)
...
### Community 200 - "activityRoutes.ts"
Cohesion: 0.33
Nodes (4): DescribableActivityEntry, ACTIVITY_ENTITY_LABEL, ACTIVITY_ENTITY_ROUTE, ActivityEntityType

## Knowledge Gaps
- **856 isolated node(s):** `supabase`, `$schema`, `typescript`, `oxc`, `react/rules-of-hooks` (+851 more)
...
- **Why does `query()` connect `ProjectDataManagementPage.tsx` to `ProjectSettingsPage.tsx`, `graphify reference: extra exports and benchmark`, `Community 4`, `Community 7`?**
