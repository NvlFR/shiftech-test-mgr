...
## Corpus Check
- 422 files · ~262,354 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2647 nodes · 5341 edges · 232 communities (181 shown, 51 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 45 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `eb5cd281`
...
9. `useProjectRole()` - 24 edges
10. `WriteService` - 24 edges
...
Cohesion: 0.09
Nodes (38): AiTestCaseGeneratorDialog(), maxCaseOptions, priorityOptions, ReviewDraft, AiTestCaseResponseSchema, AiTestCaseSchema, AiTestCaseValidationError, AiTestCaseValidationResult (+30 more)

### Community 1 - "Community 1"
Cohesion: 0.08
Nodes (42): AiIssueDraftDialog(), priorities, Props, aiIssueDraftSchema, assistantEntityTypeSchema, assistantMatchSchema, assistantResponseSchema, buildDuplicateReason() (+34 more)
...
Cohesion: 0.11
Nodes (33): CodeCursorQuery, IssueSearchQuery, RequirementListQuery, TestCaseSearchQuery, TestResultListQuery, TestRunListQuery, ArtifactUrl, IssueDetail (+25 more)

### Community 7 - "Community 7"
Cohesion: 0.12
Nodes (20): App(), AdminRoute(), ProtectedRoute(), ImportCasesDialog(), BreadcrumbItem, BreadcrumbProps, CommentsPanel(), AuthContext (+12 more)

### Community 8 - "Community 8"
Cohesion: 0.10
Nodes (26): mapCicdPipelineRow(), mapTestResultStepRow(), cicdRepository, commentRepository, testResultStepRepository, commentService, testResultStepService, ActivityAction (+18 more)
...
Cohesion: 0.05
Nodes (46): AppLayout(), AppLayoutInner(), AppSidebar(), AppSidebarMask(), AppTopbar(), BreadcrumbContext, BreadcrumbContextValue, BreadcrumbItem (+38 more)

### Community 17 - "What You Must Do When Invoked"
Cohesion: 0.12
Nodes (22): byteLength(), ErrorDetail, ErrorEnvelope, errorResponse(), PaginationInput, PaginationMeta, SuccessEnvelope, successResponse() (+14 more)
...
Cohesion: 0.21
Nodes (25): JsonRecord, mapAnalysisRunSummaryRow(), mapFlakyCandidateRow(), mapIssueDetailRow(), mapIssueSummaryRow(), mapProjectRow(), mapRequirementCoverageRow(), mapRequirementDetailRow() (+17 more)

### Community 21 - "Feature Backlog — TestManager"
Cohesion: 0.13
Nodes (22): mapAutomationJobLogRow(), mapAutomationJobRow(), mapAutomationRunnerRow(), mapAutomationScriptRow(), useAutomation(), useAutomationJobLogs(), useTestPlans(), AutomationPage() (+14 more)

### Community 22 - "Architecture"
Cohesion: 0.14
Nodes (15): normalizePageSize(), paginatedResponse(), decodeCursor(), decodeResultCursor(), encodeCodeCursor, encodeRequirementCursor(), encodeTestCaseCursor(), encodeTestResultCursor() (+7 more)

### Community 23 - "AttachmentPanel.tsx"
Cohesion: 0.14
Nodes (24): IssueDialog(), IssueDialogProps, TEST_RUN_STATUS_LABEL, TEST_RUN_STATUS_SEVERITY, useIssuesByTestRun(), useProjectRole(), useScreenSize(), useTestRunAnalysis() (+16 more)

### Community 24 - "testRunService.ts"
Cohesion: 0.10
Nodes (24): AnalysisOutputSchema, AnalysisRequest, AssistantOutputSchema, AssistantRequest, computeDuplicateConfidence(), csvCell(), DuplicateOutputSchema, DuplicateRequest (+16 more)
...
Cohesion: 0.06
Nodes (39): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, AttachmentPanel(), AttachmentPanelProps (+31 more)
...
Cohesion: 0.07
Nodes (33): xlsx, CustomTestRunDialog(), CustomTestRunDialogProps, ActivityPanel(), TABLE_LABELS, BulkActionsBar(), BulkActionsBarProps, formatDate() (+25 more)
...
Cohesion: 0.14
Nodes (22): ImportCasesDialogProps, PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_LABEL, PROJECT_STATUS_SEVERITY, ProjectContext, ProjectContextValue, MEMBER_ROLE_OPTIONS, REPOSITORY_SOURCE_LABEL (+14 more)

### Community 40 - "graphify reference: query, path, explain"
Cohesion: 0.24
Nodes (8): PageHeader(), PageHeaderProps, useCicdPipelines(), CicdIntegrationPage(), providerOptions, cicdService, CicdPipeline, react
...
Cohesion: 0.12
Nodes (20): TestSuiteDialog(), ProfileViewProps, dataTablePaginatorProps, dataTablePaginatorTemplate, FilterToolbar(), FilterToolbarProps, RowActionsMenu(), RowActionsMenuProps (+12 more)
...
Cohesion: 0.19
Nodes (15): AppMenu(), AppMenuitem(), AppMenuSeparator(), MenuItemModel, exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName(), useDashboardReport() (+7 more)
...
Cohesion: 0.13
Nodes (21): AiAssistantPanel(), Props, TEST_CASE_STATUS_LABEL, TEST_CASE_STATUS_SEVERITY, useAiAssistant(), useAiTestCaseReview(), AiTestCaseReviewPage(), priorities (+13 more)
...
Cohesion: 0.17
Nodes (15): mapDashboardReportRunRow(), DashboardReportIssueRow, dashboardReportRepository, DashboardReportResultRow, ACTIVE_ISSUE_STATUSES, calculateIssueAging(), dashboardReportService, percent() (+7 more)
...
Cohesion: 0.13
Nodes (21): IssueEditor(), IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY, ISSUE_STATUS_LABEL (+13 more)
...
Cohesion: 0.23
Nodes (11): jspdf, exportTestRunsToExcel(), exportTestRunsToPdf(), fileName(), TestRunExportRow, useDashboard(), useProjectContext(), downloadCsv() (+3 more)
...
### Community 138 - "testResultRepository.ts"
Cohesion: 0.17
Nodes (12): mapTestCaseRow(), mapTestResultRow(), mapTestResultScreenshotHistoryRow(), fetchAllRows(), RangeResult, testResultRepository, testResultService, TEXT_ARTIFACT_TYPES (+4 more)

### Community 139 - "config.ts"
Cohesion: 0.11
Nodes (18): loadConfig(), parseBoundedInteger(), parseReadonly(), parseRerunFailedMaxTests(), requiredEnv(), ServerConfig, baseEnv, config (+10 more)
...
### Community 169 - "useIssueEditorOptions.ts"
Cohesion: 0.21
...
Cohesion: 0.21
Nodes (10): mapTestRunAssignmentRow(), mapTestRunRow(), calculateTestRunSummary(), EMPTY_FILTERS, TestRunWithSummary, TestRunFilters, testRunRepository, TestResultStatus (+2 more)
...
Cohesion: 0.14
Nodes (15): mapTestPlanRow(), ProjectTestPlanTab(), ProjectTestPlanTabProps, STATUS_OPTIONS, PRIORITY_OPTIONS, TEST_PLAN_STATUS_OPTIONS, TEST_RUN_STATUS_OPTIONS, TestPlanDetailPage() (+7 more)
...
Cohesion: 0.08
Nodes (37): supabase, mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapIssueRow(), mapModuleRow(), mapProfileRow(), mapProjectMemberRow() (+29 more)

### Community 223 - "activityDescribe.ts"
Cohesion: 0.09
Nodes (24): ProfileView(), Breadcrumb(), ISSUE_STATUS_SEVERITY, PROJECT_MEMBER_ROLE_SEVERITY, PROJECT_MEMBER_STATUS_LABEL, PROJECT_MEMBER_STATUS_SEVERITY, PROJECT_VISIBILITY_LABEL, PROJECT_VISIBILITY_SEVERITY (+16 more)
...
## Knowledge Gaps
- **933 isolated node(s):** `2026-08-01 — Notifikasi Telegram codex-loop + konvensi DataTable`, `2026-08-01 — E2E-05 perbaikan gate verifikasi DataTable`, `2026-08-01 — E2E-05 review batch Test Case AI`, `2026-08-01 — 37 task baru masuk antrean Codex`, `2026-08-01 — Arsitektur & distribusi Local Agent (runner + MCP)` (+928 more)
...
- **Why does `Uuid` connect `useAuthContext` to `testRunService.ts`, `Community 9`, `Community 11`?**
  _High betweenness centrality (0.135) - this node is a cross-community bridge._
- **Why does `query()` connect `AttachmentPanel.tsx` to `csvImport.ts`, `graphify reference: extra exports and benchmark`, `Coding Conventions`?**
  _High betweenness centrality (0.129) - this node is a cross-community bridge._
- **Why does `react` connect `graphify reference: query, path, explain` to `Community 0`, `Community 1`, `Community 7`, `Community 8`, `testResultRepository.ts`, `Community 10`, `Community 12`, `Community 16`, `Feature Backlog — TestManager`, `AttachmentPanel.tsx`, `TestCaseDetailPage.tsx`, `Coding Conventions`, `schema_auth.sql`, `useIssueEditorOptions.ts`, `TestManager (shiftech-test-mgr)`, `schema_project_roles.sql`, `AppTopbar.tsx`, `testSuiteRepository.ts`, `useProjectBreadcrumbItems.ts`, `issueAttachmentRepository.ts`, `graphify reference: transcribe video and audio`, `useNotifications.ts`, `executor.ts`, `useTheme.tsx`, `csvImport.ts`, `AppTopbar.tsx`, `useEnvironments.ts`, `AppTopbar.tsx`, `useStoredState.ts`, `activityDescribe.ts`, `csvImport.ts`, `AppMenu.tsx`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **What connects `2026-08-01 — Notifikasi Telegram codex-loop + konvensi DataTable`, `2026-08-01 — E2E-05 perbaikan gate verifikasi DataTable`, `2026-08-01 — E2E-05 review batch Test Case AI` to the rest of the system?**
