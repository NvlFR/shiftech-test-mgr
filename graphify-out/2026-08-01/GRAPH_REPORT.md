...
## Summary
- 2553 nodes · 5252 edges · 215 communities (170 shown, 45 thin omitted)
...
7. `2026-07-31 — MCP-08 write test case/test plan tools` - 26 edges
...
Cohesion: 0.07
Nodes (49): AiIssueDraftDialog(), priorities, Props, IssueEditor(), IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS (+41 more)
...
Cohesion: 0.08
Nodes (32): xlsx, CustomTestRunDialog(), CustomTestRunDialogProps, ImportCasesDialog(), ImportCasesDialogProps, downloadTestCaseImportTemplate(), exportTestCasesToExcel(), exportTestCasesToPdf() (+24 more)
...
Cohesion: 0.11
Nodes (29): AiAssistantPanel(), TestSuiteDialog(), dataTablePaginatorProps, dataTablePaginatorTemplate, FilterToolbar(), FilterToolbarProps, PageHeader(), PageHeaderProps (+21 more)
...
Cohesion: 0.08
Nodes (40): AdminRoute(), ProtectedRoute(), IssueDialog(), IssueDialogProps, formatDate(), useAuthContext(), useIssuesByTestRun(), useProjectRole() (+32 more)

### Community 17 - "What You Must Do When Invoked"
Cohesion: 0.07
Nodes (36): ProfileViewProps, describeSystemEvent(), EVENT_TYPE_LABEL, STATUS_LABEL_BY_ENTITY, statusLabel(), ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY, ISSUE_STATUS_LABEL (+28 more)
...
Cohesion: 0.19
Nodes (14): mapDashboardReportRunRow(), dashboardReportRepository, DashboardReportResultRow, ACTIVE_ISSUE_STATUSES, calculateIssueAging(), dashboardReportService, percent(), RESULT_STATUSES (+6 more)

### Community 21 - "Feature Backlog — TestManager"
Cohesion: 0.16
Nodes (15): useAutomation(), AutomationPage(), jobSeverity, runnerOnline(), automationRepository, automationService, AutomationBrowser, AutomationEnqueueResponse (+7 more)
...
Cohesion: 0.14
Nodes (16): App(), ProfileView(), Breadcrumb(), BreadcrumbItem, BreadcrumbProps, CommentsPanel(), AuthContext, AuthContextValue (+8 more)
...
Cohesion: 0.16
Nodes (19): exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName(), mapProjectRow(), useDashboardReport(), useProfiles(), useProjects(), ALL (+11 more)
...
Cohesion: 0.10
Nodes (27): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, ActivityPanel(), TABLE_LABELS, BulkActionsBar(), BulkActionsBarProps, formatDateTime() (+19 more)
...
Cohesion: 0.09
Nodes (22): mapTestPlanRow(), mapTestResultRow(), mapTestResultScreenshotHistoryRow(), mapTestRunAssignmentRow(), mapTestRunRow(), calculateTestRunSummary(), EMPTY_FILTERS, fetchAllRows() (+14 more)
...
Cohesion: 0.15
Nodes (16): Props, useEnvironments(), useProjectRepositories(), MEMBER_ROLE_OPTIONS, ProjectSettingsPage(), REPOSITORY_SOURCE_LABEL, REPOSITORY_SOURCE_OPTIONS, VISIBILITY_OPTIONS (+8 more)
...
- **Why does `query()` connect `Community 16` to `Community 8`, `ProjectDataManagementPage.tsx`, `graphify reference: extra exports and benchmark`, `Community 4`?**
  _High betweenness centrality (0.161) - this node is a cross-community bridge._
- **Why does `Uuid` connect `AttachmentPanel.tsx` to `testRunService.ts`, `Community 9`, `Community 11`?**
  _High betweenness centrality (0.159) - this node is a cross-community bridge._
- **Why does `WriteService` connect `Community 11` to `registry.ts`, `Community 6`?**
