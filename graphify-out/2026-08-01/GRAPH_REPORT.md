...
## Summary
- 2512 nodes · 5193 edges · 201 communities (164 shown, 37 thin omitted)
...
Cohesion: 0.07
Nodes (44): AiTestCaseGeneratorDialog(), maxCaseOptions, priorityOptions, Props, CustomTestRunDialog(), CustomTestRunDialogProps, ImportCasesDialog(), ImportCasesDialogProps (+36 more)
...
Cohesion: 0.07
Nodes (44): IssueEditor(), IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, ProfileViewProps, describeSystemEvent(), EVENT_TYPE_LABEL (+36 more)
...
Cohesion: 0.20
Nodes (8): displayText(), EvidenceViewer(), TAB_TYPES, TestResultDetailPage(), testResultService, TEXT_ARTIFACT_TYPES, AutomationArtifact, ViewableAutomationArtifact
...
Cohesion: 0.13
Nodes (19): mapDashboardReportRunRow(), mapTestResultRow(), mapTestResultStepRow(), DashboardReportIssueRow, dashboardReportRepository, DashboardReportResultRow, fetchAllRows(), RangeResult (+11 more)
...
Cohesion: 0.13
Nodes (22): mapRequirementLinkRow(), mapRequirementRow(), mapLink(), requirementRepository, testResultStepRepository, testResultStepService, ActivityAction, CicdIngestResultInput (+14 more)
...
Cohesion: 0.18
Nodes (11): supabase, mapTestRunAssignmentRow(), mapTestRunRow(), commentRepository, moduleRepository, profileRepository, testRunRepository, commentService (+3 more)
...
Cohesion: 0.09
Nodes (24): AdminRoute(), ProtectedRoute(), ProfileView(), Breadcrumb(), BreadcrumbItem, BreadcrumbProps, CommentsPanel(), UserHoverCard() (+16 more)
...
Cohesion: 0.10
Nodes (32): AiAssistantPanel(), IssueDialog(), IssueDialogProps, TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY, TEST_RUN_STATUS_SEVERITY, useAiAssistant(), useDashboard() (+24 more)
...
## Knowledge Gaps
- **885 isolated node(s):** `1. Fitur yang sudah selesai`, `Requirement Traceability`, `Environment Management`, `Test Run Enhancement`, `Test Case Productivity` (+880 more)
