...
## Corpus Check
- 465 files · ~290,714 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2904 nodes · 5965 edges · 241 communities (190 shown, 51 thin omitted)
...
6. `supabase` - 38 edges
7. `useProjectRole()` - 32 edges
8. `2026-08-01 — E2E-09 fallback eksekusi manual tanpa automation script` - 32 edges
...
## Communities (241 total, 51 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (61): AiIssueDraftDialog(), priorities, Props, aiIssueDraftSchema, artifactSchema, assistantEntityTypeSchema, assistantMatchSchema, assistantResponseSchema (+53 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (25): AutomationEnqueueInput, AutomationRepository, AutomationRepositoryError, AutomationRerunFailedInput, AutomationVerifyRegressionInput, RegressionDiffContext, config, execFileAsync (+17 more)

### Community 2 - "Community 2"
Cohesion: 0.09
Nodes (19): DuplicateIssueDraft, IssuePriority, IssueStatus, IssueWriteInput, config, TestCaseChanges, TestCaseWriteInput, TestResultWriteStatus (+11 more)

### Community 3 - "Community 3"
Cohesion: 0.07
Nodes (33): loadConfig(), parseBoundedInteger(), parseReadonly(), parseRerunFailedMaxTests(), requiredEnv(), ServerConfig, baseEnv, readJsonBody() (+25 more)
...
Cohesion: 0.09
Nodes (36): Props, TEST_CASE_STATUS_SEVERITY, ImportedTestCaseRow, PRIORITY_OPTIONS, TestCaseDetail, testCaseRepository, moduleService, tagService (+28 more)
...
Cohesion: 0.36
Nodes (7): exportTestRunsToExcel(), exportTestRunsToPdf(), fileName(), TestRunExportRow, useDashboard(), downloadCsv(), HomePage()
...
Cohesion: 0.11
Nodes (51): JsonRecord, mapAnalysisRunSummaryRow(), mapFlakyCandidateRow(), mapIssueDetailRow(), mapIssueSummaryRow(), mapProjectRow(), mapRequirementCoverageRow(), mapRequirementDetailRow() (+43 more)
...
Cohesion: 0.16
Nodes (5): ReadRepository, ArtifactUrl, IssueDetail, IssueSummary, Project

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (44): IssueDialog(), IssueDialogProps, STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, CharacterCount(), CharacterCountProps, TEST_PLAN_STATUS_LABEL (+36 more)
...
Cohesion: 0.07
Nodes (33): CustomTestRunDialog(), CustomTestRunDialogProps, BulkActionsBar(), BulkActionsBarProps, ParsedTestCaseRow, downloadTestCaseImportTemplate(), exportTestCasesToExcel(), exportTestCasesToPdf() (+25 more)

### Community 19 - "2026-07-22"
Cohesion: 0.12
Nodes (21): byteLength(), ErrorDetail, ErrorEnvelope, errorResponse(), paginatedResponse(), PaginationInput, PaginationMeta, SuccessEnvelope (+13 more)
...
Cohesion: 0.09
Nodes (26): ProfileView(), ProfileViewProps, describeSystemEvent(), EVENT_TYPE_LABEL, STATUS_LABEL_BY_ENTITY, statusLabel(), ISSUE_PRIORITY_SEVERITY, ISSUE_STATUS_SEVERITY (+18 more)
...
Cohesion: 0.05
Nodes (49): App(), AppLayout(), AppLayoutInner(), AppSidebar(), AppSidebarMask(), AppTopbar(), BreadcrumbContext, BreadcrumbContextValue (+41 more)
...
Cohesion: 0.14
Nodes (20): mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapProfileRow(), mapProjectMemberRow(), mapProjectMemberWithProfileRow(), mapProjectTeamRow(), mapTeamRow() (+12 more)

### Community 31 - "shiftech-test-mgr (TestManager) — OpenCode Project Rules"
Cohesion: 0.06
Nodes (32): 2026-08-01 — ADM-01 Scheduled Test Run, 2026-08-01 — ADM-02 pembatasan eksekusi dan secret management runner, 2026-08-01 — ADM-02 percobaan ulang gate verifikasi, 2026-08-01 — ADM-03 percobaan ulang gate verifikasi, 2026-08-01 — ADM-03 permission granular per project, 2026-08-01 — ADM-04 Team management, 2026-08-01 — ADM-04 Team management (perbaikan gate verifikasi), 2026-08-01 — E2E-09 fallback eksekusi manual tanpa automation script (+24 more)
...
Cohesion: 0.12
Nodes (17): mapProjectRepositoryRow(), projectMemberRepository, CreateProjectRepositoryInput, projectRepositoryLinkRepository, UpdateProjectRepositoryInput, CredentialAction, repositoryConnectionRepository, RepositoryConnectionResultRow (+9 more)

### Community 34 - "TestRunDetailPage.tsx"
Cohesion: 0.43
Nodes (7): mapIssueRow(), mapModuleRow(), mapTagRow(), IssueCodeContextRecord, mapIssueDetails(), mapTestCaseSummary(), ProjectRepository
...
Cohesion: 0.06
Nodes (34): devDependencies, jsdom, oxlint, @testing-library/react, @types/node, @types/react, @types/react-dom, typescript (+26 more)

### Community 41 - "graphify reference: query, path, explain"
Cohesion: 0.13
Nodes (20): mapAutomationJobLogRow(), mapAutomationJobRow(), mapAutomationRunnerRow(), mapAutomationScriptRow(), useAutomation(), useAutomationJobLogs(), AutomationPage(), jobSeverity (+12 more)

### Community 42 - "useTheme.tsx"
Cohesion: 0.13
Nodes (12): McpToolError, AnalysisRepository, AnalysisRepositoryError, config, AnalysisService, annotations, createAnalysisToolRegistrar(), limit (+4 more)
...
Cohesion: 0.09
Nodes (23): dependencies, @hookform/resolvers, jspdf-autotable, primeflex, primeicons, primereact, react, react-hook-form (+15 more)

### Community 48 - "react-hook-form"
Cohesion: 0.10
Nodes (34): AiAssistantPanel(), TestSuiteDialog(), TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, Breadcrumb(), BreadcrumbProps, dataTablePaginatorProps (+26 more)
...
Cohesion: 0.18
Nodes (15): ImportCasesDialogProps, mapProjectRow(), ProjectContext, ProjectContextValue, ProjectOwnerFilter, ProjectPaginatedQuery, ProjectQuery, projectRepository (+7 more)
...
Cohesion: 0.29
Nodes (7): mapTestPlanScheduleRow(), useTestPlanSchedule(), ScheduleInput, testPlanScheduleRepository, testPlanScheduleService, AutomationBrowser, TestPlanSchedule
...
Cohesion: 0.09
Nodes (30): IssueEditor(), IssueEditorProps, IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, ISSUE_PRIORITY_LABEL, ISSUE_STATUS_LABEL (+22 more)

### Community 64 - "TODO — Sprint Board Aktif"
Cohesion: 0.08
Nodes (42): AdminRoute(), ProtectedRoute(), auth, ImportCasesDialog(), ActivityPanel(), TABLE_LABELS, BreadcrumbItem, CommentsPanel() (+34 more)
...
Cohesion: 0.12
Nodes (14): supabase, mapEnvironmentRow(), mapTestCaseStepRow(), mapTestResultStepRow(), mapTestRoleRow(), environmentRepository, moduleRepository, tagRepository (+6 more)
...
Cohesion: 0.11
Nodes (24): PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_SEVERITY, useProfiles(), useProjectTeams(), useTeams(), MEMBER_ROLE_OPTIONS, PERMISSION_OPTIONS, REPOSITORY_SOURCE_LABEL (+16 more)
...
## Knowledge Gaps
- **1039 isolated node(s):** `supabase`, `$schema`, `typescript`, `oxc`, `react/rules-of-hooks` (+1034 more)
...
- **Why does `useAiTestCaseReview()` connect `3. Konsep Test Management` to `Community 2`, `Community 7`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **Why does `WriteService` connect `Community 2` to `Community 3`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `react` connect `react-hook-form` to `Community 0`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 12`, `schema_025_fix_pgcrypto_and_audit.sql`, `Community 14`, `Community 16`, `3. Konsep Test Management`, `testRunService.ts`, `statusLabels.ts`, `schema_p2_workflow.sql`, `graphify reference: query, path, explain`, `schema_project_lifecycle.sql`, `graphify reference: commit hook and native CLAUDE.md integration`, `graphify reference: incremental update and cluster-only`, `issueAttachmentRepository.ts`, `schema_016_p1_security_hardening.sql`, `issueService.ts`, `TODO — Sprint Board Aktif`, `schema_issue_attachments.sql`, `schema_017_p1_rpc_hardening.sql`, `schema_018_p2_dashboard_reporting.sql`, `activityDescribe.ts`, `domain.ts`?**
