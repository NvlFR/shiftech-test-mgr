...
## Corpus Check
- 396 files · ~239,353 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2474 nodes · 5114 edges · 209 communities (171 shown, 38 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 45 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d329db8a`
...
Cohesion: 0.11
Nodes (32): ReviewDraft, AiTestCaseResponseSchema, AiTestCaseSchema, AiTestCaseValidationError, AiTestCaseValidationResult, asList(), asSteps(), asText() (+24 more)
...
Cohesion: 0.16
Nodes (10): ApiError, AutomationJob, EnvironmentMetadata, ReportPayload, collectEnvironmentMetadata(), DEFAULT_VIEWPORT, parseViewport(), VersionCommand (+2 more)

### Community 4 - "Community 4"
Cohesion: 0.10
Nodes (32): AiTestCaseGeneratorDialog(), maxCaseOptions, priorityOptions, Props, Breadcrumb(), downloadTestCaseImportTemplate(), exportTestCasesToExcel(), exportTestCasesToPdf() (+24 more)
...
Cohesion: 0.10
Nodes (21): CodeCursorQuery, IssueSearchQuery, RequirementListQuery, TestCaseSearchQuery, TestRunListQuery, ArtifactUrl, IssuePriority, IssueStatus (+13 more)
...
Cohesion: 0.07
Nodes (37): ProfileViewProps, DescribableActivityEntry, describeSystemEvent(), EVENT_TYPE_LABEL, STATUS_LABEL_BY_ENTITY, statusLabel(), ACTIVITY_ENTITY_LABEL, ACTIVITY_ENTITY_ROUTE (+29 more)

### Community 17 - "What You Must Do When Invoked"
Cohesion: 0.20
Nodes (11): PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_SEVERITY, useProjectRepositories(), MEMBER_ROLE_OPTIONS, REPOSITORY_SOURCE_LABEL, REPOSITORY_SOURCE_OPTIONS, VISIBILITY_OPTIONS, environmentService (+3 more)

### Community 18 - "3. Konsep Test Management"
Cohesion: 0.08
Nodes (29): IssueDialog(), IssueDialogProps, TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY, TEST_RUN_STATUS_SEVERITY, useRequirements(), useTestRunAnalysis(), useTestRunDetail() (+21 more)
...
Cohesion: 0.13
Nodes (22): exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName(), mapDashboardReportRunRow(), useDashboardReport(), ALL, DashboardReportPage(), dashboardReportRepository (+14 more)

### Community 21 - "Feature Backlog — TestManager"
Cohesion: 0.16
Nodes (16): mapAutomationJobRow(), mapAutomationRunnerRow(), mapAutomationScriptRow(), useAutomation(), AutomationPage(), jobSeverity, runnerOnline(), automationRepository (+8 more)
...
Cohesion: 0.09
Nodes (23): AnalysisOutputSchema, AnalysisRequest, AssistantOutputSchema, AssistantRequest, computeDuplicateConfidence(), DuplicateOutputSchema, DuplicateRequest, ErrorEnvelope (+15 more)
...
Cohesion: 0.25
Nodes (10): mapCicdPipelineRow(), useCicdPipelines(), providerOptions, cicdRepository, cicdService, CicdIngestPayload, CicdIngestResponse, CicdPipeline (+2 more)

### Community 29 - "schema_test_management_v2.sql"
Cohesion: 0.08
Nodes (28): byteLength(), ErrorDetail, ErrorEnvelope, errorResponse(), McpToolError, paginatedResponse(), PaginationInput, PaginationMeta (+20 more)
...
Cohesion: 0.17
Nodes (18): ImportCasesDialog(), ImportCasesDialogProps, mapProjectRow(), ProjectContext, ProjectContextValue, ProjectProvider(), STATUS_OPTIONS, ProjectOwnerFilter (+10 more)

### Community 40 - "graphify reference: query, path, explain"
Cohesion: 0.18
Nodes (11): ActivityPanel(), TABLE_LABELS, CommentsPanel(), formatDateTime(), useActivity(), useComments(), useDashboard(), downloadCsv() (+3 more)
...
Cohesion: 0.17
Nodes (4): ReadRepository, ReadRepositoryError, config, Project
...
Cohesion: 0.09
Nodes (26): CustomTestRunDialog(), CustomTestRunDialogProps, STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, BulkActionsBar(), BulkActionsBarProps, TEST_PLAN_STATUS_LABEL (+18 more)
...
Cohesion: 0.13
Nodes (22): mapRequirementLinkRow(), mapLink(), requirementRepository, testResultStepRepository, testResultStepService, ActivityAction, AutomationArtifact, CicdIngestResultInput (+14 more)
...
Cohesion: 0.10
Nodes (24): AdminRoute(), ProtectedRoute(), AppTopbar(), useBreadcrumbContext(), ProfileView(), BreadcrumbCollapsed(), BreadcrumbItem, BreadcrumbProps (+16 more)
...
Cohesion: 0.08
Nodes (34): mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapIssueRow(), mapModuleRow(), mapProfileRow(), mapProjectMemberRow(), mapProjectMemberWithProfileRow() (+26 more)
...
Cohesion: 0.16
Nodes (7): config, AuthenticationError, AuthRepository, TokenAuthenticationRow, AuthService, ProjectScopeError, config
...
Cohesion: 0.11
Nodes (19): 2026-07-31 — MCP-08 write test case/test plan tools, 2026-07-31 — MCP-09 gate manusia approval Test Plan, 2026-07-31 — MCP-11 workflow Issue, 2026-07-31 — MCP-12 tool Automation, 2026-07-31 — MCP-13 selective rerun failed, 2026-07-31 — MCP-15 tool analisis, 2026-07-31 — MCP-16 rate limit dan audit tool MCP, 2026-08-01 — Eksekusi seluruh migration melalui MCP Supabase (+11 more)
...
Cohesion: 0.19
Nodes (22): formatDate(), useEnvironments(), useIssuesByTestRun(), useProjectRole(), useScreenSize(), useTestPlanDetail(), useTestPlans(), CicdIntegrationPage() (+14 more)
...
Cohesion: 0.14
Nodes (16): IssueEditor(), IssueEditorProps, IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, mapTestRoleRow(), ISSUE_TYPE_LABEL (+8 more)
...
Cohesion: 0.20
Nodes (10): loadConfig(), parseBoundedInteger(), parseReadonly(), parseRerunFailedMaxTests(), requiredEnv(), baseEnv, BeginToolCallResult, BeginToolCallRow (+2 more)
...
Cohesion: 0.17
Nodes (7): ServerConfig, RepoRepositoryError, RepositoryConfigRow, RepositorySourceType, config, fixture(), run

### Community 193 - "registry.ts"
Cohesion: 0.22
Nodes (9): GovernanceRepository, createMcpServer(), GovernanceService, ToolRateLimitError, installToolGovernance(), registerTools(), unusedServer, ToolRegistrar (+1 more)

### Community 194 - "executor.ts"
Cohesion: 0.23
Nodes (13): JobResult, ReportArtifact, classifyArtifact(), collectArtifacts(), CollectedArtifact, walk(), executeJob(), ExecutionMode (+5 more)
...
Cohesion: 0.11
Nodes (17): supabase, mapEnvironmentRow(), mapTestCaseStepRow(), mapTestRunAssignmentRow(), mapTestRunRow(), commentRepository, environmentRepository, moduleRepository (+9 more)

### Community 199 - "repositoryWorkspace.ts"
Cohesion: 0.20
...
### Community 201 - "upload.ts"
Cohesion: 0.27
Nodes (8): RunnerConfig, emit(), Level, log, localFallback(), MIME, SignResponse, uploadArtifacts()

### Community 203 - "interactive.ts"
Cohesion: 0.39
...
## Knowledge Gaps
- **866 isolated node(s):** `1. Fitur yang sudah selesai`, `Requirement Traceability`, `Environment Management`, `Test Run Enhancement`, `Test Case Productivity` (+861 more)
