...
## Summary
- 2430 nodes · 5031 edges · 194 communities (160 shown, 34 thin omitted)
...
Cohesion: 0.12
Nodes (22): FilterToolbar(), FilterToolbarProps, PageHeader(), PageHeaderProps, RowActionsMenu(), RowActionsMenuProps, useAutomation(), useCicdPipelines() (+14 more)
...
Cohesion: 0.08
Nodes (32): mapAutomationJobRow(), mapAutomationRunnerRow(), mapAutomationScriptRow(), mapCicdPipelineRow(), automationRepository, cicdRepository, testResultStepRepository, automationService (+24 more)
...
Cohesion: 0.09
Nodes (25): AiAssistantPanel(), TestSuiteDialog(), dataTablePaginatorProps, dataTablePaginatorTemplate, SearchInput(), SearchInputProps, exportTestCasesToExcel(), exportTestCasesToPdf() (+17 more)
...
Cohesion: 0.12
Nodes (25): IssueEditor(), IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY, ISSUE_STATUS_LABEL (+17 more)

### Community 17 - "What You Must Do When Invoked"
Cohesion: 0.12
Nodes (20): ProfileViewProps, describeSystemEvent(), EVENT_TYPE_LABEL, STATUS_LABEL_BY_ENTITY, statusLabel(), ISSUE_STATUS_SEVERITY, PROJECT_MEMBER_ROLE_SEVERITY, PROJECT_MEMBER_STATUS_LABEL (+12 more)

### Community 18 - "3. Konsep Test Management"
Cohesion: 0.19
Nodes (10): IssueDialog(), IssueDialogProps, TEST_RESULT_STATUS_LABEL, TEST_RUN_STATUS_SEVERITY, useTestRunAnalysis(), useTestRunDetail(), RESULT_FILTER_OPTIONS, RESULT_OPTIONS (+2 more)
...
Cohesion: 0.14
Nodes (14): 2026-07-31 — MCP-08 write test case/test plan tools, 2026-07-31 — MCP-09 gate manusia approval Test Plan, 2026-07-31 — MCP-11 workflow Issue, 2026-07-31 — MCP-12 tool Automation, 2026-07-31 — MCP-13 selective rerun failed, 2026-07-31 — MCP-15 tool analisis, 2026-07-31 — MCP-16 rate limit dan audit tool MCP, 2026-08-01 — Eksekusi seluruh migration melalui MCP Supabase (+6 more)

### Community 22 - "Architecture"
Cohesion: 0.06
Nodes (65): JsonRecord, mapAnalysisRunSummaryRow(), mapFlakyCandidateRow(), mapIssueDetailRow(), mapIssueSummaryRow(), mapProjectRow(), mapRequirementCoverageRow(), mapRequirementDetailRow() (+57 more)
...
Cohesion: 0.11
Nodes (21): mapDashboardReportRunRow(), mapTestCaseRow(), mapTestPlanRow(), mapTestResultRow(), mapTestResultStepRow(), mapTestRunAssignmentRow(), mapTestRunRow(), calculateTestRunSummary() (+13 more)
...
Cohesion: 0.06
Nodes (55): ImportCasesDialog(), ImportCasesDialogProps, STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, ActivityPanel(), TABLE_LABELS, BulkActionsBar() (+47 more)
...
Cohesion: 0.12
Nodes (29): AdminRoute(), ProtectedRoute(), formatDate(), useAuthContext(), useBackupRetention(), useIntegrations(), useProjectRepositories(), useProjectRole() (+21 more)
...
Cohesion: 0.16
Nodes (14): ProfileView(), Breadcrumb(), BreadcrumbItem, BreadcrumbProps, AuthContext, AuthContextValue, useProfileView(), useProjectBreadcrumbItems() (+6 more)
...
Cohesion: 0.10
Nodes (17): BeginToolCallResult, BeginToolCallRow, GovernanceRepository, GovernanceRepositoryError, config, AnalysisService, GovernanceService, ToolRateLimitError (+9 more)
...
Cohesion: 0.19
Nodes (10): supabase, mapEnvironmentRow(), commentRepository, environmentRepository, tagRepository, commentService, ActivityEvent, Comment (+2 more)
...
## Knowledge Gaps
- **855 isolated node(s):** `2026-07-31 — MCP-14 tool konteks repository`, `2026-07-31 — MCP-10 tool workflow Test Run`, `2026-07-31 — REPO-08 traceability repository pada Test Run`, `2026-07-31 — REPO-07 mode `local_path` pada runner`, `2026-07-31 — REPO-04 tab Repository di Project Settings` (+850 more)
...
- **Why does `query()` connect `ProjectDataManagementPage.tsx` to `Community 8`, `graphify reference: extra exports and benchmark`?**
