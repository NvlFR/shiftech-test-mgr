...
## Corpus Check
- 417 files · ~257,808 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2623 nodes · 5342 edges · 219 communities (178 shown, 41 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 44 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2ab94194`
...
- `TestPlansPage()` --indirect_call--> `query()`  [INFERRED]
  frontend/src/pages/test-plans/TestPlansPage.tsx → supabase/functions/ai-gateway/handler.ts
...
Cohesion: 0.10
Nodes (34): AiTestCaseGeneratorDialog(), maxCaseOptions, priorityOptions, ReviewDraft, AiTestCaseResponseSchema, AiTestCaseSchema, AiTestCaseValidationError, AiTestCaseValidationResult (+26 more)
...
Cohesion: 0.15
Nodes (13): IssueDialog(), IssueDialogProps, ActivityPanel(), TABLE_LABELS, TEST_RESULT_STATUS_LABEL, TEST_RESULT_STATUS_SEVERITY, TEST_RUN_STATUS_SEVERITY, useActivity() (+5 more)
...
Cohesion: 0.10
Nodes (30): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, BulkActionsBar(), BulkActionsBarProps, PageHeader(), PageHeaderProps, TEST_PLAN_STATUS_LABEL (+22 more)

### Community 17 - "What You Must Do When Invoked"
Cohesion: 0.11
Nodes (23): byteLength(), ErrorDetail, ErrorEnvelope, errorResponse(), paginatedResponse(), PaginationInput, PaginationMeta, SuccessEnvelope (+15 more)
...
Cohesion: 0.12
Nodes (18): normalizePageSize(), CodeCursorQuery, TestResultListQuery, TestRunListQuery, decodeCursor(), decodeResultCursor(), encodeCodeCursor, encodeRequirementCursor() (+10 more)

### Community 21 - "Feature Backlog — TestManager"
Cohesion: 0.22
Nodes (11): useAutomation(), useAutomationJobLogs(), AutomationPage(), jobSeverity, runnerOnline(), automationRepository, automationService, AutomationBrowser (+3 more)

### Community 22 - "Architecture"
Cohesion: 0.17
Nodes (14): Breadcrumb(), BreadcrumbItem, BreadcrumbProps, CommentsPanel(), AuthContext, AuthContextValue, useComments(), useProfileView() (+6 more)
...
Cohesion: 0.23
Nodes (11): mapIssueRow(), mapModuleRow(), mapTagRow(), mapTestCaseRow(), mapTestCaseVersionRow(), mapTestPlanCaseRow(), issueRepository, mapIssueDetails() (+3 more)
...
Cohesion: 0.13
Nodes (24): AppMenu(), AppMenuitem(), AppMenuSeparator(), MenuItemModel, useDashboardReport(), useEnvironments(), useProfiles(), readStoredPins() (+16 more)
...
Cohesion: 0.07
Nodes (41): App(), AppLayout(), AppLayoutInner(), AppSidebar(), AppSidebarMask(), AppTopbar(), BreadcrumbContext, BreadcrumbContextValue (+33 more)
...
Cohesion: 0.12
Nodes (18): mapProjectRepositoryRow(), projectMemberRepository, CreateProjectRepositoryInput, projectRepositoryLinkRepository, UpdateProjectRepositoryInput, CredentialAction, repositoryConnectionRepository, RepositoryConnectionResultRow (+10 more)
...
Cohesion: 0.13
Nodes (12): UserHoverCard(), UserHoverCardProps, mapActivityEventRow(), mapNotificationRow(), queryKeys, useProfile(), activityRepository, notificationRepository (+4 more)
...
Cohesion: 0.08
Nodes (40): mapRequirementRow(), mapTestRunAssignmentRow(), mapTestRunRow(), calculateTestRunSummary(), useRequirements(), useTestRunDetail(), EMPTY_FILTERS, TestRunWithSummary (+32 more)
...
Cohesion: 0.15
Nodes (16): IssueEditorProps, PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_SEVERITY, useIssueEditorOptions(), MEMBER_ROLE_OPTIONS, REPOSITORY_SOURCE_LABEL, REPOSITORY_SOURCE_OPTIONS, VISIBILITY_OPTIONS (+8 more)
...
Cohesion: 0.08
Nodes (24): loadConfig(), parseBoundedInteger(), parseReadonly(), parseRerunFailedMaxTests(), requiredEnv(), ServerConfig, baseEnv, readJsonBody() (+16 more)
...
Cohesion: 0.07
Nodes (41): Props, CustomTestRunDialog(), CustomTestRunDialogProps, ImportCasesDialogProps, ParsedTestCaseRow, downloadTestCaseImportTemplate(), TEST_CASE_PRIORITY_LABEL, TEST_CASE_PRIORITY_SEVERITY (+33 more)
...
Cohesion: 0.12
Nodes (15): supabase, mapEnvironmentRow(), mapTestCaseStepRow(), mapTestRoleRow(), commentRepository, environmentRepository, moduleRepository, profileRepository (+7 more)
...
Cohesion: 0.38
Nodes (6): jspdf, exportDashboardReportToExcel(), exportDashboardReportToPdf(), safeName(), exportTestCasesToPdf(), jspdf

### Community 203 - "AppTopbar.tsx"
Cohesion: 0.31
Nodes (8): xlsx, exportTestCasesToExcel(), ImportedTestCaseRow, normalizeHeader(), normalizePriority(), parseTestCaseExcel(), valueFrom(), xlsx
...
Cohesion: 0.14
Nodes (28): AdminRoute(), ProtectedRoute(), ImportCasesDialog(), formatDate(), formatDateTime(), useAuthContext(), useBackupRetention(), useIssuesByTestRun() (+20 more)

### Community 216 - "testResultService.ts"
Cohesion: 0.10
Nodes (29): mapAutomationJobLogRow(), mapAutomationJobRow(), mapAutomationRunnerRow(), mapAutomationScriptRow(), mapCommentMentionRow(), mapCommentRow(), mapProfileRow(), mapProjectMemberRow() (+21 more)

### Community 223 - "activityDescribe.ts"
Cohesion: 0.07
Nodes (46): IssueEditor(), IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, ProfileView(), ProfileViewProps, describeSystemEvent() (+38 more)
...
## Knowledge Gaps
- **923 isolated node(s):** `2026-08-01 — 37 task baru masuk antrean Codex`, `2026-08-01 — Arsitektur & distribusi Local Agent (runner + MCP)`, `2026-08-01 — Backlog: halaman "Connect your agent" + Runner UI/UX`, `2026-07-31 — MCP-14 tool konteks repository`, `2026-07-31 — MCP-10 tool workflow Test Run` (+918 more)
...
- **Why does `query()` connect `useAuthContext` to `Community 1`, `graphify reference: extra exports and benchmark`?**
  _High betweenness centrality (0.145) - this node is a cross-community bridge._
- **Why does `react` connect `Community 16` to `Community 0`, `Community 1`, `Community 7`, `Community 8`, `Community 10`, `Feature Backlog — TestManager`, `Architecture`, `TestCaseDetailPage.tsx`, `schema_auth.sql`, `ProjectDataManagementPage.tsx`, `TestManager (shiftech-test-mgr)`, `schema_project_roles.sql`, `AppTopbar.tsx`, `useProjectBreadcrumbItems.ts`, `issueAttachmentRepository.ts`, `graphify reference: transcribe video and audio`, `useNotifications.ts`, `csvImport.ts`, `react-dom`, `ServerConfig`, `useAuthContext`, `AppTopbar.tsx`, `activityDescribe.ts`, `csvImport.ts`, `AppMenu.tsx`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **What connects `2026-08-01 — 37 task baru masuk antrean Codex`, `2026-08-01 — Arsitektur & distribusi Local Agent (runner + MCP)`, `2026-08-01 — Backlog: halaman "Connect your agent" + Runner UI/UX` to the rest of the system?**
