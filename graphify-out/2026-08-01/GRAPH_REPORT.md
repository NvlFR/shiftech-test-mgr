...
## Corpus Check
- 421 files · ~260,932 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2640 nodes · 5420 edges · 226 communities (183 shown, 43 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 47 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8ac092e0`
...
Cohesion: 0.09
Nodes (54): JsonRecord, mapAnalysisRunSummaryRow(), mapFlakyCandidateRow(), mapIssueDetailRow(), mapIssueSummaryRow(), mapProjectRow(), mapRequirementCoverageRow(), mapRequirementDetailRow() (+46 more)

### Community 7 - "Community 7"
Cohesion: 0.10
Nodes (26): BreadcrumbItem, BreadcrumbProps, CommentsPanel(), ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY, ISSUE_STATUS_LABEL, ISSUE_TYPE_LABEL, ISSUE_TYPE_SEVERITY (+18 more)

### Community 8 - "Community 8"
Cohesion: 0.09
Nodes (34): mapApiTokenRow(), mapRequirementLinkRow(), mapRequirementRow(), mapWebhookDeliveryRow(), mapWebhookRow(), integrationRepository, mapLink(), requirementRepository (+26 more)
...
Cohesion: 0.13
Nodes (17): normalizePageSize(), RequirementListQuery, TestCaseSearchQuery, TestResultListQuery, decodeCursor(), decodeResultCursor(), encodeCodeCursor, encodeRequirementCursor() (+9 more)

### Community 23 - "AttachmentPanel.tsx"
Cohesion: 0.13
Nodes (29): AiAssistantPanel(), AdminRoute(), ProtectedRoute(), ImportCasesDialog(), formatDate(), useAiAssistant(), useAuthContext(), useIssueAttachments() (+21 more)
...
Cohesion: 0.11
Nodes (29): ImportCasesDialogProps, PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_LABEL, PROJECT_STATUS_SEVERITY, useDashboardReport(), useEnvironments(), useProfiles(), ProjectContext (+21 more)
...
Cohesion: 0.31
Nodes (7): useRequirements(), Option, PRIORITIES, RequirementsPage(), STATUSES, TYPES, requirementService
...
Cohesion: 0.17
Nodes (14): TestSuiteDialog(), dataTablePaginatorProps, dataTablePaginatorTemplate, FilterToolbar(), FilterToolbarProps, RowActionsMenu(), RowActionsMenuProps, SearchInput() (+6 more)
...
Cohesion: 0.08
Nodes (42): AiTestCaseGeneratorDialog(), maxCaseOptions, priorityOptions, Props, CustomTestRunDialog(), CustomTestRunDialogProps, downloadTestCaseImportTemplate(), exportTestCasesToExcel() (+34 more)
...
Cohesion: 0.13
Nodes (19): mapDashboardReportRunRow(), mapTestResultRow(), mapTestResultScreenshotHistoryRow(), dashboardReportRepository, DashboardReportResultRow, fetchAllRows(), RangeResult, ACTIVE_ISSUE_STATUSES (+11 more)
...
Cohesion: 0.18
Nodes (13): PageHeader(), PageHeaderProps, useAiTestCaseReview(), useDashboard(), useIntegrations(), useProjectContext(), downloadCsv(), HomePage() (+5 more)
...
Cohesion: 0.15
Nodes (13): supabase, mapTestCaseStepRow(), mapTestRunAssignmentRow(), mapTestRunRow(), commentRepository, moduleRepository, testCaseStepRepository, testRunRepository (+5 more)
...
Cohesion: 0.10
Nodes (32): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, ActivityPanel(), TABLE_LABELS, BulkActionsBar(), BulkActionsBarProps, formatDateTime() (+24 more)
...
Cohesion: 0.07
Nodes (39): mapActivityEventRow(), mapCommentMentionRow(), mapCommentRow(), mapEnvironmentRow(), mapIssueRow(), mapModuleRow(), mapProfileRow(), mapProjectMemberRow() (+31 more)

### Community 217 - "NotificationPanel.tsx"
Cohesion: 0.50
Nodes (4): iconForKind(), NOTIFICATION_KIND_ICON, NotificationPanel(), NotificationPanelProps

### Community 223 - "activityDescribe.ts"
Cohesion: 0.09
Nodes (28): IssueDialog(), IssueDialogProps, ProfileView(), ProfileViewProps, Breadcrumb(), ISSUE_STATUS_SEVERITY, PROJECT_MEMBER_ROLE_SEVERITY, PROJECT_MEMBER_STATUS_LABEL (+20 more)
...
- **Why does `useAiTestCaseReview()` connect `ProjectDataManagementPage.tsx` to `csvImport.ts`, `Community 11`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
- **Why does `WriteService` connect `Community 11` to `statusLabels.ts`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `react` connect `Community 7` to `Community 0`, `Community 1`, `Community 8`, `csvImport.ts`, `Community 10`, `Community 12`, `Community 16`, `3. Konsep Test Management`, `ARCHITECTURE — TestManager (shiftech-test-mgr)`, `Feature Backlog — TestManager`, `AttachmentPanel.tsx`, `TestCaseDetailPage.tsx`, `schema_auth.sql`, `ProjectDataManagementPage.tsx`, `TestManager (shiftech-test-mgr)`, `schema_project_roles.sql`, `AppTopbar.tsx`, `testSuiteRepository.ts`, `useProjectBreadcrumbItems.ts`, `issueAttachmentRepository.ts`, `schema_project_members.sql`, `graphify reference: transcribe video and audio`, `executor.ts`, `useTheme.tsx`, `csvImport.ts`, `react-dom`, `testResultStepRepository.ts`, `dashboardRepository.ts`, `AppTopbar.tsx`, `activityDescribe.ts`, `csvImport.ts`?**
