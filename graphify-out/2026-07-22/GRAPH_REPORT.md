...
## Corpus Check
- 174 files · ~90,955 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1020 nodes · 2092 edges · 85 communities (70 shown, 15 thin omitted)
...
- `exportDashboardReportToExcel()` --references--> `xlsx`  [EXTRACTED]
  frontend/src/helpers/dashboardReportExporter.ts → frontend/package.json
- `downloadTestCaseImportTemplate()` --references--> `xlsx`  [EXTRACTED]
  frontend/src/helpers/excelExporter.ts → frontend/package.json
- `exportTestCasesToExcel()` --references--> `xlsx`  [EXTRACTED]
  frontend/src/helpers/excelExporter.ts → frontend/package.json
...
Cohesion: 0.24
Nodes (14): AdminRoute(), ProtectedRoute(), formatDateTime(), useAuthContext(), useProjectRole(), LoginPage(), PendingApprovalPage(), IssueDetailPage() (+6 more)

### Community 3 - "Community 3"
Cohesion: 0.13
Nodes (24): mapCommentMentionRow(), mapCommentRow(), mapIssueRow(), mapModuleRow(), mapProfileRow(), mapProjectMemberRow(), mapProjectMemberWithProfileRow(), mapProjectRow() (+16 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (41): dependencies, @hookform/resolvers, jspdf, jspdf-autotable, primeflex, primeicons, primereact, react (+33 more)

### Community 5 - "Community 5"
Cohesion: 0.09
Nodes (30): AppLayout(), AppLayoutInner(), AppSidebar(), AppSidebarMask(), AppTopbar(), BreadcrumbContext, BreadcrumbContextValue, BreadcrumbItem (+22 more)
...
Cohesion: 0.10
Nodes (31): downloadTestCaseImportTemplate(), exportTestCasesToExcel(), exportTestCasesToPdf(), TEST_CASE_PRIORITY_LABEL, TEST_CASE_STATUS_LABEL, TEST_CASE_STATUS_SEVERITY, ImportedTestCaseRow, ISSUE_PRIORITY_OPTIONS (+23 more)
...
Cohesion: 0.17
Nodes (17): mapRequirementLinkRow(), mapRequirementRow(), mapLink(), requirementRepository, requirementService, CicdIngestResultInput, CicdIngestStatus, CommentMention (+9 more)
...
Cohesion: 0.06
Nodes (31): 2026-07-22, 2026-07-22 — Apply migration P1 dan checklist, 2026-07-22 — Integrasi P1 dan QA final, 2026-07-22 — P1 Duplicate Test Case dan Comment/Mention, 2026-07-22 — P1 Requirement Traceability, 2026-07-22 — P2 API Token dan Webhook (sub-agent 2), 2026-07-22 — P2 Integrasi CI/CD (sub-agent 3), 2026-07-22 — Sub-agent 1: P2 Dashboard Trend dan Reporting (+23 more)
...
Cohesion: 0.16
Nodes (16): Breadcrumb(), BreadcrumbItem, BreadcrumbProps, ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY, ISSUE_STATUS_LABEL, TEST_CASE_PRIORITY_SEVERITY, useIssuesByTestRun() (+8 more)

### Community 47 - "primereact"
Cohesion: 0.18
Nodes (9): supabase, mapNotificationRow(), mapTestPlanRow(), moduleRepository, profileRepository, projectMemberRepository, testPlanRepository, ProjectMemberRole (+1 more)

### Community 48 - "react-hook-form"
Cohesion: 0.12
Nodes (26): PageHeader(), PageHeaderProps, formatDate(), ISSUE_STATUS_SEVERITY, PROJECT_MEMBER_ROLE_SEVERITY, TagSeverity, TEST_PLAN_STATUS_LABEL, TEST_PLAN_STATUS_SEVERITY (+18 more)
...
Cohesion: 0.18
Nodes (11): useRequirements(), Summary, useTestRunDetail(), TestRunWithSummary, Option, PRIORITIES, RequirementsPage(), STATUSES (+3 more)

### Community 79 - "primeflex"
Cohesion: 0.18
Nodes (10): BulkActionsBar(), BulkActionsBarProps, RowActionsMenu(), RowActionsMenuProps, PROJECT_MEMBER_ROLE_LABEL, PROJECT_STATUS_LABEL, PROJECT_STATUS_SEVERITY, MEMBER_ROLE_OPTIONS (+2 more)

### Community 81 - "primereact"
Cohesion: 0.27
Nodes (10): App(), USER_ROLE_LABEL, USER_ROLE_SEVERITY, AuthContext, AuthContextValue, AuthProvider(), queryClient, profileService (+2 more)
...
Cohesion: 0.25
Nodes (8): mapTestRunAssignmentRow(), mapTestRunRow(), EMPTY_FILTERS, testCaseRepository, testResultRepository, TestRunFilters, testRunRepository, TestRunAssignment
...
## Knowledge Gaps
- **394 isolated node(s):** `$schema`, `typescript`, `oxc`, `react/rules-of-hooks`, `warn` (+389 more)
...
- **Why does `react` connect `primereact` to `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 9`, `Community 12`, `Community 13`, `AttachmentPanel.tsx`, `statusLabels.ts`, `Coding Conventions`, `schema_requirement_traceability.sql`, `react-hook-form`, `backupRetentionRepository.ts`, `CLAUDE.md`, `package.json`, `scripts`, `primeflex`, `testRunRepository.ts`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `xlsx` connect `Community 4` to `Community 9`, `Community 7`?**
